...
final class CarouselStrategyHelper {
    ...
    static KeylineState createLeftAlignedKeylineState(Context context, float childHorizontalMargins, float availableSpace, Arrangement arrangement) {
        ...
        KeylineState.Builder addAnchorKeyline = new KeylineState.Builder(arrangement.largeSize, availableSpace).addAnchorKeyline(extraSmallHeadCenterX, extraSmallMask, extraSmallChildWidth);
        float mediumMask2 = arrangement.largeSize;
        KeylineState.Builder builder = addAnchorKeyline.addKeylineRange(largeStartCenterX, 0.0f, mediumMask2, arrangement.largeCount, true);

...
public final class LogRepository {
    ...
    private final LogEntry deserialize(String raw) {
        ...
        try {
            ...
            m7216constructorimpl = Result.m7216constructorimpl(new LogEntry(Long.parseLong((String) parts.get(0)), LogLevel.valueOf((String) parts.get(1)), logRepository.decode((String) parts.get(2)), logRepository.decode((String) parts.get(3))));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m7216constructorimpl = Result.m7216constructorimpl(ResultKt.createFailure(th));
        }
        return (LogEntry) (Result.m7222isFailureimpl(m7216constructorimpl) ? null : m7216constructorimpl);
    }

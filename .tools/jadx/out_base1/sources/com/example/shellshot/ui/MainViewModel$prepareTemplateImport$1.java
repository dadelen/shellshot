    ...
    public final Object invokeSuspend(Object $result) {
        ...
        try {
            ...
            if (validationWarning != null) {
                ...
                mutableStateFlow7.setValue(new TemplateImportAlert("模板不符合要求", mapTemplateImportMessage2));
            } else {
            ...
            try {
                if (!(throwable instanceof CancellationException)) {
                    ...
                    mutableStateFlow3.setValue(new TemplateImportAlert("无法导入模板", mapTemplateImportMessage));
                } else {
                    throw throwable;
                }
            } finally {

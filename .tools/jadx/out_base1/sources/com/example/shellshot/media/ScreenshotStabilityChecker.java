...
public final class ScreenshotStabilityChecker {
    ...
    public final Pair<Integer, Integer> decodeBounds(File file) {
        ...
        try {
            ...
            m7216constructorimpl = kotlin.Result.m7216constructorimpl(TuplesKt.to(Integer.valueOf(options.outWidth), Integer.valueOf(options.outHeight)));
        } catch (Throwable th) {
            Result.Companion companion2 = kotlin.Result.INSTANCE;
            m7216constructorimpl = kotlin.Result.m7216constructorimpl(ResultKt.createFailure(th));
        }
        Pair pair = TuplesKt.to(0, 0);
        if (kotlin.Result.m7222isFailureimpl(m7216constructorimpl)) {
            m7216constructorimpl = pair;
        }
        return (Pair) m7216constructorimpl;
    }

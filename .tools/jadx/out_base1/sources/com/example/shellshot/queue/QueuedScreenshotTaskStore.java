...
public final class QueuedScreenshotTaskStore {
    ...
    public final ScreenshotTaskSnapshot readSnapshotLocked() {
        ...
        try {
            ...
            m7216constructorimpl = Result.m7216constructorimpl((ScreenshotTaskSnapshot) json.decodeFromString(ScreenshotTaskSnapshot.INSTANCE.serializer(), readText$default));
        } catch (Throwable th) {
        ...
        if (Result.m7222isFailureimpl(m7216constructorimpl)) {
            m7216constructorimpl = screenshotTaskSnapshot;
        }
        return (ScreenshotTaskSnapshot) m7216constructorimpl;
    }

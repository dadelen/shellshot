...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m7384boximpl(ULong.m7390constructorimpl(getMostSignificantBits())), ULong.m7384boximpl(ULong.m7390constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m8691toUByteArrayTcUX1vc() {
        return UByteArray.m7287constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (this.mostSignificantBits != other.mostSignificantBits) {
            return Long.compareUnsigned(ULong.m7390constructorimpl(this.mostSignificantBits), ULong.m7390constructorimpl(other.mostSignificantBits));
        }
        return Long.compareUnsigned(ULong.m7390constructorimpl(this.leastSignificantBits), ULong.m7390constructorimpl(other.leastSignificantBits));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m8693fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m8692fromUByteArrayGBYM_sE(byte[] ubyteArray) {

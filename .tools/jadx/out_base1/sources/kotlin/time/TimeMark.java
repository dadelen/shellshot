...
public interface TimeMark {
    ...
    TimeMark mo8546minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo8548plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {2, 2, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m8666plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m8665minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo8548plusLRDsOJo(Duration.m8599unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m8581isNegativeimpl($this.mo8545elapsedNowUwyO8pc());
        }

...
public abstract class AbstractLongTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class LongTimeMark implements ComparableTimeMark {
        ...
        public long mo8545elapsedNowUwyO8pc() {
            return Duration.m8583minusLRDsOJo(LongSaturatedMathKt.saturatingOriginsDiff(this.timeSource.adjustedRead(), this.startedAt, this.timeSource.getUnit()), this.offset);
        }
        ...
        public ComparableTimeMark mo8548plusLRDsOJo(long duration) {
            ...
            if (Duration.m8580isInfiniteimpl(duration)) {
                return new LongTimeMark(LongSaturatedMathKt.m8657saturatingAddNuflL3o(this.startedAt, unit, duration), this.timeSource, Duration.INSTANCE.m8646getZEROUwyO8pc(), null);
            }
            long durationInUnit = Duration.m8598truncateToUwyO8pc$kotlin_stdlib(duration, unit);
            long rest = Duration.m8584plusLRDsOJo(Duration.m8583minusLRDsOJo(duration, durationInUnit), this.offset);
            long sum = LongSaturatedMathKt.m8657saturatingAddNuflL3o(this.startedAt, unit, durationInUnit);
            long restInUnit = Duration.m8598truncateToUwyO8pc$kotlin_stdlib(rest, unit);
            long sum2 = LongSaturatedMathKt.m8657saturatingAddNuflL3o(sum, unit, restInUnit);
            long restUnderUnit = Duration.m8583minusLRDsOJo(rest, restInUnit);
            long restUnderUnitNs = Duration.m8568getInWholeNanosecondsimpl(restUnderUnit);
            if (sum2 != 0 && restUnderUnitNs != 0 && (sum2 ^ restUnderUnitNs) < 0) {
                ...
                sum2 = LongSaturatedMathKt.m8657saturatingAddNuflL3o(sum2, unit, correction);
                restUnderUnit = Duration.m8583minusLRDsOJo(restUnderUnit, correction);
            }
            long newValue = sum2;
            long newOffset = (((newValue - 1) | 1) > Long.MAX_VALUE ? 1 : (((newValue - 1) | 1) == Long.MAX_VALUE ? 0 : -1)) == 0 ? Duration.INSTANCE.m8646getZEROUwyO8pc() : restUnderUnit;
        ...
        public long mo8547minusUwyO8pc(ComparableTimeMark other) {
            ...
            return Duration.m8584plusLRDsOJo(startedAtDiff, Duration.m8583minusLRDsOJo(this.offset, ((LongTimeMark) other).offset));
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof LongTimeMark) && Intrinsics.areEqual(this.timeSource, ((LongTimeMark) other).timeSource) && Duration.m8560equalsimpl0(mo8547minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m8646getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return (Duration.m8576hashCodeimpl(this.offset) * 37) + Long.hashCode(this.startedAt);
        }

        public String toString() {
            return "LongTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m8595toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new LongTimeMark(adjustedRead(), this, Duration.INSTANCE.m8646getZEROUwyO8pc(), null);
    }
}

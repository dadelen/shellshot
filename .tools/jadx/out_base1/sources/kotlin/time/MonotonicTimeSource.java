...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m8668boximpl(m8662markNowz9LOYto());
    }
    ...
    public long m8662markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m8671constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m8661elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m8660differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m8659adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m8671constructorimpl(LongSaturatedMathKt.m8657saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}

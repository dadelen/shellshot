...
public final class UStringsKt {
    ...
    public static final String m8542toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m8544toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m8543toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
        return UnsignedKt.ulongToString($this$toString_u2dV7xB4Y4 & 4294967295L, CharsKt.checkRadix(radix));
    }

    /* renamed from: toString-JSWoG40, reason: not valid java name */
    public static final String m8541toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (Integer.compareUnsigned(data, UInt.m7311constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m7228boximpl(UByte.m7234constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m7311constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m7491boximpl(UShort.m7497constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m7311constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m7311constructorimpl(result * uradix);
            result = UInt.m7311constructorimpl(UInt.m7311constructorimpl(digit) + result2);
            if (Integer.compareUnsigned(result, result2) < 0) {
                return null;
            }
        }
        return UInt.m7305boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m7390constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m7390constructorimpl(result * uradix);
            result = ULong.m7390constructorimpl(ULong.m7390constructorimpl(UInt.m7311constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m7384boximpl(result);
    }
}

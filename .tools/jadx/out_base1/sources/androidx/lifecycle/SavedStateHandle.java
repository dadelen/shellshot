...
public final class SavedStateHandle {
    ...
    public final <T> StateFlow<T> getStateFlow(String key, T initialValue) {
        ...
        MutableStateFlow<Object> mutableStateFlow = $this$getOrPut$iv.get(key);
        if (mutableStateFlow == null) {
            if (!this.regular.containsKey(key)) {
                this.regular.put(key, initialValue);
            }
            $this$getStateFlow_u24lambda_u242_u24lambda_u241 = StateFlowKt.MutableStateFlow(this.regular.get(key));
            this.flows.put(key, $this$getStateFlow_u24lambda_u242_u24lambda_u241);
            $this$getOrPut$iv.put(key, $this$getStateFlow_u24lambda_u242_u24lambda_u241);
        } else {
            $this$getStateFlow_u24lambda_u242_u24lambda_u241 = mutableStateFlow;
        }
        StateFlow<T> asStateFlow = FlowKt.asStateFlow($this$getStateFlow_u24lambda_u242_u24lambda_u241);

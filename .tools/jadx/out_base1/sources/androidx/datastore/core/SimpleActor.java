...
public final class SimpleActor<T> {
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
                ...
                public final void invoke2(Throwable th) {
                    ...
                    do {
                        Object m8722getOrNullimpl = ChannelResult.m8722getOrNullimpl(((SimpleActor) this).messageQueue.mo8711tryReceivePtdJZtk());
                        if (m8722getOrNullimpl != null) {
                            onUndeliveredElement.invoke(m8722getOrNullimpl, th);
                            obj = Unit.INSTANCE;
                        } else {
                            obj = null;
                        }
    ...
    public final void offer(T msg) {
        Object $this$onClosed_u2dWpGqRn0$iv = this.messageQueue.mo8706trySendJP2dKIU(msg);
        if (!($this$onClosed_u2dWpGqRn0$iv instanceof ChannelResult.Closed)) {
            if (!ChannelResult.m8727isSuccessimpl($this$onClosed_u2dWpGqRn0$iv)) {
        ...
        Throwable it = ChannelResult.m8721exceptionOrNullimpl($this$onClosed_u2dWpGqRn0$iv);
        if (it != null) {
            throw it;
        }
    }

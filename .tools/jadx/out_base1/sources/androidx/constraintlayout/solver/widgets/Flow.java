...
public class Flow extends VirtualLayout {
    ...
    public void measure(int i, int i2, int i3, int i4) {
        ...
        if (i11 <= 0) {
            ...
            ConstraintWidget[] constraintWidgetArr5 = new ConstraintWidget[this.mWidgetsCount - i11];
            int i13 = 0;
            int i14 = 0;
            while (true) {
                int i15 = i12;
                ...
                if (constraintWidget.getVisibility() != 8) {
                    constraintWidgetArr6[i13] = constraintWidget;
                    i13++;
                }
                i14++;
                i12 = i15;
        ...
        int i16 = iArr[z ? 1 : 0] + paddingLeft + paddingRight;
        int i17 = iArr[r17] + paddingTop + paddingBottom;
        int i18 = 0;
        int i19 = 0;
        if (i == 1073741824) {
            i18 = i2;

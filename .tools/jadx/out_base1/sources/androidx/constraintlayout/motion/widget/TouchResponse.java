        ...
        switch (event.getAction()) {
            ...
            case 1:
                ...
                if (i == -1) {
                    ...
                    motionLayout.getAnchorDpDt(this.mTouchAnchorId, pos, this.mTouchAnchorX, this.mTouchAnchorY, this.mAnchorDpDt);
                }
            ...
            case 2:
                ...
                if (Math.abs(drag) > this.mDragThreshold || this.mDragStarted) {
                    ...
                    if (i2 != -1) {
                        c = 1;
                        motionLayout2.getAnchorDpDt(this.mTouchAnchorId, pos2, this.mTouchAnchorX, this.mTouchAnchorY, this.mAnchorDpDt);
                    } else {
                        c = 1;
                    ...
                    float movmentInDir = (this.mTouchDirectionX * this.mAnchorDpDt[0]) + (this.mTouchDirectionY * this.mAnchorDpDt[c]);
                    if (Math.abs(movmentInDir * this.mDragScale) < 0.01d) {
                        this.mAnchorDpDt[0] = 0.01f;
                        this.mAnchorDpDt[c] = 0.01f;
                    }

...
final class TimePickerStateImpl implements TimePickerState {
    ...
    public TimePickerStateImpl(int initialHour, int initialMinute, boolean is24Hour) {
        ...
        this.selection = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TimePickerSelectionMode.m2748boximpl(TimePickerSelectionMode.INSTANCE.m2755getHouryecRtBI()), null, 2, null);
    ...
    public int mo1764getSelectionyecRtBI() {
        ...
        return ((TimePickerSelectionMode) $this$getValue$iv.getValue()).m2754unboximpl();
    }
    ...
    public void mo1765setSelection6_8s6DQ(int i) {
        ...
        $this$setValue$iv.setValue(TimePickerSelectionMode.m2748boximpl(i));
    }

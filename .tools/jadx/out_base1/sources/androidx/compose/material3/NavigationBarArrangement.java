...
public final class NavigationBarArrangement {
    ...
    private static final int EqualWeight = m2254constructorimpl(0);
    private static final int Centered = m2254constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ NavigationBarArrangement m2253boximpl(int i) {
        return new NavigationBarArrangement(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m2254constructorimpl(int i) {
        return i;
    }
    ...
    public static String m2258toStringimpl(int arg0) {
        return m2256equalsimpl0(arg0, EqualWeight) ? "EqualWeight" : m2256equalsimpl0(arg0, Centered) ? "Centered" : "Unknown";
    }
}

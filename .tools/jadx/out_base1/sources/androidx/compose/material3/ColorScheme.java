...
public final class ColorScheme {
    ...
    public static /* synthetic */ ColorScheme m1893copyG1PFcw$default(ColorScheme colorScheme, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14, long j15, long j16, long j17, long j18, long j19, long j20, long j21, long j22, long j23, long j24, long j25, long j26, long j27, long j28, long j29, int i, Object obj) {
        long j30;
        long j31;
        long j32;
        long j33;
        ...
        return colorScheme.m1895copyG1PFcw(j65, j59, j60, j61, j62, j63, j64, j66, j67, j68, j69, j70, j71, j72, j30, j32, j34, j36, j38, j40, j42, j44, j46, j48, j50, j52, j54, j56, j57);
    }
    ...
    public final /* synthetic */ ColorScheme m1895copyG1PFcw(long primary, long onPrimary, long primaryContainer, long onPrimaryContainer, long inversePrimary, long secondary, long onSecondary, long secondaryContainer, long onSecondaryContainer, long tertiary, long onTertiary, long tertiaryContainer, long onTertiaryContainer, long background, long onBackground, long surface, long onSurface, long surfaceVariant, long onSurfaceVariant, long surfaceTint, long inverseSurface, long inverseOnSurface, long error, long onError, long errorContainer, long onErrorContainer, long outline, long outlineVariant, long scrim) {
        return m1892copyCXl9yA$default(this, primary, onPrimary, primaryContainer, onPrimaryContainer, inversePrimary, secondary, onSecondary, secondaryContainer, onSecondaryContainer, tertiary, onTertiary, tertiaryContainer, onTertiaryContainer, background, onBackground, surface, onSurface, surfaceVariant, onSurfaceVariant, surfaceTint, inverseSurface, inverseOnSurface, error, onError, errorContainer, onErrorContainer, outline, outlineVariant, scrim, 0L, 0L, 0L, 0L, 0L, 0L, 0L, -536870912, 15, null);
    }

    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("ColorScheme(primary=").append((Object) Color.m4171toStringimpl(this.primary)).append("onPrimary=").append((Object) Color.m4171toStringimpl(this.onPrimary)).append("primaryContainer=").append((Object) Color.m4171toStringimpl(this.primaryContainer)).append("onPrimaryContainer=").append((Object) Color.m4171toStringimpl(this.onPrimaryContainer)).append("inversePrimary=").append((Object) Color.m4171toStringimpl(this.inversePrimary)).append("secondary=").append((Object) Color.m4171toStringimpl(this.secondary)).append("onSecondary=").append((Object) Color.m4171toStringimpl(this.onSecondary)).append("secondaryContainer=").append((Object) Color.m4171toStringimpl(this.secondaryContainer)).append("onSecondaryContainer=").append((Object) Color.m4171toStringimpl(this.onSecondaryContainer)).append("tertiary=").append((Object) Color.m4171toStringimpl(this.tertiary)).append("onTertiary=").append((Object) Color.m4171toStringimpl(this.onTertiary)).append("tertiaryContainer=");
        sb.append((Object) Color.m4171toStringimpl(this.tertiaryContainer)).append("onTertiaryContainer=").append((Object) Color.m4171toStringimpl(this.onTertiaryContainer)).append("background=").append((Object) Color.m4171toStringimpl(this.background)).append("onBackground=").append((Object) Color.m4171toStringimpl(this.onBackground)).append("surface=").append((Object) Color.m4171toStringimpl(this.surface)).append("onSurface=").append((Object) Color.m4171toStringimpl(this.onSurface)).append("surfaceVariant=").append((Object) Color.m4171toStringimpl(this.surfaceVariant)).append("onSurfaceVariant=").append((Object) Color.m4171toStringimpl(this.onSurfaceVariant)).append("surfaceTint=").append((Object) Color.m4171toStringimpl(this.surfaceTint)).append("inverseSurface=").append((Object) Color.m4171toStringimpl(this.inverseSurface)).append("inverseOnSurface=").append((Object) Color.m4171toStringimpl(this.inverseOnSurface)).append("error=").append((Object) Color.m4171toStringimpl(this.error));
        sb.append("onError=").append((Object) Color.m4171toStringimpl(this.onError)).append("errorContainer=").append((Object) Color.m4171toStringimpl(this.errorContainer)).append("onErrorContainer=").append((Object) Color.m4171toStringimpl(this.onErrorContainer)).append("outline=").append((Object) Color.m4171toStringimpl(this.outline)).append("outlineVariant=").append((Object) Color.m4171toStringimpl(this.outlineVariant)).append("scrim=").append((Object) Color.m4171toStringimpl(this.scrim)).append("surfaceBright=").append((Object) Color.m4171toStringimpl(this.surfaceBright)).append("surfaceDim=").append((Object) Color.m4171toStringimpl(this.surfaceDim)).append("surfaceContainer=").append((Object) Color.m4171toStringimpl(this.surfaceContainer)).append("surfaceContainerHigh=").append((Object) Color.m4171toStringimpl(this.surfaceContainerHigh)).append("surfaceContainerHighest=").append((Object) Color.m4171toStringimpl(this.surfaceContainerHighest)).append("surfaceContainerLow=");
        sb.append((Object) Color.m4171toStringimpl(this.surfaceContainerLow)).append("surfaceContainerLowest=").append((Object) Color.m4171toStringimpl(this.surfaceContainerLowest)).append(')');
        return sb.toString();
    }

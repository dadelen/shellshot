...
public final class ProgressIndicatorDefaults {
    ...
    private static final float CircularStrokeWidth = ProgressIndicatorTokens.INSTANCE.m3471getTrackThicknessD9Ej5fM();
    private static final int LinearStrokeCap = StrokeCap.INSTANCE.m4516getRoundKaPHkGw();
    private static final int CircularDeterminateStrokeCap = StrokeCap.INSTANCE.m4516getRoundKaPHkGw();
    private static final int CircularIndeterminateStrokeCap = StrokeCap.INSTANCE.m4516getRoundKaPHkGw();
    private static final float LinearTrackStopIndicatorSize = ProgressIndicatorTokens.INSTANCE.m3470getStopSizeD9Ej5fM();
    private static final float LinearIndicatorTrackGapSize = ProgressIndicatorTokens.INSTANCE.m3467getActiveTrackSpaceD9Ej5fM();
    private static final float CircularIndicatorTrackGapSize = ProgressIndicatorTokens.INSTANCE.m3467getActiveTrackSpaceD9Ej5fM();
    ...
    public static /* synthetic */ void m2357getCircularIndicatorTrackGapSizeD9Ej5fM$annotations() {
    }
    ...
    public static /* synthetic */ void m2358getLinearIndicatorTrackGapSizeD9Ej5fM$annotations() {
    }

    /* renamed from: getLinearTrackStopIndicatorSize-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m2359getLinearTrackStopIndicatorSizeD9Ej5fM$annotations() {
    }
    ...
    public final long getCircularTrackColor(Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        return m4198getTransparent0d7_KjU;
    }
    ...
    public final void m2360drawStopIndicatorEgI2THU(DrawScope drawScope, float stopSize, long color, int strokeCap) {
        float adjustedStopSize = Math.min(drawScope.mo364toPx0680j_4(stopSize), Size.m3988getHeightimpl(drawScope.mo4713getSizeNHjbRc()));
        float stopOffset = (Size.m3988getHeightimpl(drawScope.mo4713getSizeNHjbRc()) - adjustedStopSize) / 2.0f;
        if (StrokeCap.m4511equalsimpl0(strokeCap, StrokeCap.INSTANCE.m4516getRoundKaPHkGw())) {
            DrawScope.m4694drawCircleVaOC9Bg$default(drawScope, color, adjustedStopSize / 2.0f, OffsetKt.Offset((Size.m3991getWidthimpl(drawScope.mo4713getSizeNHjbRc()) - (adjustedStopSize / 2.0f)) - stopOffset, Size.m3988getHeightimpl(drawScope.mo4713getSizeNHjbRc()) / 2.0f), 0.0f, null, null, 0, 120, null);
        } else {
            DrawScope.m4707drawRectnJ9OG0$default(drawScope, color, OffsetKt.Offset((Size.m3991getWidthimpl(drawScope.mo4713getSizeNHjbRc()) - adjustedStopSize) - stopOffset, (Size.m3988getHeightimpl(drawScope.mo4713getSizeNHjbRc()) - adjustedStopSize) / 2.0f), SizeKt.Size(adjustedStopSize, adjustedStopSize), 0.0f, null, null, 0, 120, null);
        }
    }
}

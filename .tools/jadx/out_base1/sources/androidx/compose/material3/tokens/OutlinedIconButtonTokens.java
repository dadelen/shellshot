...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m6626constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m6626constructorimpl((float) 24.0d);
    ...
    public final float m3357getContainerSizeD9Ej5fM() {
    ...
    public final float m3358getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m3359getUnselectedOutlineWidthD9Ej5fM() {

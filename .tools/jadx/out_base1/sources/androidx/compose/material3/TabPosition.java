...
public final class TabPosition {
    ...
    public final float m2588getRightD9Ej5fM() {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TabPosition) && Dp.m6631equalsimpl0(this.left, ((TabPosition) other).left) && Dp.m6631equalsimpl0(this.width, ((TabPosition) other).width) && Dp.m6631equalsimpl0(this.contentWidth, ((TabPosition) other).contentWidth);
    }

    public int hashCode() {
        int result = Dp.m6632hashCodeimpl(this.left);
        return (((result * 31) + Dp.m6632hashCodeimpl(this.width)) * 31) + Dp.m6632hashCodeimpl(this.contentWidth);
    }

    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m6637toStringimpl(this.left)) + ", right=" + ((Object) Dp.m6637toStringimpl(m2588getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m6637toStringimpl(this.width)) + ", contentWidth=" + ((Object) Dp.m6637toStringimpl(this.contentWidth)) + ')';
    }
}

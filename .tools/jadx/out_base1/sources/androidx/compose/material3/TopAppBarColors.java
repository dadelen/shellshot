...
public final class TopAppBarColors {
    ...
    public final TopAppBarColors m2854copyt635Npw(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor) {
    ...
    public final long m2853containerColorvNxB06k$material3_release(float colorTransitionFraction) {
        return ColorKt.m4214lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(colorTransitionFraction));
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof TopAppBarColors) && Color.m4164equalsimpl0(this.containerColor, ((TopAppBarColors) other).containerColor) && Color.m4164equalsimpl0(this.scrolledContainerColor, ((TopAppBarColors) other).scrolledContainerColor) && Color.m4164equalsimpl0(this.navigationIconContentColor, ((TopAppBarColors) other).navigationIconContentColor) && Color.m4164equalsimpl0(this.titleContentColor, ((TopAppBarColors) other).titleContentColor) && Color.m4164equalsimpl0(this.actionIconContentColor, ((TopAppBarColors) other).actionIconContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((result * 31) + Color.m4170hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m4170hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m4170hashCodeimpl(this.titleContentColor)) * 31) + Color.m4170hashCodeimpl(this.actionIconContentColor);
    }
}

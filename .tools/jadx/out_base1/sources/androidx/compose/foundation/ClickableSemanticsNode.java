...
final class ClickableSemanticsNode extends Modifier.Node implements SemanticsModifierNode {
    ...
    private ClickableSemanticsNode(boolean enabled, String onClickLabel, Role role, Function0<Unit> function0, String onLongClickLabel, Function0<Unit> function02) {
    ...
    public final void m271updateUMe6uN4(boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick, String onLongClickLabel, Function0<Unit> onLongClick) {
        this.enabled = enabled;
        this.onClickLabel = onClickLabel;
        this.role = role;

...
public final class PagerLazyLayoutItemProvider implements LazyLayoutItemProvider {
    ...
    public void Item(final int index, Object key, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(Item)207@8683L155,207@8629L209:LazyLayoutPager.kt#g6yjnt");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if (($dirty & 147) != 146 || !$composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1201380429, $dirty, -1, "androidx.compose.foundation.pager.PagerLazyLayoutItemProvider.Item (LazyLayoutPager.kt:206)");
            }
            index2 = index;
            key2 = key;
            LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(key2, index2, this.state.getPinnedPages(), ComposableLambdaKt.rememberComposableLambda(1142237095, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerLazyLayoutItemProvider$Item$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    ComposerKt.sourceInformation($composer3, "C*209@8782L32:LazyLayoutPager.kt#g6yjnt");
                    if (($changed2 & 3) != 2 || !$composer3.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(1142237095, $changed2, -1, "androidx.compose.foundation.pager.PagerLazyLayoutItemProvider.Item.<anonymous> (LazyLayoutPager.kt:208)");
                        }
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerLazyLayoutItemProvider$Item$2
                ...
                public final void invoke(Composer composer, int i) {
                    PagerLazyLayoutItemProvider.this.Item(index2, key2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }

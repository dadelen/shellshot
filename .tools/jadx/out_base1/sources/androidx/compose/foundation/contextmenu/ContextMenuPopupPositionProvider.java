...
public final class ContextMenuPopupPositionProvider implements PopupPositionProvider {
    ...
    public long mo336calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        return IntOffsetKt.IntOffset(ContextMenuPopupPositionProvider_androidKt.alignPopupAxis(anchorBounds.getLeft() + IntOffset.m6754getXimpl(this.localPosition), IntSize.m6796getWidthimpl(popupContentSize), IntSize.m6796getWidthimpl(windowSize), layoutDirection == LayoutDirection.Ltr), ContextMenuPopupPositionProvider_androidKt.alignPopupAxis$default(anchorBounds.getTop() + IntOffset.m6755getYimpl(this.localPosition), IntSize.m6795getHeightimpl(popupContentSize), IntSize.m6795getHeightimpl(windowSize), false, 8, null));
    }
}

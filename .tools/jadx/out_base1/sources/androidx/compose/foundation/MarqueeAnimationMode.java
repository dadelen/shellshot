...
public final class MarqueeAnimationMode {
    ...
    private static final int Immediately = m299constructorimpl(0);
    private static final int WhileFocused = m299constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ MarqueeAnimationMode m298boximpl(int i) {
        return new MarqueeAnimationMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m299constructorimpl(int i) {
        return i;
    }
    ...
    public static int m302hashCodeimpl(int i) {
    ...
    public int hashCode() {
        return m302hashCodeimpl(this.value);
    }
    ...
    public static String m303toStringimpl(int arg0) {
        if (m301equalsimpl0(arg0, Immediately)) {
            return "Immediately";
        }
        if (m301equalsimpl0(arg0, WhileFocused)) {
            return "WhileFocused";
        }
    ...
    public String toString() {
        return m303toStringimpl(this.value);
    }

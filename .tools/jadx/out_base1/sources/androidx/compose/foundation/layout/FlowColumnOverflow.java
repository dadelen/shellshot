...
public final class FlowColumnOverflow extends FlowLayoutOverflow {
    ...
    public static final class Companion {
                        ...
                        public final void invoke(Composer $composer, int $changed) {
                            ...
                            if (($changed & 3) != 2 || !$composer.getSkipping()) {
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventStart(19371081, $changed, -1, "androidx.compose.foundation.layout.FlowColumnOverflow.Companion.expandIndicator.<anonymous>.<anonymous> (FlowLayoutOverflow.kt:262)");
                                }
        ...
        public final FlowColumnOverflow m594expandOrCollapseIndicatorjt2gSs(final Function3<? super FlowColumnOverflowScope, ? super Composer, ? super Integer, Unit> function3, final Function3<? super FlowColumnOverflowScope, ? super Composer, ? super Integer, Unit> function32, int minColumnsToShowCollapse, float minWidthToShowCollapse, Composer $composer, int $changed, int i) {
            Object value$iv;
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(972645562, $changed, -1, "androidx.compose.foundation.layout.FlowColumnOverflow.Companion.expandOrCollapseIndicator (FlowLayoutOverflow.kt:304)");
            }
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                        ...
                        return ComposableLambdaKt.composableLambdaInstance(617878374, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.FlowColumnOverflow$Companion$expandOrCollapseIndicator$1$seeMoreGetter$1.1
                            ...
                            public final void invoke(Composer $composer2, int $changed2) {
                                ...
                                if (($changed2 & 3) != 2 || !$composer2.getSkipping()) {
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(617878374, $changed2, -1, "androidx.compose.foundation.layout.FlowColumnOverflow.Companion.expandOrCollapseIndicator.<anonymous>.<anonymous>.<anonymous> (FlowLayoutOverflow.kt:316)");
                                    }
                                    FlowColumnOverflowScopeImpl scope = new FlowColumnOverflowScopeImpl(FlowLayoutOverflowState.this);
                    ...
                    public final Function2<Composer, Integer, Unit> invoke(final FlowLayoutOverflowState state) {
                        ...
                        return ComposableLambdaKt.composableLambdaInstance(1004384103, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.FlowColumnOverflow$Companion$expandOrCollapseIndicator$1$collapseGetter$1.1
                            ...
                            public final void invoke(Composer $composer2, int $changed2) {
                                ...
                                if (($changed2 & 3) != 2 || !$composer2.getSkipping()) {
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(1004384103, $changed2, -1, "androidx.compose.foundation.layout.FlowColumnOverflow.Companion.expandOrCollapseIndicator.<anonymous>.<anonymous>.<anonymous> (FlowLayoutOverflow.kt:323)");
                                    }
                                    FlowColumnOverflowScopeImpl scope = new FlowColumnOverflowScopeImpl(FlowLayoutOverflowState.this);
                                    function33.invoke(scope, $composer2, 0);
                                    if (ComposerKt.isTraceInProgress()) {
                ...
                value$iv = new FlowColumnOverflow(FlowLayoutOverflow.OverflowType.ExpandOrCollapseIndicator, minColumnsToShowCollapse2, minWidthToShowCollapsePx, seeMoreGetter, collapseGetter, null);
                $composer.updateRememberedValue(value$iv);
            } else {
                value$iv = it$iv;
            }
            FlowColumnOverflow flowColumnOverflow = (FlowColumnOverflow) value$iv;
            ComposerKt.sourceInformationMarkerEnd($composer);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }

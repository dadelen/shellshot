...
public final class FlowRowOverflow extends FlowLayoutOverflow {
    ...
    public static final class Companion {
        ...
        public final FlowRowOverflow expandIndicator(final Function3<? super FlowRowOverflowScope, ? super Composer, ? super Integer, Unit> content) {
            Function1 seeMoreGetter = new Function1<FlowLayoutOverflowState, Function2<? super Composer, ? super Integer, ? extends Unit>>() { // from class: androidx.compose.foundation.layout.FlowRowOverflow$Companion$expandIndicator$seeMoreGetter$1
                        ...
                        public final void invoke(Composer $composer, int $changed) {
                            ...
                            if (($changed & 3) != 2 || !$composer.getSkipping()) {
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventStart(263270381, $changed, -1, "androidx.compose.foundation.layout.FlowRowOverflow.Companion.expandIndicator.<anonymous>.<anonymous> (FlowLayoutOverflow.kt:111)");
                                }
        ...
        public final FlowRowOverflow m621expandOrCollapseIndicatorjt2gSs(final Function3<? super FlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function3, final Function3<? super FlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function32, int minRowsToShowCollapse, float minHeightToShowCollapse, Composer $composer, int $changed, int i) {
            Object value$iv;
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-58693346, $changed, -1, "androidx.compose.foundation.layout.FlowRowOverflow.Companion.expandOrCollapseIndicator (FlowLayoutOverflow.kt:154)");
            }
            ...
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                Function1 seeMoreGetter = new Function1<FlowLayoutOverflowState, Function2<? super Composer, ? super Integer, ? extends Unit>>() { // from class: androidx.compose.foundation.layout.FlowRowOverflow$Companion$expandOrCollapseIndicator$1$seeMoreGetter$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(1);
                        ...
                        return ComposableLambdaKt.composableLambdaInstance(2094557836, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.FlowRowOverflow$Companion$expandOrCollapseIndicator$1$seeMoreGetter$1.1
                            ...
                            public final void invoke(Composer $composer2, int $changed2) {
                                ...
                                if (($changed2 & 3) != 2 || !$composer2.getSkipping()) {
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(2094557836, $changed2, -1, "androidx.compose.foundation.layout.FlowRowOverflow.Companion.expandOrCollapseIndicator.<anonymous>.<anonymous>.<anonymous> (FlowLayoutOverflow.kt:166)");
                                    }
                                    FlowRowOverflowScopeImpl scope = new FlowRowOverflowScopeImpl(FlowLayoutOverflowState.this);
                ...
                Function1 collapseGetter = new Function1<FlowLayoutOverflowState, Function2<? super Composer, ? super Integer, ? extends Unit>>() { // from class: androidx.compose.foundation.layout.FlowRowOverflow$Companion$expandOrCollapseIndicator$1$collapseGetter$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(1);
                    ...
                    public final Function2<Composer, Integer, Unit> invoke(final FlowLayoutOverflowState state) {
                        ...
                        return ComposableLambdaKt.composableLambdaInstance(-972285589, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.FlowRowOverflow$Companion$expandOrCollapseIndicator$1$collapseGetter$1.1
                            ...
                            public final void invoke(Composer $composer2, int $changed2) {
                                ...
                                if (($changed2 & 3) != 2 || !$composer2.getSkipping()) {
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(-972285589, $changed2, -1, "androidx.compose.foundation.layout.FlowRowOverflow.Companion.expandOrCollapseIndicator.<anonymous>.<anonymous>.<anonymous> (FlowLayoutOverflow.kt:173)");
                                    }
                                    FlowRowOverflowScopeImpl scope = new FlowRowOverflowScopeImpl(FlowLayoutOverflowState.this);
                                    function33.invoke(scope, $composer2, 0);
                                    if (ComposerKt.isTraceInProgress()) {
                ...
                value$iv = new FlowRowOverflow(FlowLayoutOverflow.OverflowType.ExpandOrCollapseIndicator, minRowsToShowCollapse2, minHeightToShowCollapsePx, seeMoreGetter, collapseGetter, null);
                $composer.updateRememberedValue(value$iv);
            } else {
                value$iv = it$iv;
            }
            FlowRowOverflow flowRowOverflow = (FlowRowOverflow) value$iv;
            ComposerKt.sourceInformationMarkerEnd($composer);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }

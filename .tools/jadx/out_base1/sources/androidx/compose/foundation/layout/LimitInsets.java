...
final class LimitInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        if (layoutDirection == LayoutDirection.Ltr) {
            layoutDirectionSide = WindowInsetsSides.INSTANCE.m759getAllowLeftInLtrJoeWqyM$foundation_layout_release();
        } else {
            layoutDirectionSide = WindowInsetsSides.INSTANCE.m760getAllowLeftInRtlJoeWqyM$foundation_layout_release();
        }
        boolean allowLeft = WindowInsetsSides.m753hasAnybkgdKaI$foundation_layout_release(this.sides, layoutDirectionSide);
        if (allowLeft) {
    ...
    public int getTop(Density density) {
        if (WindowInsetsSides.m753hasAnybkgdKaI$foundation_layout_release(this.sides, WindowInsetsSides.INSTANCE.m769getTopJoeWqyM())) {
    ...
    public int getRight(Density density, LayoutDirection layoutDirection) {
        int layoutDirectionSide;
        if (layoutDirection == LayoutDirection.Ltr) {
            layoutDirectionSide = WindowInsetsSides.INSTANCE.m761getAllowRightInLtrJoeWqyM$foundation_layout_release();
        } else {
            layoutDirectionSide = WindowInsetsSides.INSTANCE.m762getAllowRightInRtlJoeWqyM$foundation_layout_release();
        }
        boolean allowRight = WindowInsetsSides.m753hasAnybkgdKaI$foundation_layout_release(this.sides, layoutDirectionSide);
        if (allowRight) {
    ...
    public int getBottom(Density density) {
        if (WindowInsetsSides.m753hasAnybkgdKaI$foundation_layout_release(this.sides, WindowInsetsSides.INSTANCE.m763getBottomJoeWqyM())) {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof LimitInsets) {
            return Intrinsics.areEqual(this.insets, ((LimitInsets) other).insets) && WindowInsetsSides.m752equalsimpl0(this.sides, ((LimitInsets) other).sides);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (result * 31) + WindowInsetsSides.m754hashCodeimpl(this.sides);
    }

    public String toString() {
        return '(' + this.insets + " only " + ((Object) WindowInsetsSides.m756toStringimpl(this.sides)) + ')';
    }
}

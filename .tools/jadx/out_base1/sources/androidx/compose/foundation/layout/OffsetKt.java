...
public final class OffsetKt {
    ...
    public static final Modifier m632offsetVpY3zN4(Modifier $this$offset_u2dVpY3zN4, final float x, final float y) {
        return $this$offset_u2dVpY3zN4.then(new OffsetModifierElement(x, y, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.OffsetKt$offset$1
            ...
            public final void invoke2(InspectorInfo $this$$receiver) {
                ...
                $this$$receiver.getProperties().set("x", Dp.m6624boximpl(x));
                $this$$receiver.getProperties().set("y", Dp.m6624boximpl(y));
            }
        }, null));
    }

    /* renamed from: offset-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m633offsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m632offsetVpY3zN4(modifier, f, f2);
    }

    /* renamed from: absoluteOffset-VpY3zN4, reason: not valid java name */
    public static final Modifier m630absoluteOffsetVpY3zN4(Modifier $this$absoluteOffset_u2dVpY3zN4, final float x, final float y) {
    ...
    public static /* synthetic */ Modifier m631absoluteOffsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m6626constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m630absoluteOffsetVpY3zN4(modifier, f, f2);
    }

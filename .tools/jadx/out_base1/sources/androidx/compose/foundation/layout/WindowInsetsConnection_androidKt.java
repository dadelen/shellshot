...
public final class WindowInsetsConnection_androidKt {
        ...
        return ComposedModifierKt.composed($this$imeNestedScroll, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.WindowInsetsConnection_androidKt$imeNestedScroll$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-369978792, $changed, -1, "androidx.compose.foundation.layout.imeNestedScroll.<anonymous> (WindowInsetsConnection.android.kt:80)");
                }
                NestedScrollConnection nestedScrollConnection = WindowInsetsConnection_androidKt.m740rememberWindowInsetsConnectionVRgvIgI(WindowInsetsHolder.Companion.current($composer, 6).getIme(), WindowInsetsSides.INSTANCE.m763getBottomJoeWqyM(), $composer, 48);
    ...
    public static final NestedScrollConnection m740rememberWindowInsetsConnectionVRgvIgI(AndroidWindowInsets windowInsets, int side, Composer $composer, int $changed) {
        Object value$iv;
        Object value$iv2;
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1011341039, $changed, -1, "androidx.compose.foundation.layout.rememberWindowInsetsConnection (WindowInsetsConnection.android.kt:108)");
        }
        ...
        SideCalculator sideCalculator = SideCalculator.INSTANCE.m700chooseCalculatorni1skBw(side, layoutDirection);
        ...
        if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = new WindowInsetsNestedScrollConnection(windowInsets, view, sideCalculator, density);
            $composer.updateRememberedValue(value$iv);
        } else {
            value$iv = it$iv;
        }
        final WindowInsetsNestedScrollConnection connection = (WindowInsetsNestedScrollConnection) value$iv;
        ComposerKt.sourceInformationMarkerEnd($composer);
        ...
        if (invalid$iv2 || it$iv2 == Composer.INSTANCE.getEmpty()) {
            value$iv2 = (Function1) new Function1<DisposableEffectScope, DisposableEffectResult>() { // from class: androidx.compose.foundation.layout.WindowInsetsConnection_androidKt$rememberWindowInsetsConnection$1$1
                {
                    super(1);
                }
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        EffectsKt.DisposableEffect(connection, (Function1<? super DisposableEffectScope, ? extends DisposableEffectResult>) value$iv2, $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();

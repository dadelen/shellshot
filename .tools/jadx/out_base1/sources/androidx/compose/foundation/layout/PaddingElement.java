...
final class PaddingElement extends ModifierNodeElement<PaddingNode> {
    ...
    public /* synthetic */ PaddingElement(float f, float f2, float f3, float f4, boolean z, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m6626constructorimpl(0) : f, (i & 2) != 0 ? Dp.m6626constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m6626constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m6626constructorimpl(0) : f4, z, function1, null);
    }
    ...
    public final void m663setStart0680j_4(float f) {
        this.start = f;
    }
    ...
    public final void m664setTop0680j_4(float f) {
        this.top = f;
    }
    ...
    public final void m662setEnd0680j_4(float f) {
        this.end = f;
    }
    ...
    public final void m661setBottom0680j_4(float f) {
        this.bottom = f;
    }
    ...
    private PaddingElement(float start, float top, float end, float bottom, boolean rtlAware, Function1<? super InspectorInfo, Unit> function1) {
        ...
        if ((this.start >= 0.0f || Dp.m6631equalsimpl0(this.start, Dp.INSTANCE.m6646getUnspecifiedD9Ej5fM())) && (this.top >= 0.0f || Dp.m6631equalsimpl0(this.top, Dp.INSTANCE.m6646getUnspecifiedD9Ej5fM())) && ((this.end >= 0.0f || Dp.m6631equalsimpl0(this.end, Dp.INSTANCE.m6646getUnspecifiedD9Ej5fM())) && (this.bottom >= 0.0f || Dp.m6631equalsimpl0(this.bottom, Dp.INSTANCE.m6646getUnspecifiedD9Ej5fM())))) {
        } else {
    ...
    public void update(PaddingNode node) {
        node.m683setStart0680j_4(this.start);
        node.m684setTop0680j_4(this.top);
        node.m682setEnd0680j_4(this.end);
        node.m681setBottom0680j_4(this.bottom);
        node.setRtlAware(this.rtlAware);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = Dp.m6632hashCodeimpl(this.start);
        return (((((((result * 31) + Dp.m6632hashCodeimpl(this.top)) * 31) + Dp.m6632hashCodeimpl(this.end)) * 31) + Dp.m6632hashCodeimpl(this.bottom)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public boolean equals(Object other) {
        PaddingElement otherModifierElement = other instanceof PaddingElement ? (PaddingElement) other : null;
        return otherModifierElement != null && Dp.m6631equalsimpl0(this.start, otherModifierElement.start) && Dp.m6631equalsimpl0(this.top, otherModifierElement.top) && Dp.m6631equalsimpl0(this.end, otherModifierElement.end) && Dp.m6631equalsimpl0(this.bottom, otherModifierElement.bottom) && this.rtlAware == otherModifierElement.rtlAware;
    }

...
public final class TextFieldTextLayoutModifierNode extends Modifier.Node implements LayoutModifierNode, GlobalPositionAwareModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public TextFieldTextLayoutModifierNode(TextLayoutState textLayoutState, TransformedTextFieldState textFieldState, TextStyle textStyle, boolean singleLine, Function2<? super Density, ? super Function0<TextLayoutResult>, Unit> function2) {
        this.textLayoutState = textLayoutState;
        this.singleLine = singleLine;
        this.textLayoutState.setOnTextLayout(function2);
        this.textLayoutState.updateNonMeasureInputs(textFieldState, textStyle, this.singleLine, !this.singleLine);
    }
    ...
    public MeasureResult mo84measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        TextLayoutResult result = this.textLayoutState.m1204layoutWithNewMeasureInputshBUhpc($this$measure_u2d3p2s80s, $this$measure_u2d3p2s80s.getLayoutDirection(), (FontFamily.Resolver) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFontFamilyResolver()), constraints);
        final Placeable placeable = measurable.mo5491measureBRTryo0(Constraints.INSTANCE.m6588fitPrioritizingWidthZbe2FdA(IntSize.m6796getWidthimpl(result.getSize()), IntSize.m6796getWidthimpl(result.getSize()), IntSize.m6795getHeightimpl(result.getSize()), IntSize.m6795getHeightimpl(result.getSize())));
        TextLayoutState textLayoutState = this.textLayoutState;
        if (this.singleLine) {
            m6626constructorimpl = $this$measure_u2d3p2s80s.mo361toDpu2uoSUM(TextDelegateKt.ceilToIntPx(result.getLineBottom(0)));
        } else {
            m6626constructorimpl = Dp.m6626constructorimpl(0);
        }
        textLayoutState.m1205setMinHeightForSingleLineField0680j_4(m6626constructorimpl);
        ...
        int m6796getWidthimpl = IntSize.m6796getWidthimpl(result.getSize());
        int m6795getHeightimpl = IntSize.m6795getHeightimpl(result.getSize());
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return $this$measure_u2d3p2s80s.layout(m6796getWidthimpl, m6795getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldTextLayoutModifierNode$measure$1
            {
                super(1);
            }

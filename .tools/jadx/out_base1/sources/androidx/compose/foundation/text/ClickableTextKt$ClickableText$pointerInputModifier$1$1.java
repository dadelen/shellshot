                ...
                case 0:
                    ...
                    if (PointerMoveDetectorKt.detectMoves(pointerInputScope, pointerEventPass, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.ClickableTextKt.ClickableText.pointerInputModifier.1.1.1.1
                        ...
                        public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                            m974invokek4lQ0M(offset.getPackedValue());
                        ...
                        public final void m974invokek4lQ0M(long pos) {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                final MutableState<TextLayoutResult> mutableState = this.$layoutResult;
                this.label = 1;
                if (TapGestureDetectorKt.detectTapGestures$default($this$pointerInput, null, null, null, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.ClickableTextKt$ClickableText$pointerInputModifier$1$1.2
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(1);
                    ...
                    /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
                    public final void m975invokek4lQ0M(long pos) {

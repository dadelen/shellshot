...
public enum TextContextMenuItems {
    ...
    TextContextMenuItems(int stringId) {
    ...
    public final String resolvedString(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-309609081, $changed, -1, "androidx.compose.foundation.text.TextContextMenuItems.resolvedString (ContextMenu.android.kt:89)");
        }

...
public final class StatelessInputConnection implements InputConnection {
        ...
        if (this.batchDepth == 0 && this.editCommands.isNotEmpty()) {
            this.session.requestEdit(new Function1<EditingBuffer, Unit>() { // from class: androidx.compose.foundation.text.input.internal.StatelessInputConnection$endBatchEditInternal$1
                ...
                public final void invoke2(EditingBuffer $this$requestEdit) {
                    ...
                    this_$iv = StatelessInputConnection.this.editCommands;
    ...
    public CharSequence getSelectedText(int flags) {
        CharSequence result;
        if (TextRange.m6086getCollapsedimpl(getText().getSelection())) {
            result = null;
        } else {
    ...
    public int getCursorCapsMode(int reqModes) {
        ...
        return TextUtils.getCapsMode(getText(), TextRange.m6090getMinimpl(getText().getSelection()), reqModes);
    }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        this.session.mo1125onImeActionKlQnJC8(imeAction);
        return true;
    }

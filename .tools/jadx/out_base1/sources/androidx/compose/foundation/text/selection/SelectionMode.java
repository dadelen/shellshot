...
public enum SelectionMode {
    Vertical { // from class: androidx.compose.foundation.text.selection.SelectionMode.Vertical
        ...
        public int mo1372compare3MmeM6k$foundation_release(long position, Rect bounds) {
            if (SelectionManagerKt.m1365containsInclusiveUv8p0NA(bounds, position)) {
                return 0;
            }
            if (Offset.m3923getYimpl(position) < bounds.getTop()) {
                return -1;
            }
            return (Offset.m3922getXimpl(position) >= bounds.getLeft() || Offset.m3923getYimpl(position) >= bounds.getBottom()) ? 1 : -1;
        }
    },
    Horizontal { // from class: androidx.compose.foundation.text.selection.SelectionMode.Horizontal
        ...
        public int mo1372compare3MmeM6k$foundation_release(long position, Rect bounds) {
            ...
            if (Offset.m3922getXimpl(position) < bounds.getLeft()) {
                return -1;
            }
            return (Offset.m3923getYimpl(position) >= bounds.getTop() || Offset.m3922getXimpl(position) >= bounds.getRight()) ? 1 : -1;
        }
    };
    ...
    public abstract int mo1372compare3MmeM6k$foundation_release(long position, Rect bounds);

    /* renamed from: isSelected-2x9bVx0$foundation_release, reason: not valid java name */
    public final boolean m1373isSelected2x9bVx0$foundation_release(Rect bounds, long start, long end) {
        if (m1371containsInclusiveUv8p0NA(bounds, start) || m1371containsInclusiveUv8p0NA(bounds, end)) {
            return true;
        }
        int compareStart = mo1372compare3MmeM6k$foundation_release(start, bounds);
        int compareEnd = mo1372compare3MmeM6k$foundation_release(end, bounds);
        return (compareEnd > 0) ^ (compareStart > 0);
    }

    /* renamed from: containsInclusive-Uv8p0NA, reason: not valid java name */
    private final boolean m1371containsInclusiveUv8p0NA(Rect $this$containsInclusive_u2dUv8p0NA, long offset) {

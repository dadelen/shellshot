...
public final class TextLayoutResultProxy {
    ...
    public static /* synthetic */ int m1080getOffsetForPosition3MmeM6k$default(TextLayoutResultProxy textLayoutResultProxy, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutResultProxy.m1081getOffsetForPosition3MmeM6k(j, z);
    }

    /* renamed from: getOffsetForPosition-3MmeM6k, reason: not valid java name */
    public final int m1081getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        long coercedPosition = coerceInVisibleBounds ? m1079coercedInVisibleBoundsOfInputTextMKHz9U(position) : position;
        long relativePosition = m1083translateDecorationToInnerCoordinatesMKHz9U$foundation_release(coercedPosition);
        return this.value.m6064getOffsetForPositionk4lQ0M(relativePosition);
    }

    public final int getLineForVerticalPosition(float vertical) {
        long coercedPosition = m1079coercedInVisibleBoundsOfInputTextMKHz9U(OffsetKt.Offset(0.0f, vertical));
        float relativeVertical = Offset.m3923getYimpl(m1083translateDecorationToInnerCoordinatesMKHz9U$foundation_release(coercedPosition));
    ...
    public final boolean m1082isPositionOnTextk4lQ0M(long offset) {
        long visibleOffset = m1079coercedInVisibleBoundsOfInputTextMKHz9U(offset);
        long relativeOffset = m1083translateDecorationToInnerCoordinatesMKHz9U$foundation_release(visibleOffset);
        int line = this.value.getLineForVerticalPosition(Offset.m3923getYimpl(relativeOffset));
        return Offset.m3922getXimpl(relativeOffset) >= this.value.getLineLeft(line) && Offset.m3922getXimpl(relativeOffset) <= this.value.getLineRight(line);
    }

    /* renamed from: translateDecorationToInnerCoordinates-MK-Hz9U$foundation_release, reason: not valid java name */
    public final long m1083translateDecorationToInnerCoordinatesMKHz9U$foundation_release(long offset) {
            ...
            if (innerCoords != null) {
                ...
                if (it != null) {
                    ...
                    if (decorationCoords != null) {
                        return innerCoords.mo5500localPositionOfR5De75A(decorationCoords, offset);
                    }
                }
                return offset;
            }
    ...
    public final long m1084translateInnerToDecorationCoordinatesMKHz9U$foundation_release(long offset) {
        LayoutCoordinates innerCoords = this.innerTextFieldCoordinates;
        if (innerCoords != null) {
            if (!innerCoords.isAttached()) {
                innerCoords = null;
            ...
            if (innerCoords != null) {
                ...
                if (it != null) {
                    LayoutCoordinates decorationCoords = it.isAttached() ? it : null;
                    if (decorationCoords != null) {
                        return decorationCoords.mo5500localPositionOfR5De75A(innerCoords, offset);
                    }
                }
                return offset;
            }
    ...
    */
    private final long m1079coercedInVisibleBoundsOfInputTextMKHz9U(long r7) {
        /*
            r6 = this;
        ...
        L26:
            long r0 = androidx.compose.foundation.text.TextLayoutResultProxyKt.m1085access$coerceIn3MmeM6k(r7, r3)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.TextLayoutResultProxy.m1079coercedInVisibleBoundsOfInputTextMKHz9U(long):long");
    }
}

            ...
            if (!(this.firstVisibleItemIndices.length == 0)) {
                if (!(this.firstVisibleItemScrollOffsets.length == 0)) {
                    ...
                    for (int i = 0; i < length; i++) {
                        iArr[i] = this.firstVisibleItemScrollOffsets[i] - delta;
                    }
                    this.firstVisibleItemScrollOffsets = iArr;

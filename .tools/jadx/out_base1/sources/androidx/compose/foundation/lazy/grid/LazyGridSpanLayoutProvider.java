...
public final class LazyGridSpanLayoutProvider {
    ...
    private final List<GridItemSpan> getDefaultSpans(int currentSlotsPerLine) {
        ...
        for (int i = 0; i < currentSlotsPerLine; i++) {
            arrayList.add(GridItemSpan.m791boximpl(LazyGridSpanKt.GridItemSpan(1)));
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:25:0x00b2 A[ADDED_TO_REGION, LOOP:0: B:25:0x00b2->B:54:0x00b2, LOOP_START, PHI: r2 r4 r5
  0x00b2: PHI (r2v7 'currentLine' int) = (r2v6 'currentLine' int), (r2v8 'currentLine' int) binds: [B:24:0x00b0, B:54:0x00b2] A[DONT_GENERATE, DONT_INLINE]
  0x00b2: PHI (r4v6 'currentItemIndex' int) = (r4v5 'currentItemIndex' int), (r4v9 'currentItemIndex' int) binds: [B:24:0x00b0, B:54:0x00b2] A[DONT_GENERATE, DONT_INLINE]
  0x00b2: PHI (r5v4 'knownCurrentItemSpan' int) = (r5v3 'knownCurrentItemSpan' int), (r5v11 'knownCurrentItemSpan' int) binds: [B:24:0x00b0, B:54:0x00b2] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public final int getLineIndexOfItem(final int itemIndex) {
        ...
        return spanOf(itemIndex, i - spansUsed) + spansUsed > this.slotsPerLine ? currentLine + 1 : currentLine;
    }

    public final int spanOf(int itemIndex, int maxSpan) {
        LazyGridItemSpanScopeImpl $this$spanOf_u24lambda_u2410 = LazyGridItemSpanScopeImpl.INSTANCE;
        $this$spanOf_u24lambda_u2410.setMaxCurrentLineSpan(maxSpan);
        $this$spanOf_u24lambda_u2410.setMaxLineSpan(this.slotsPerLine);
        ...
        long span = interval.getValue().getSpan().invoke($this$spanOf_u24lambda_u2410, Integer.valueOf(localIntervalIndex)).getPackedValue();
        return GridItemSpan.m795getCurrentLineSpanimpl(span);
    }

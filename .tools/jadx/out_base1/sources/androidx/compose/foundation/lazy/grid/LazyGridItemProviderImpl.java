...
final class LazyGridItemProviderImpl implements LazyGridItemProvider {
    ...
    public void Item(final int index, Object key, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(Item)75@2938L162,75@2884L216:LazyGridItemProvider.kt#7791vq");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
            ...
            LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(key2, index2, this.state.getPinnedItems(), ComposableLambdaKt.rememberComposableLambda(726189336, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridItemProviderImpl$Item$1
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 3) != 2 || !$composer3.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(726189336, $changed2, -1, "androidx.compose.foundation.lazy.grid.LazyGridItemProviderImpl.Item.<anonymous> (LazyGridItemProvider.kt:76)");
                        }
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridItemProviderImpl$Item$2
                ...
                public final void invoke(Composer composer, int i) {
                    LazyGridItemProviderImpl.this.Item(index2, key2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }

...
public final class HoverInteractionKt {
    public static final State<Boolean> collectIsHoveredAsState(InteractionSource $this$collectIsHoveredAsState, Composer $composer, int $changed) {
        Object value$iv;
        HoverInteractionKt$collectIsHoveredAsState$1$1 value$iv2;
        ...
        MutableState isHovered = (MutableState) value$iv;
        ...
        if (invalid$iv || it$iv2 == Composer.INSTANCE.getEmpty()) {
            value$iv2 = new HoverInteractionKt$collectIsHoveredAsState$1$1($this$collectIsHoveredAsState, isHovered, null);
            $composer.updateRememberedValue(value$iv2);
        } else {
            value$iv2 = it$iv2;
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        EffectsKt.LaunchedEffect($this$collectIsHoveredAsState, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) value$iv2, $composer, $changed & 14);
        if (ComposerKt.isTraceInProgress()) {

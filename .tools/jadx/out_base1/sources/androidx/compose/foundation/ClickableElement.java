...
final class ClickableElement extends ModifierNodeElement<ClickableNode> {
    ...
    private ClickableElement(MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean enabled, String onClickLabel, Role role, Function0<Unit> function0) {
    ...
    public void update(ClickableNode node) {
        node.m268updateQzZPfjk(this.interactionSource, this.indicationNodeFactory, this.enabled, this.onClickLabel, this.role, this.onClick);
    }

...
final class DialogWrapper extends ComponentDialog implements ViewRootForInspector {
    ...
    public DialogWrapper(Function0<Unit> function0, DialogProperties properties, View composeView, LayoutDirection layoutDirection, Density density, UUID dialogId) {
        ...
        this.defaultSoftInputMode = window.getAttributes().softInputMode & AppPrefs.MAX_RECENT_PROCESSED_KEYS;
        ...
        $this$_init__u24lambda_u241.setTag(R.id.compose_view_saveable_id_tag, "Dialog:" + dialogId);
        ...
        $this$_init__u24lambda_u241.setOutlineProvider(new ViewOutlineProvider() { // from class: androidx.compose.ui.window.DialogWrapper$1$2

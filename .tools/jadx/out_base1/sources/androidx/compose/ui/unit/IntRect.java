...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m6772getSizeYbymL2g$annotations() {
    }
    ...
    public final long m6780getSizeYbymL2g() {
    ...
    public final IntRect m6784translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m6754getXimpl(offset), this.top + IntOffset.m6755getYimpl(offset), this.right + IntOffset.m6754getXimpl(offset), this.bottom + IntOffset.m6755getYimpl(offset));
    }

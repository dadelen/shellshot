...
final class DragAndDropModifierOnDragListener implements View.OnDragListener, DragAndDropManager {
    ...
    public boolean onDrag(View view, DragEvent event) {
        ...
        switch (event.getAction()) {
            case 1:
                ...
                Iterable $this$forEach$iv = this.interestedNodes;
                for (Object element$iv : $this$forEach$iv) {
                    DragAndDropModifierNode it = (DragAndDropModifierNode) element$iv;
    ...
    public boolean mo3793drag12SF9DM(DragAndDropTransferData transferData, long decorationSize, Function1<? super DrawScope, Unit> drawDragDecoration) {
        return this.startDrag.invoke(transferData, Size.m3979boximpl(decorationSize), drawDragDecoration).booleanValue();
    }

    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<PlatformTextInputInterceptor, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure($result);
                    PlatformTextInputInterceptor interceptor = (PlatformTextInputInterceptor) this.L$0;
                    this.label = 1;
                    if (interceptor.interceptStartInputMethod(this.$request, this.$parentSession, this) != coroutine_suspended) {
                        break;
                    } else {
                        return coroutine_suspended;
                    }

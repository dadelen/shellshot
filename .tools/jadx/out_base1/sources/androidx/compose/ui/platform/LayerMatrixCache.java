...
public final class LayerMatrixCache<T> {
    ...
    public final float[] m5853calculateMatrixGrdbGEg(T target) {
        float[] it = this.matrixCache;
        if (it == null) {
            it = androidx.compose.ui.graphics.Matrix.m4393constructorimpl$default(null, 1, null);
            this.matrixCache = it;
        }
        if (!this.isDirty) {
            return it;
        ...
        if (prevMatrix == null || !Intrinsics.areEqual(it2, prevMatrix)) {
            AndroidMatrixConversions_androidKt.m4034setFromtUYjHk(it, it2);
    ...
    public final float[] m5852calculateInverseMatrixbWbORWo(T target) {
        ...
        if (this.isInverseDirty) {
            float[] normalMatrix = m5853calculateMatrixGrdbGEg(target);
            this.isInverseValid = InvertMatrixKt.m5850invertToJiSxe2E(normalMatrix, it);

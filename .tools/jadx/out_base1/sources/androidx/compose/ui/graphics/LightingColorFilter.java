...
public final class LightingColorFilter extends ColorFilter {
    ...
    private LightingColorFilter(long multiply, long add) {
        this(multiply, add, AndroidColorFilter_androidKt.m4028actualLightingColorFilterOWjLjI(multiply, add), null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof LightingColorFilter) && Color.m4164equalsimpl0(this.multiply, ((LightingColorFilter) other).multiply) && Color.m4164equalsimpl0(this.add, ((LightingColorFilter) other).add);
    }

    public int hashCode() {
        int result = Color.m4170hashCodeimpl(this.multiply);
        return (result * 31) + Color.m4170hashCodeimpl(this.add);
    }

    public String toString() {
        return "LightingColorFilter(multiply=" + ((Object) Color.m4171toStringimpl(this.multiply)) + ", add=" + ((Object) Color.m4171toStringimpl(this.add)) + ')';
    }
}

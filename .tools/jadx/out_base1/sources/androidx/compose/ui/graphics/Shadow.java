...
public final class Shadow {
    ...
    public static /* synthetic */ void m4484getColor0d7_KjU$annotations() {
    }

    /* renamed from: getOffset-F1C5BW0$annotations, reason: not valid java name */
    public static /* synthetic */ void m4485getOffsetF1C5BW0$annotations() {
    }
    ...
    public /* synthetic */ Shadow(long j, long j2, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4278190080L) : j, (i & 2) != 0 ? Offset.INSTANCE.m3938getZeroF1C5BW0() : j2, (i & 4) != 0 ? 0.0f : f, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Shadow) && Color.m4164equalsimpl0(this.color, ((Shadow) other).color) && Offset.m3919equalsimpl0(this.offset, ((Shadow) other).offset)) {
    ...
    public int hashCode() {
        ...
        return (((result * 31) + Offset.m3924hashCodeimpl(this.offset)) * 31) + Float.hashCode(this.blurRadius);
    }

    public String toString() {
        return "Shadow(color=" + ((Object) Color.m4171toStringimpl(this.color)) + ", offset=" + ((Object) Offset.m3930toStringimpl(this.offset)) + ", blurRadius=" + this.blurRadius + ')';
    }

    /* renamed from: copy-qcb84PM, reason: not valid java name */
    public final Shadow m4486copyqcb84PM(long color, long offset, float blurRadius) {

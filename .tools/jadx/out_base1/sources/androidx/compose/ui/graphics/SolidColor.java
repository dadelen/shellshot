...
public final class SolidColor extends Brush {
    ...
    public void mo4110applyToPq9zytI(long size, Paint p, float alpha) {
        p.setAlpha(1.0f);
        boolean z = alpha == 1.0f;
        long j = this.value;
        if (!z) {
            j = Color.m4161copywmQWz5c(j, (r12 & 1) != 0 ? Color.m4165getAlphaimpl(j) : Color.m4165getAlphaimpl(this.value) * alpha, (r12 & 2) != 0 ? Color.m4169getRedimpl(j) : 0.0f, (r12 & 4) != 0 ? Color.m4168getGreenimpl(j) : 0.0f, (r12 & 8) != 0 ? Color.m4166getBlueimpl(j) : 0.0f);
        }
        p.mo4042setColor8_81llA(j);
        if (p.getShader() != null) {
            p.setShader(null);
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SolidColor) && Color.m4164equalsimpl0(this.value, ((SolidColor) other).value);
    }
    ...
    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m4171toStringimpl(this.value)) + ')';
    }
}

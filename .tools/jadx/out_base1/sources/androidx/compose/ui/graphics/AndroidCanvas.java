...
public final class AndroidCanvas implements Canvas {
    ...
    public void mo4018concat58bKbWc(float[] matrix) {
        if (!MatrixKt.m4417isIdentity58bKbWc(matrix)) {
            android.graphics.Matrix frameworkMatrix = new android.graphics.Matrix();
            AndroidMatrixConversions_androidKt.m4033setFromEL8BTi8(frameworkMatrix, matrix);
    ...
    public void mo4017clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp) {
        this.internalCanvas.clipRect(left, top, right, bottom, m4026toRegionOp7u2Bmg(clipOp));
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: clipPath-mtrdD-E, reason: not valid java name */
    public void mo4016clipPathmtrdDE(Path path, int clipOp) {
        android.graphics.Canvas canvas = this.internalCanvas;
        if (path instanceof AndroidPath) {
            canvas.clipPath(((AndroidPath) path).getInternalPath(), m4026toRegionOp7u2Bmg(clipOp));
            return;
        }
    ...
    public final Region.Op m4026toRegionOp7u2Bmg(int $this$toRegionOp_u2d_u2d7u2Bmg) {
        return ClipOp.m4147equalsimpl0($this$toRegionOp_u2d_u2d7u2Bmg, ClipOp.INSTANCE.m4151getDifferencertfAjoo()) ? Region.Op.DIFFERENCE : Region.Op.INTERSECT;
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: drawLine-Wko1d7g, reason: not valid java name */
    public void mo4022drawLineWko1d7g(long p1, long p2, Paint paint) {
        this.internalCanvas.drawLine(Offset.m3922getXimpl(p1), Offset.m3923getYimpl(p1), Offset.m3922getXimpl(p2), Offset.m3923getYimpl(p2), paint.getInternalPaint());
    }
    ...
    public void mo4019drawCircle9KIMszo(long center, float radius, Paint paint) {
        this.internalCanvas.drawCircle(Offset.m3922getXimpl(center), Offset.m3923getYimpl(center), radius, paint.getInternalPaint());
    }
    ...
    public void mo4020drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint) {
        this.internalCanvas.drawBitmap(AndroidImageBitmap_androidKt.asAndroidBitmap(image), Offset.m3922getXimpl(topLeftOffset), Offset.m3923getYimpl(topLeftOffset), paint.getInternalPaint());
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: drawImageRect-HPBpro0, reason: not valid java name */
    public void mo4021drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint) {
        ...
        $this$drawImageRect_HPBpro0_u24lambda_u240.left = IntOffset.m6754getXimpl(srcOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u240.top = IntOffset.m6755getYimpl(srcOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u240.right = IntOffset.m6754getXimpl(srcOffset) + IntSize.m6796getWidthimpl(srcSize);
        $this$drawImageRect_HPBpro0_u24lambda_u240.bottom = IntOffset.m6755getYimpl(srcOffset) + IntSize.m6795getHeightimpl(srcSize);
        ...
        $this$drawImageRect_HPBpro0_u24lambda_u241.left = IntOffset.m6754getXimpl(dstOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u241.top = IntOffset.m6755getYimpl(dstOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u241.right = IntOffset.m6754getXimpl(dstOffset) + IntSize.m6796getWidthimpl(dstSize);
        $this$drawImageRect_HPBpro0_u24lambda_u241.bottom = IntOffset.m6755getYimpl(dstOffset) + IntSize.m6795getHeightimpl(dstSize);
    ...
    public void mo4023drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint) {
        if (!PointMode.m4463equalsimpl0(pointMode, PointMode.INSTANCE.m4467getLinesr_lszbg())) {
            if (!PointMode.m4463equalsimpl0(pointMode, PointMode.INSTANCE.m4469getPolygonr_lszbg())) {
                if (PointMode.m4463equalsimpl0(pointMode, PointMode.INSTANCE.m4468getPointsr_lszbg())) {
    ...
    private final void drawPoints(List<Offset> points, Paint paint) {
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            this.internalCanvas.drawPoint(Offset.m3922getXimpl(point), Offset.m3923getYimpl(point), paint.getInternalPaint());
        }
    }
    ...
    private final void drawLines(List<Offset> points, Paint paint, int stepBy) {
        if (points.size() >= 2) {
            ...
            while (i < points.size() - 1) {
                ...
                this.internalCanvas.drawLine(Offset.m3922getXimpl(p1), Offset.m3923getYimpl(p1), Offset.m3922getXimpl(p2), Offset.m3923getYimpl(p2), frameworkPaint);
                i += stepBy;
            }
        }
    }
    ...
    public void mo4024drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint) {
    ...
    public void mo4025drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint) {
        this.internalCanvas.drawVertices(AndroidVertexMode_androidKt.m4069toAndroidVertexModeJOOmi9M(vertices.getVertexMode()), vertices.getPositions().length, vertices.getPositions(), 0, vertices.getTextureCoordinates(), 0, vertices.getColors(), 0, vertices.getIndices(), 0, vertices.getIndices().length, paint.getInternalPaint());
    }
}

...
public final class ColorKt {
    ...
    */
    ...
    public static final long Color(int color) {
        return Color.m4159constructorimpl(ULong.m7390constructorimpl(ULong.m7390constructorimpl(color) << 32));
    }

    public static final long Color(long color) {
        return Color.m4159constructorimpl(ULong.m7390constructorimpl(color << 32));
    }
    ...
    public static final int m4217toArgb8_81llA(long $this$toArgb_u2d8_81llA) {
        return (int) ULong.m7390constructorimpl(Color.m4160convertvNxB06k($this$toArgb_u2d8_81llA, ColorSpaces.INSTANCE.getSrgb()) >>> 32);
    }

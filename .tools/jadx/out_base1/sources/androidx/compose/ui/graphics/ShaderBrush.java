...
public abstract class ShaderBrush extends Brush {
    ...
    public abstract Shader mo4132createShaderuvyYCjk(long size);

    public ShaderBrush() {
        super(null);
        this.createdSize = Size.INSTANCE.m3999getUnspecifiedNHjbRc();
    }

    @Override // androidx.compose.ui.graphics.Brush
    /* renamed from: applyTo-Pq9zytI */
    public final void mo4110applyToPq9zytI(long size, Paint p, float alpha) {
        Shader shader = this.internalShader;
        if (shader == null || !Size.m3987equalsimpl0(this.createdSize, size)) {
            if (Size.m3993isEmptyimpl(size)) {
                shader = null;
                this.internalShader = null;
                this.createdSize = Size.INSTANCE.m3999getUnspecifiedNHjbRc();
            } else {
                Shader it = mo4132createShaderuvyYCjk(size);
                this.internalShader = it;
                shader = it;
                this.createdSize = size;
            }
        }
        if (!Color.m4164equalsimpl0(p.mo4036getColor0d7_KjU(), Color.INSTANCE.m4189getBlack0d7_KjU())) {
            p.mo4042setColor8_81llA(Color.INSTANCE.m4189getBlack0d7_KjU());
        }

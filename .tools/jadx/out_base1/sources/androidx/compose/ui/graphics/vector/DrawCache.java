...
public final class DrawCache {
    ...
    private int config = ImageBitmapConfig.INSTANCE.m4383getArgb8888_sVssgQ();
    ...
    public final void m4839drawCachedImageFqjB98A(int config, long size, Density density, LayoutDirection layoutDirection, Function1<? super DrawScope, Unit> block) {
        this.scopeDensity = density;
        this.layoutDirection = layoutDirection;
        ImageBitmap targetImage = this.mCachedImage;
        Canvas targetCanvas = this.cachedCanvas;
        if (targetImage == null || targetCanvas == null || IntSize.m6796getWidthimpl(size) > targetImage.getWidth() || IntSize.m6795getHeightimpl(size) > targetImage.getHeight() || !ImageBitmapConfig.m4378equalsimpl0(this.config, config)) {
            targetImage = ImageBitmapKt.m4388ImageBitmapx__hDU$default(IntSize.m6796getWidthimpl(size), IntSize.m6795getHeightimpl(size), config, false, null, 24, null);
        ...
        long size$iv = IntSizeKt.m6808toSizeozmzZPI(size);
    ...
    public final void drawInto(DrawScope target, float alpha, ColorFilter colorFilter) {
        ...
        DrawScope.m4696drawImageAZ2fEMs$default(target, targetImage, 0L, this.size, 0L, 0L, alpha, null, colorFilter, 0, 0, 858, null);
    }

    private final void clear(DrawScope $this$clear) {
        DrawScope.m4707drawRectnJ9OG0$default($this$clear, Color.INSTANCE.m4189getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.INSTANCE.m4078getClear0nO6VwU(), 62, null);
    }
}

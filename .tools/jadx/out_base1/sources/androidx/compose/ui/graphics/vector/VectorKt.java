...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.INSTANCE.m4515getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.INSTANCE.m4526getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.INSTANCE.m4103getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.INSTANCE.m4198getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.INSTANCE.m4445getNonZeroRgk1Os();
    ...
    public static final boolean m4863rgbEqualOWjLjI(long $this$rgbEqual_u2d_u2dOWjLjI, long other) {
        if (Color.m4169getRedimpl($this$rgbEqual_u2d_u2dOWjLjI) == Color.m4169getRedimpl(other)) {
            if (Color.m4168getGreenimpl($this$rgbEqual_u2d_u2dOWjLjI) == Color.m4168getGreenimpl(other)) {
                if (Color.m4166getBlueimpl($this$rgbEqual_u2d_u2dOWjLjI) == Color.m4166getBlueimpl(other)) {
                    return true;
                }
            }
        }
    ...
    public static final boolean tintableWithAlphaMask(ColorFilter $this$tintableWithAlphaMask) {
        return $this$tintableWithAlphaMask instanceof BlendModeColorFilter ? BlendMode.m4074equalsimpl0(((BlendModeColorFilter) $this$tintableWithAlphaMask).getBlendMode(), BlendMode.INSTANCE.m4103getSrcIn0nO6VwU()) || BlendMode.m4074equalsimpl0(((BlendModeColorFilter) $this$tintableWithAlphaMask).getBlendMode(), BlendMode.INSTANCE.m4105getSrcOver0nO6VwU()) : $this$tintableWithAlphaMask == null;
    }
}

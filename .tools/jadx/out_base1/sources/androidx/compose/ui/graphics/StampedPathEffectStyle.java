...
public final class StampedPathEffectStyle {
    ...
    private static final int Translate = m4499constructorimpl(0);
    private static final int Rotate = m4499constructorimpl(1);
    private static final int Morph = m4499constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StampedPathEffectStyle m4498boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m4507getTranslateYpspkwk() {
            return StampedPathEffectStyle.Translate;
        }

        /* renamed from: getRotate-Ypspkwk, reason: not valid java name */
        public final int m4506getRotateYpspkwk() {
            return StampedPathEffectStyle.Rotate;
        }

        /* renamed from: getMorph-Ypspkwk, reason: not valid java name */
        public final int m4505getMorphYpspkwk() {
            return StampedPathEffectStyle.Morph;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4503toStringimpl(int arg0) {
        return m4501equalsimpl0(arg0, Translate) ? "Translate" : m4501equalsimpl0(arg0, Rotate) ? "Rotate" : m4501equalsimpl0(arg0, Morph) ? "Morph" : "Unknown";
    }

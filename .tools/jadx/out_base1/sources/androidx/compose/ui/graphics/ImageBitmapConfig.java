...
public final class ImageBitmapConfig {
    ...
    private static final int Argb8888 = m4376constructorimpl(0);
    private static final int Alpha8 = m4376constructorimpl(1);
    private static final int Rgb565 = m4376constructorimpl(2);
    private static final int F16 = m4376constructorimpl(3);
    private static final int Gpu = m4376constructorimpl(4);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ImageBitmapConfig m4375boximpl(int i) {
    ...
    public static boolean m4377equalsimpl(int i, Object obj) {
        return (obj instanceof ImageBitmapConfig) && i == ((ImageBitmapConfig) obj).m4381unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m4383getArgb8888_sVssgQ() {
            return ImageBitmapConfig.Argb8888;
        }

        /* renamed from: getAlpha8-_sVssgQ, reason: not valid java name */
        public final int m4382getAlpha8_sVssgQ() {
            return ImageBitmapConfig.Alpha8;
        }

        /* renamed from: getRgb565-_sVssgQ, reason: not valid java name */
        public final int m4386getRgb565_sVssgQ() {
            return ImageBitmapConfig.Rgb565;
        }

        /* renamed from: getF16-_sVssgQ, reason: not valid java name */
        public final int m4384getF16_sVssgQ() {
            return ImageBitmapConfig.F16;
        }

        /* renamed from: getGpu-_sVssgQ, reason: not valid java name */
        public final int m4385getGpu_sVssgQ() {
    ...
    public static String m4380toStringimpl(int arg0) {
        return m4378equalsimpl0(arg0, Argb8888) ? "Argb8888" : m4378equalsimpl0(arg0, Alpha8) ? "Alpha8" : m4378equalsimpl0(arg0, Rgb565) ? "Rgb565" : m4378equalsimpl0(arg0, F16) ? "F16" : m4378equalsimpl0(arg0, Gpu) ? "Gpu" : "Unknown";
    }

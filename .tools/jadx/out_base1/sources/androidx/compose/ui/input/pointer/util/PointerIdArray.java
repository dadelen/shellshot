...
public final class PointerIdArray {
    ...
    public final long m5457get_I2yYro(int index) {
        return PointerId.m5342constructorimpl(this.internalArray[index]);
    }

    /* renamed from: remove-0FcD4WY, reason: not valid java name */
    public final boolean m5458remove0FcD4WY(long pointerId) {
    ...
    public final boolean remove(long pointerIdValue) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            if (pointerIdValue == m5457get_I2yYro(i2)) {
                removeAt(i2);
                return true;
            }
        }
    ...
    public final boolean m5455add0FcD4WY(long pointerId) {
        return add(pointerId);
    }

    public final void set(int index, long value) {
        if (index >= this.internalArray.length) {
            long[] copyOf = Arrays.copyOf(this.internalArray, Math.max(index + 1, this.internalArray.length * 2));
    ...
    public final void m5459setDmW0f2w(int index, long pointerId) {
        set(index, pointerId);
    }
    ...
    public final boolean m5456contains0FcD4WY(long pointerId) {

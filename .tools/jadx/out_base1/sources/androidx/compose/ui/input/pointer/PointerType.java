...
public final class PointerType {
    ...
    private static final int Unknown = m5432constructorimpl(0);
    private static final int Touch = m5432constructorimpl(1);
    private static final int Mouse = m5432constructorimpl(2);
    private static final int Stylus = m5432constructorimpl(3);
    private static final int Eraser = m5432constructorimpl(4);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PointerType m5431boximpl(int i) {
        return new PointerType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m5432constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m5433equalsimpl(int i, Object obj) {
        return (obj instanceof PointerType) && i == ((PointerType) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5434equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m5435hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m5433equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m5435hashCodeimpl(this.value);
    }
    ...
    public static String m5436toStringimpl(int arg0) {
        switch (arg0) {
            case 1:
                return "Touch";
            case 2:
    ...
    public String toString() {
        return m5436toStringimpl(this.value);
    }

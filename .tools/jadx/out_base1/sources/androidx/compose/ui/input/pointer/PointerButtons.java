...
public final class PointerButtons {
    ...
    public static final /* synthetic */ PointerButtons m5294boximpl(int i) {
    ...
    public static String m5299toStringimpl(int i) {
        return "PointerButtons(packedValue=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m5296equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m5298hashCodeimpl(this.packedValue);
    }

...
public final /* data */ class ViewInfo {
    ...
    public static /* synthetic */ ViewInfo copy$default(ViewInfo viewInfo, String str, int i, IntRect intRect, SourceLocation sourceLocation, List list, Object obj, int i2, Object obj2) {
        ...
        List list2 = list;
        Object obj3 = obj;
        return viewInfo.copy(str, i, intRect, sourceLocation, list2, obj3);
    }
    ...
    public ViewInfo(String fileName, int lineNumber, IntRect bounds, SourceLocation location, List<ViewInfo> list, Object layoutInfo) {
    ...
    public String toString() {
        String str;
        StringBuilder append = new StringBuilder().append('(').append(this.fileName).append(AbstractJsonLexerKt.COLON).append(this.lineNumber).append(",\n            |bounds=(top=").append(this.bounds.getTop()).append(", left=").append(this.bounds.getLeft()).append(",\n            |location=");

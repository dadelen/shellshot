...
public final class AnimatedVisibilityComposeAnimation implements ComposeAnimation {
    ...
    private final Set<AnimatedVisibilityState> states = SetsKt.setOf((Object[]) new AnimatedVisibilityState[]{AnimatedVisibilityState.m6558boximpl(AnimatedVisibilityState.INSTANCE.m6565getEnterjXw82LU()), AnimatedVisibilityState.m6558boximpl(AnimatedVisibilityState.INSTANCE.m6566getExitjXw82LU())});
    ...
    public Transition<Boolean> m6551getAnimationObject() {
    ...
    public final Transition<Object> getChildTransition() {
        Object orNull = CollectionsKt.getOrNull(m6551getAnimationObject().getTransitions(), 0);

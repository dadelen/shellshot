...
public final /* data */ class Rect {
    ...
    public static /* synthetic */ void m3947getSizeNHjbRc$annotations() {
    }
    ...
    public final Rect m3959translatek4lQ0M(long offset) {
        return new Rect(this.left + Offset.m3922getXimpl(offset), this.top + Offset.m3923getYimpl(offset), this.right + Offset.m3922getXimpl(offset), this.bottom + Offset.m3923getYimpl(offset));
    }
    ...
    public final boolean m3948containsk4lQ0M(long offset) {
        return Offset.m3922getXimpl(offset) >= this.left && Offset.m3922getXimpl(offset) < this.right && Offset.m3923getYimpl(offset) >= this.top && Offset.m3923getYimpl(offset) < this.bottom;
    }

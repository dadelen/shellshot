    ...
    public android.graphics.Typeface loadBlocking(Font font) {
        ...
        if (FontLoadingStrategy.m6188equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m6193getBlockingPKNRLFQ())) {
            ...
            try {
                ...
                m7216constructorimpl = Result.m7216constructorimpl(load);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                m7216constructorimpl = Result.m7216constructorimpl(ResultKt.createFailure(th));
            }
            typeface = (android.graphics.Typeface) (Result.m7222isFailureimpl(m7216constructorimpl) ? null : m7216constructorimpl);
        } else {

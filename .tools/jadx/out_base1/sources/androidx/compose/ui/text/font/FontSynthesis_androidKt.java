...
public final class FontSynthesis_androidKt {
    ...
    public static final Object m6222synthesizeTypefaceFxwP2eA(int $this$synthesizeTypeface_u2dFxwP2eA, Object typeface, Font font, FontWeight requestedWeight, int requestedStyle) {
        int finalFontWeight;
        boolean finalFontStyle;
        if (!(typeface instanceof android.graphics.Typeface)) {
            return typeface;
        }
        boolean synthesizeWeight = FontSynthesis.m6215isWeightOnimpl$ui_text_release($this$synthesizeTypeface_u2dFxwP2eA) && !Intrinsics.areEqual(font.getWeight(), requestedWeight) && requestedWeight.compareTo(AndroidFontUtils_androidKt.getAndroidBold(FontWeight.INSTANCE)) >= 0 && font.getWeight().compareTo(AndroidFontUtils_androidKt.getAndroidBold(FontWeight.INSTANCE)) < 0;
        boolean synthesizeStyle = FontSynthesis.m6214isStyleOnimpl$ui_text_release($this$synthesizeTypeface_u2dFxwP2eA) && !FontStyle.m6201equalsimpl0(requestedStyle, font.getStyle());
        ...
        if (synthesizeStyle) {
            finalFontStyle = FontStyle.m6201equalsimpl0(requestedStyle, FontStyle.INSTANCE.m6207getItalic_LCdwA());
        } else {
            finalFontStyle = FontStyle.m6201equalsimpl0(font.getStyle(), FontStyle.INSTANCE.m6207getItalic_LCdwA());
        }

...
public final class FontListFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public final Object preload(FontFamily family, PlatformFontLoader resourceLoader, Continuation<? super Unit> continuation) {
        ...
        while (index$iv$iv < size) {
            ...
            if (FontLoadingStrategy.m6188equalsimpl0(it.getLoadingStrategy(), FontLoadingStrategy.INSTANCE.m6192getAsyncPKNRLFQ())) {
                target$iv.add(it);
            }
            index$iv$iv++;
        ...
        while (index$iv$iv2 < size2) {
            ...
            target$iv2.add(TuplesKt.to(it2.getWeight(), FontStyle.m6198boximpl(it2.getStyle())));
            index$iv$iv2++;
        ...
        while (index$iv < size4) {
            ...
            int fontStyle = ((FontStyle) pair.component2()).m6204unboximpl();
            List matched = fontMatcher.m6197matchFontRetOiIg((List<? extends Font>) allFonts, fontWeight, fontStyle);
            List allFonts2 = allFonts;
            TypefaceRequest typeRequest = new TypefaceRequest(family, fontWeight, fontStyle, FontSynthesis.INSTANCE.m6218getAllGVVA2EU(), resourceLoader.getCacheKey(), null);
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        List matched = fontMatcher.m6197matchFontRetOiIg(((FontListFontFamily) typefaceRequest.getFontFamily()).getFonts(), typefaceRequest.getFontWeight(), typefaceRequest.m6246getFontStyle_LCdwA());

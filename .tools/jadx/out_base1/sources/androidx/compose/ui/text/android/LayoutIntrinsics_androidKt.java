...
public final class LayoutIntrinsics_androidKt {
    public static final float minIntrinsicWidth(CharSequence text, TextPaint paint) {
        ...
        PriorityQueue longestWordCandidates = new PriorityQueue(10, new Comparator() { // from class: androidx.compose.ui.text.android.LayoutIntrinsics_androidKt$$ExternalSyntheticLambda0
    ...
    static final int minIntrinsicWidth$lambda$0(Pair left, Pair right) {

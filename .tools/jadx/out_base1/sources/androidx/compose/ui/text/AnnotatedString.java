...
public final class AnnotatedString implements CharSequence {
    ...
    */
    ...
    public final AnnotatedString m5943subSequence5zctL8(long range) {
        return subSequence(TextRange.m6090getMinimpl(range), TextRange.m6089getMaximpl(range));
    }
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:13:0x004f A[LOOP:0: B:4:0x0010->B:13:0x004f, LOOP_END] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:11:0x0042 A[LOOP:0: B:4:0x0010->B:11:0x0042, LOOP_END] */
    ...
    public static final class Builder implements Appendable {
        ...
        public final void append(AnnotatedString text, int start, int end) {
            ...
            while (index$iv3 < size3) {
                Object item$iv3 = $this$fastForEach$iv3.get(index$iv3);
                Range it3 = (Range) item$iv3;
                builder.annotations.add(new MutableRange<>(it3.getItem(), it3.getStart() + insertionStart, it3.getEnd() + insertionStart, it3.getTag()));
                index$iv3++;
                builder = this;
            }
        }

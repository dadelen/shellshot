...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface mo6341getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        return TypefaceHelperMethodsApi28.INSTANCE.create(Typeface.DEFAULT, fontWeight.getWeight(), FontStyle.m6201equalsimpl0(fontStyle, FontStyle.INSTANCE.m6207getItalic_LCdwA()));
    }
}

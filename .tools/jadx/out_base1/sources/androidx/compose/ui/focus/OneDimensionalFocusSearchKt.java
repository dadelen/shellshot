...
public final class OneDimensionalFocusSearchKt {
    ...
    public static final boolean m3878oneDimensionalFocusSearchOMvw8(FocusTargetNode $this$oneDimensionalFocusSearch_u2d_u2dOM_u2dvw8, int direction, Function1<? super FocusTargetNode, Boolean> function1) {
        if (FocusDirection.m3834equalsimpl0(direction, FocusDirection.INSTANCE.m3844getNextdhqQ8s())) {
            return forwardFocusSearch($this$oneDimensionalFocusSearch_u2d_u2dOM_u2dvw8, function1);
        }
        if (FocusDirection.m3834equalsimpl0(direction, FocusDirection.INSTANCE.m3845getPreviousdhqQ8s())) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[$this$forwardFocusSearch.getFocusState().ordinal()]) {
            case 1:
                ...
                if (focusedChild != null) {
                    return forwardFocusSearch(focusedChild, function1) || m3877generateAndSearchChildren4C6V_qg($this$forwardFocusSearch, focusedChild, FocusDirection.INSTANCE.m3844getNextdhqQ8s(), function1);
                }
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[$this$backwardFocusSearch.getFocusState().ordinal()]) {
            case 1:
                ...
                switch (WhenMappings.$EnumSwitchMapping$0[focusedChild.getFocusState().ordinal()]) {
                    case 1:
                        if (backwardFocusSearch(focusedChild, function1) || m3877generateAndSearchChildren4C6V_qg($this$backwardFocusSearch, focusedChild, FocusDirection.INSTANCE.m3845getPreviousdhqQ8s(), function1)) {
                            return true;
                        }
                        return focusedChild.fetchFocusProperties$ui_release().getCanFocus() && function1.invoke(focusedChild).booleanValue();
                    case 2:
                    case 3:
                        return m3877generateAndSearchChildren4C6V_qg($this$backwardFocusSearch, focusedChild, FocusDirection.INSTANCE.m3845getPreviousdhqQ8s(), function1);
                    case 4:
                        throw new IllegalStateException(NoActiveChild.toString());
                    default:
                        throw new NoWhenBranchMatchedException();
    ...
    private static final boolean m3877generateAndSearchChildren4C6V_qg(final FocusTargetNode $this$generateAndSearchChildren_u2d4C6V_qg, final FocusTargetNode focusedItem, final int direction, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m3879searchChildren4C6V_qg($this$generateAndSearchChildren_u2d4C6V_qg, focusedItem, direction, function1)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m3830searchBeyondBoundsOMvw8($this$generateAndSearchChildren_u2d4C6V_qg, direction, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.OneDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope $this$searchBeyondBounds) {
                boolean m3879searchChildren4C6V_qg;
                m3879searchChildren4C6V_qg = OneDimensionalFocusSearchKt.m3879searchChildren4C6V_qg(FocusTargetNode.this, focusedItem, direction, function1);
                Boolean valueOf = Boolean.valueOf(m3879searchChildren4C6V_qg);
    ...
    public static final boolean m3879searchChildren4C6V_qg(FocusTargetNode $this$searchChildren_u2d4C6V_qg, FocusTargetNode focusedItem, int direction, Function1<? super FocusTargetNode, Boolean> function1) {
                    ...
                    if ((node$iv$iv.getKindSet() & m5726constructorimpl) != 0) {
                        ...
                        while (node2 != null) {
                            ...
                            if (node2 instanceof FocusTargetNode) {
                                ...
                                if (((this_$iv$iv$iv2.getKindSet() & m5726constructorimpl) != 0 ? i : 0) == 0 || !(node2 instanceof DelegatingNode)) {
                                    $this$searchChildren_4C6V_qg_u24lambda_u242 = $this$searchChildren_4C6V_qg_u24lambda_u2423;
                                } else {
                                    int count$iv$iv2 = 0;
        ...
        if (FocusDirection.m3834equalsimpl0(direction, FocusDirection.INSTANCE.m3844getNextdhqQ8s()) || !$this$searchChildren_u2d4C6V_qg.fetchFocusProperties$ui_release().getCanFocus() || isRoot($this$searchChildren_u2d4C6V_qg)) {
            return false;
        }
                    ...
                    if ((node$iv$iv.getKindSet() & m5726constructorimpl) != 0) {
                        ...
                        while (node != null) {
                            if (node instanceof FocusTargetNode) {
                                ...
                                if (((this_$iv$iv$iv.getKindSet() & m5726constructorimpl) != 0) && (node instanceof DelegatingNode)) {
                                    int count$iv$iv = 0;

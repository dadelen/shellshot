...
public final class LiveRegionMode {
    ...
    private static final int Polite = m5887constructorimpl(0);
    private static final int Assertive = m5887constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ LiveRegionMode m5886boximpl(int i) {
        return new LiveRegionMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m5887constructorimpl(int i) {
        return i;
    }
    ...
    public static int m5890hashCodeimpl(int i) {
    ...
    public int hashCode() {
        return m5890hashCodeimpl(this.value);
    }
    ...
    public static String m5891toStringimpl(int arg0) {
        return m5889equalsimpl0(arg0, Polite) ? "Polite" : m5889equalsimpl0(arg0, Assertive) ? "Assertive" : "Unknown";
    }

    public String toString() {
        return m5891toStringimpl(this.value);
    }
}

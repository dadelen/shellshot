        ...
        switch (this.label) {
            case 0:
                ...
                if (!z) {
                    ...
                    this.label = 1;
                    if (nestedScrollDispatcher2.m5238dispatchPostFlingRZ2iAVY(Velocity.INSTANCE.m6874getZero9UxMQ8M(), this.$viewVelocity, this) != coroutine_suspended) {
                        break;
                    } else {
                    ...
                    this.label = 2;
                    if (nestedScrollDispatcher.m5238dispatchPostFlingRZ2iAVY(this.$viewVelocity, Velocity.INSTANCE.m6874getZero9UxMQ8M(), this) != coroutine_suspended) {
                        break;
                    } else {
                        return coroutine_suspended;
                    }

...
public abstract class AlignmentLines {
    ...
    protected abstract long mo5598calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            position = mo5598calculatePositionInParentR5De75A(coordinator, position);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            $this$fastRoundToInt$iv = Offset.m3923getYimpl(position);
        } else {
            $this$fastRoundToInt$iv = Offset.m3922getXimpl(position);
        }
        int positionInContainer = Math.round($this$fastRoundToInt$iv);

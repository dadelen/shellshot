...
public final class LayoutTreeConsistencyChecker {
    ...
    */
    ...
    private final String nodeToString(LayoutNode node) {
        ...
        $this$nodeToString_u24lambda_u243.append(new StringBuilder().append(AbstractJsonLexerKt.BEGIN_LIST).append(node.getLayoutState$ui_release()).append(AbstractJsonLexerKt.END_LIST).toString());
        if (!node.isPlaced()) {
            $this$nodeToString_u24lambda_u243.append("[!isPlaced]");
        }
        $this$nodeToString_u24lambda_u243.append("[measuredByParent=" + node.getMeasuredByParent$ui_release() + AbstractJsonLexerKt.END_LIST);
        if (!consistentLayoutState(node)) {

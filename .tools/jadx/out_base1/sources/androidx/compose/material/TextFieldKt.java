...
public final class TextFieldKt {
    private static final float FirstBaselineOffset = Dp.m6626constructorimpl(20);
    private static final float TextFieldBottomPadding = Dp.m6626constructorimpl(10);
    private static final float TextFieldTopPadding = Dp.m6626constructorimpl(2);
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:171:0x0692  */
    ...
    */
    ...
    public static final int m1718calculateWidthVsPV1Ek(int leadingWidth, int trailingWidth, int textFieldWidth, int labelWidth, int placeholderWidth, long constraints) {
    ...
    public static final int m1717calculateHeightO3s9Psw(int textFieldHeight, boolean hasLabel, int labelBaseline, int leadingHeight, int trailingHeight, int placeholderHeight, long constraints, float density, PaddingValues paddingValues) {
        ...
        return Math.max(MathKt.roundToInt(middleSectionHeight), Math.max(Math.max(leadingHeight, trailingHeight), Constraints.m6580getMinHeightimpl(constraints)));
    }
    ...
    public static final Modifier drawIndicatorLine(Modifier $this$drawIndicatorLine, final BorderStroke indicatorBorder) {
        ...
        return DrawModifierKt.drawWithContent($this$drawIndicatorLine, new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.material.TextFieldKt$drawIndicatorLine$1
            ...
            public final void invoke2(ContentDrawScope $this$drawWithContent) {
                ...
                if (Dp.m6631equalsimpl0(strokeWidthDp, Dp.INSTANCE.m6644getHairlineD9Ej5fM())) {
                    return;
                }
                ...
                DrawScope.m4698drawLine1RTmtNc$default($this$drawWithContent, indicatorBorder.getBrush(), OffsetKt.Offset(0.0f, y), OffsetKt.Offset(Size.m3991getWidthimpl($this$drawWithContent.mo4713getSizeNHjbRc()), y), strokeWidth, 0, null, 0.0f, null, 0, 496, null);
            }
        });
    }

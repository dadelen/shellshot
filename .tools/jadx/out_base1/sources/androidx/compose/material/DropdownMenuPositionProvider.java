...
public final /* data */ class DropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public static /* synthetic */ DropdownMenuPositionProvider m1539copyrOJDEFc$default(DropdownMenuPositionProvider dropdownMenuPositionProvider, long j, Density density, Function2 function2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return dropdownMenuPositionProvider.m1541copyrOJDEFc(j, density, function2);
    }
    ...
    public final DropdownMenuPositionProvider m1541copyrOJDEFc(long contentOffset, Density density, Function2<? super IntRect, ? super IntRect, Unit> onPositionCalculated) {
    ...
    public boolean equals(Object other) {
        ...
        return DpOffset.m6686equalsimpl0(this.contentOffset, dropdownMenuPositionProvider.contentOffset) && Intrinsics.areEqual(this.density, dropdownMenuPositionProvider.density) && Intrinsics.areEqual(this.onPositionCalculated, dropdownMenuPositionProvider.onPositionCalculated);
    }

    public int hashCode() {
        return (((DpOffset.m6691hashCodeimpl(this.contentOffset) * 31) + this.density.hashCode()) * 31) + this.onPositionCalculated.hashCode();
    }

    public String toString() {
        return "DropdownMenuPositionProvider(contentOffset=" + ((Object) DpOffset.m6694toStringimpl(this.contentOffset)) + ", density=" + this.density + ", onPositionCalculated=" + this.onPositionCalculated + ')';
    }
    ...
    */
    ...
    public final long m1542getContentOffsetRKDOV3M() {
        return this.contentOffset;
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:19:0x00d7 A[LOOP:0: B:11:0x00a4->B:19:0x00d7, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:20:0x00e2 A[EDGE_INSN: B:20:0x00e2->B:21:0x00e2 BREAK  A[LOOP:0: B:11:0x00a4->B:19:0x00d7], SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:33:0x0174 A[LOOP:1: B:25:0x0142->B:33:0x0174, LOOP_END] */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public long mo336calculatePositionllwVHH4(androidx.compose.ui.unit.IntRect r25, long r26, androidx.compose.ui.unit.LayoutDirection r28, long r29) {
        /*
            Method dump skipped, instructions count: 420
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.DropdownMenuPositionProvider.mo336calculatePositionllwVHH4(androidx.compose.ui.unit.IntRect, long, androidx.compose.ui.unit.LayoutDirection, long):long");
    }
}

...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m1759setColorDxMtmZc(long color, float alpha) {
        long newColor = m1758calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (!(color2 == null ? false : Color.m4164equalsimpl0(color2.m4173unboximpl(), newColor))) {
            this.rippleColor = Color.m4153boximpl(newColor);
            setColor(ColorStateList.valueOf(ColorKt.m4217toArgb8_81llA(newColor)));
        }
    }
    ...
    private final long m1758calculateRippleColor5vOe2sY(long color, float alpha) {
        long color2;
        float transformedAlpha = RangesKt.coerceAtMost(alpha, 1.0f);
        color2 = Color.m4161copywmQWz5c(color, (r12 & 1) != 0 ? Color.m4165getAlphaimpl(color) : transformedAlpha, (r12 & 2) != 0 ? Color.m4169getRedimpl(color) : 0.0f, (r12 & 4) != 0 ? Color.m4168getGreenimpl(color) : 0.0f, (r12 & 8) != 0 ? Color.m4166getBlueimpl(color) : 0.0f);
        return color2;
    }

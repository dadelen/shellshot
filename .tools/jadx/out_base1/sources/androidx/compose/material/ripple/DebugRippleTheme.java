...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1501defaultColorWaAFU9c(Composer $composer, int $changed) {
        ...
        long m1755defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m1755defaultRippleColor5vOe2sY(Color.INSTANCE.m4189getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
        return m1755defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer $composer, int $changed) {
        ...
        RippleAlpha m1754defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m1754defaultRippleAlphaDxMtmZc(Color.INSTANCE.m4189getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
        return m1754defaultRippleAlphaDxMtmZc;
    }
}

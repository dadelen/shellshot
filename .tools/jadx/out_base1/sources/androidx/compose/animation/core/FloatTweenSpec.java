...
public final class FloatTweenSpec implements FloatAnimationSpec {
    ...
    public float getValueFromNanos(long playTimeNanos, float initialValue, float targetValue, float initialVelocity) {
        ...
        float rawFraction = this.duration == 0 ? 1.0f : clampedPlayTimeNanos / this.durationNanos;
        Easing easing = this.easing;
        float $this$fastCoerceIn$iv = rawFraction;
        ...
        float fraction = easing.transform($this$fastCoerceAtLeast$iv$iv);

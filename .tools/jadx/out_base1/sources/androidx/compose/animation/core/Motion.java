...
public final class Motion {
    ...
    public static final /* synthetic */ Motion m149boximpl(long j) {
        return new Motion(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m150constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m153equalsimpl(long j, Object obj) {
        return (obj instanceof Motion) && j == ((Motion) obj).m159unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m154equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m157hashCodeimpl(long j) {
    ...
    public boolean equals(Object obj) {
        return m153equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m157hashCodeimpl(this.packedValue);
    }
    ...
    public final /* synthetic */ long m159unboximpl() {
    ...
    public static final float m155getValueimpl(long arg0) {
        int bits$iv$iv = (int) (arg0 >> 32);
        return Float.intBitsToFloat(bits$iv$iv);
    }

    /* renamed from: getVelocity-impl, reason: not valid java name */
    public static final float m156getVelocityimpl(long arg0) {
        int bits$iv$iv = (int) (4294967295L & arg0);
        return Float.intBitsToFloat(bits$iv$iv);
    }

    /* renamed from: copy-XB9eQnU, reason: not valid java name */
    public static final long m151copyXB9eQnU(long arg0, float value, float velocity) {
        return SpringSimulationKt.Motion(value, velocity);
    }

    /* renamed from: copy-XB9eQnU$default, reason: not valid java name */
    public static /* synthetic */ long m152copyXB9eQnU$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m155getValueimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m156getVelocityimpl(j);
        }
        return m151copyXB9eQnU(j, f, f2);
    }
}

...
final class Animatable$runAnimation$2<T, V> extends SuspendLambda implements Function1<Continuation<? super AnimationResult<T, V>>, Object> {
    ...
    /* JADX WARN: Type inference failed for: r1v3, types: [androidx.compose.animation.core.Animatable$runAnimation$2] */
        ...
        try {
            switch (animatable$runAnimation$2) {
                case 0:
                    ...
                    final AnimationState copy$default = AnimationStateKt.copy$default((AnimationState) animatable$runAnimation$22.this$0.getInternalState$animation_core_release(), (Object) null, (AnimationVector) null, 0L, Long.MIN_VALUE, false, 23, (Object) null);
                ...
                case 1:
                    ...
                    animationState = (AnimationState) animatable$runAnimation$23.L$0;
                    ResultKt.throwOnFailure(obj);

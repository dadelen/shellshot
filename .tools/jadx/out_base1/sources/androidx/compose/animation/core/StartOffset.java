...
public final class StartOffset {
    ...
    public static final /* synthetic */ StartOffset m162boximpl(long j) {
        return new StartOffset(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static long m164constructorimpl(long j) {
        return j;
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m163constructorimpl(int offsetMillis, int offsetType) {
        return m164constructorimpl(offsetMillis * offsetType);
    }

    /* renamed from: constructor-impl$default, reason: not valid java name */
    public static /* synthetic */ long m165constructorimpl$default(int i, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i3 & 2) != 0) {
            i2 = StartOffsetType.INSTANCE.m180getDelayEo1U57Q();
        }
        return m163constructorimpl(i, i2);
    }

    /* renamed from: getOffsetMillis-impl, reason: not valid java name */
    public static final int m168getOffsetMillisimpl(long arg0) {
        return Math.abs((int) arg0);
    }

    /* renamed from: getOffsetType-Eo1U57Q, reason: not valid java name */
    public static final int m169getOffsetTypeEo1U57Q(long arg0) {
        boolean z = arg0 > 0;
        if (z) {
            return StartOffsetType.INSTANCE.m181getFastForwardEo1U57Q();
        }
        if (z) {
            throw new NoWhenBranchMatchedException();
        }
        return StartOffsetType.INSTANCE.m180getDelayEo1U57Q();
    }
}

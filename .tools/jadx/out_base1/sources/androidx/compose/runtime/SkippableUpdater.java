...
public final class SkippableUpdater<T> {
    ...
    public static final /* synthetic */ SkippableUpdater m3647boximpl(Composer composer) {
        return new SkippableUpdater(composer);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m3648constructorimpl(Composer composer) {
        return composer;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3649equalsimpl(Composer composer, Object obj) {
        return (obj instanceof SkippableUpdater) && Intrinsics.areEqual(composer, ((SkippableUpdater) obj).getComposer());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3650equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m3651hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3652toStringimpl(Composer composer) {
        return "SkippableUpdater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m3649equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m3651hashCodeimpl(this.composer);
    }

    public String toString() {
        return m3652toStringimpl(this.composer);
    }
    ...
    public static final void m3653updateimpl(Composer arg0, Function1<? super Updater<T>, Unit> function1) {
        arg0.startReplaceableGroup(509942095);
        function1.invoke(Updater.m3655boximpl(Updater.m3656constructorimpl(arg0)));

...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m6888clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m6889clone() {
            WearableExtender that = new WearableExtender();
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (srcArray == null) {
            ...
            for (int i = 0; i < srcArray.length; i++) {
                ...
                remoteInputs2[i] = new RemoteInput(Api20Impl.getResultKey(src), Api20Impl.getLabel(src), Api20Impl.getChoices(src), Api20Impl.getAllowFreeFormInput(src), Api29Impl.getEditChoicesBeforeSending(src), Api20Impl.getExtras(src), null);
            }

...
public class FragmentTransitionSupport extends FragmentTransitionImpl {
    ...
    public Object cloneTransition(Object transition) {
        ...
        Transition copy = ((Transition) transition).mo6924clone();
        return copy;
    }
    ...
    public boolean isSeekingSupported(Object transition) {
        ...
        if (!supported) {
            Log.v("FragmentManager", "Predictive back not available for AndroidX Transition " + transition + ". Please enable seeking support for the designated transition by overriding isSeekingSupported().");
        }
        return supported;
    }

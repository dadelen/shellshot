...
public interface SendChannel<E> {
    ...
    Object mo8706trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo8706trySendJP2dKIU(e);
            if (ChannelResult.m8727isSuccessimpl(result)) {
                return true;
            }
            Throwable m8721exceptionOrNullimpl = ChannelResult.m8721exceptionOrNullimpl(result);

...
public final /* synthetic */ class JobKt__JobKt {
    ...
    public static final DisposableHandle invokeOnCompletion(Job $this$invokeOnCompletion, boolean onCancelling, boolean invokeImmediately, InternalCompletionHandler handler) {
        return $this$invokeOnCompletion instanceof JobSupport ? ((JobSupport) $this$invokeOnCompletion).invokeOnCompletionInternal$kotlinx_coroutines_core(onCancelling, invokeImmediately, handler) : $this$invokeOnCompletion.invokeOnCompletion(onCancelling, invokeImmediately, new JobKt__JobKt$invokeOnCompletion$1(handler));
    }
    ...
    public static final /* synthetic */ Job m8700Job(Job parent) {
        return JobKt.Job(parent);
    }

    /* renamed from: Job$default, reason: collision with other method in class */
    public static /* synthetic */ Job m8701Job$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m8700Job(job);

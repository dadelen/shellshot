...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
    ...
    public final CancellableContinuationImpl<T> claimReusableCancellableContinuation$kotlinx_coroutines_core() {
        ...
        while (true) {
            ...
            if (state instanceof CancellableContinuationImpl) {
                if (_reusableCancellableContinuation$volatile$FU.compareAndSet(this, state, DispatchedContinuationKt.REUSABLE_CLAIMED)) {
    ...
    public final Throwable tryReleaseClaimedContinuation$kotlinx_coroutines_core(CancellableContinuation<?> continuation) {
        ...
        do {
            ...
            if (state != DispatchedContinuationKt.REUSABLE_CLAIMED) {
                if (state instanceof Throwable) {
                    if (!_reusableCancellableContinuation$volatile$FU.compareAndSet(this, state, null)) {
        ...
        } while (!_reusableCancellableContinuation$volatile$FU.compareAndSet(this, DispatchedContinuationKt.REUSABLE_CLAIMED, continuation));
        return null;
    }
    ...
    public final boolean postponeCancellation$kotlinx_coroutines_core(Throwable cause) {
        ...
        while (true) {
            ...
            if (Intrinsics.areEqual(state, DispatchedContinuationKt.REUSABLE_CLAIMED)) {
                if (_reusableCancellableContinuation$volatile$FU.compareAndSet(this, DispatchedContinuationKt.REUSABLE_CLAIMED, cause)) {
                    return true;
                }
            } else {
                if (state instanceof Throwable) {
    ...
    public void resumeWith(Object result) {
        ...
        if (this.dispatcher.isDispatchNeeded(context)) {
            this._state = state;
            this.resumeMode = 0;
            this.dispatcher.mo8761dispatch(context, this);
            return;
        }
        if (DebugKt.getASSERTIONS_ENABLED()) {
        }
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(12:13|14|15|(3:69|70|(9:72|73|18|(12:20|21|22|(2:54|55)(1:24)|25|26|27|28|29|30|(1:42)|34)(1:67)|35|(2:41|36)|38|39|40))|17|18|(0)(0)|35|(1:36)|38|39|40) */
    /* JADX WARN: Code restructure failed: missing block: B:68:0x011e, code lost:
    
        r0 = th;
     */
    /* JADX WARN: Removed duplicated region for block: B:20:0x00ad  */
    /* JADX WARN: Removed duplicated region for block: B:41:? A[LOOP:0: B:36:0x0116->B:41:?, LOOP_END, SYNTHETIC] */
    ...
    */
    ...
    public final boolean resumeCancelled$kotlinx_coroutines_core(Object state) {
        ...
        if (job != null && !job.isActive()) {
            ...
            resumeWith(Result.m7216constructorimpl(ResultKt.createFailure(cause)));
            return true;
        }
        return false;
    }

...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame, Waiter {
    ...
    public void cancelCompletedResult$kotlinx_coroutines_core(Object takenState, Throwable cause) {
        ...
        while (true) {
            ...
            if (!(state instanceof CompletedContinuation)) {
                if (_state$volatile$FU.compareAndSet(this, state, new CompletedContinuation(state, null, null, null, cause, 14, null))) {
                    return;
                }
            } else {
                ...
                if (_state$volatile$FU.compareAndSet(this, state, update)) {
    ...
    public boolean cancel(Throwable cause) {
        ...
        } while (!_state$volatile$FU.compareAndSet(this, state, update));
    ...
    private final DisposableHandle installParentHandle() {
        ...
        _parentHandle$volatile$FU.compareAndSet(this, null, handle);
        return handle;
    }
    ...
    private final void invokeOnCancellationImpl(Object handler) {
        ...
        while (true) {
            ...
            if (state instanceof Active) {
                if (_state$volatile$FU.compareAndSet(this, state, handler)) {
                    return;
                }
            } else {
                if (state instanceof CancelHandler ? true : state instanceof Segment) {
                    ...
                    if (state instanceof CompletedContinuation) {
                        ...
                        if (_state$volatile$FU.compareAndSet(this, state, update2)) {
                            return;
                        }
                    }
                }

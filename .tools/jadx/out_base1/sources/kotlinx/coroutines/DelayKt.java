    ...
    */
    ...
    public static final Object delay(long timeMillis, Continuation<? super Unit> continuation) {
        ...
        if (timeMillis < Long.MAX_VALUE) {
            getDelay(cont.getContext()).mo8762scheduleResumeAfterDelay(timeMillis, cont);
        }
    ...
    public static final Object m8695delayVtjQ1oo(long duration, Continuation<? super Unit> continuation) {
        Object delay = delay(m8696toDelayMillisLRDsOJo(duration), continuation);
    ...
    public static final long m8696toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        boolean m8582isPositiveimpl = Duration.m8582isPositiveimpl($this$toDelayMillis_u2dLRDsOJo);
        if (m8582isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m8566getInWholeMillisecondsimpl(Duration.m8584plusLRDsOJo($this$toDelayMillis_u2dLRDsOJo, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (m8582isPositiveimpl) {

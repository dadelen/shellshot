    ...
    static class InnerCornerShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix transform, ShadowRenderer shadowRenderer, int shadowElevation, Canvas canvas) {
            ...
            if (sweepAngle <= 0.0f) {
                ...
                shadowRenderer.drawInnerCornerShadow(canvas, this.renderMatrix, rect, (int) arcRadius, 450.0f, sweepAngle, new float[]{(float) (arcRadius + retractLength), arcRadius * 2.0f});

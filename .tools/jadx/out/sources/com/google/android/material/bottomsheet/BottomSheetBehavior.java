...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements MaterialBackHandler {
                ...
                if (yvel < 0.0f) {
                    ...
                    if (z) {
                        ...
                        if (currentTop3 < targetState4) {
                            ...
                            if (Math.abs(currentTop3 - targetState5) < Math.abs(currentTop3 - BottomSheetBehavior.this.collapsedOffset)) {
                                if (BottomSheetBehavior.this.shouldSkipHalfExpandedStateWhenDragging()) {
                                    targetState = 4;
                                } else {
                                    targetState = 6;
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection) {
        ...
        for (int i3 = 0; i3 < this.callbacks.size(); i3++) {
            this.callbacks.get(i3).onLayout(child);
        }
        return true;
    }
    ...
    private float calculateInterpolationWithCornersRemoved() {
        WindowInsets insets;
        if (this.materialShapeDrawable != null && this.viewRef != null && this.viewRef.get() != null) {

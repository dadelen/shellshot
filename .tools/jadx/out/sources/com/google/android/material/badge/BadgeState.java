...
public final class BadgeState {
    ...
    BadgeState(Context context, int badgeResId, int defStyleAttr, int defStyleRes, State storedState) {
        ...
        if (storedState.number == -2) {
            boolean hasValue = a.hasValue(R.styleable.Badge_number);
        ...
        state8.badgeShapeAppearanceResId = Integer.valueOf(intValue);
        ...
        state9.badgeShapeAppearanceOverlayResId = Integer.valueOf(intValue2);
        ...
        state10.badgeWithTextShapeAppearanceResId = Integer.valueOf(intValue3);
        ...
        state11.badgeWithTextShapeAppearanceOverlayResId = Integer.valueOf(intValue4);
        ...
        state12.backgroundColor = Integer.valueOf(intValue5);
        ...
        state13.badgeTextAppearanceResId = Integer.valueOf(intValue6);
        ...
        state14.badgeGravity = Integer.valueOf(intValue7);
        ...
        state15.badgeHorizontalPadding = Integer.valueOf(intValue8);
        ...
        state16.badgeVerticalPadding = Integer.valueOf(intValue9);
        ...
        state17.horizontalOffsetWithoutText = Integer.valueOf(intValue10);
        ...
        state18.verticalOffsetWithoutText = Integer.valueOf(intValue11);
        ...
        state19.horizontalOffsetWithText = Integer.valueOf(intValue12);
        ...
        state20.verticalOffsetWithText = Integer.valueOf(intValue13);
        ...
        state21.largeFontVerticalOffsetAdjustment = Integer.valueOf(intValue14);
        ...
        state22.autoAdjustToWithinGrandparentBounds = Boolean.valueOf(booleanValue);
        a.recycle();

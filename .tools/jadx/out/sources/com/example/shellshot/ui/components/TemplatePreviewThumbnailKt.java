    ...
    */
    ...
    public static final InputStream openTemplatePreviewStream(Context context, String path) {
        ...
        try {
            ...
            m7216constructorimpl = Result.m7216constructorimpl((file.isAbsolute() && file.exists()) ? new FileInputStream(file) : context.getAssets().open(path));
        } catch (Throwable th) {
        ...
        return (InputStream) m7216constructorimpl;
    }

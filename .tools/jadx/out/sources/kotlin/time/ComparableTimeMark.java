...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo8546minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo8547minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo8548plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m8550minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo8548plusLRDsOJo(Duration.m8599unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m8554compareToLRDsOJo($this.mo8547minusUwyO8pc(other), Duration.INSTANCE.m8646getZEROUwyO8pc());
        }
    }
}

...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo8546minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m8665minusLRDsOJo(this, duration);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo8545elapsedNowUwyO8pc() {
        return Duration.m8583minusLRDsOJo(this.mark.mo8545elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo8548plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m8584plusLRDsOJo(this.adjustment, duration), null);
    }
}

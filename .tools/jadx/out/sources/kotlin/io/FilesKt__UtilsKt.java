...
public class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final Unit copyRecursively$lambda$4$FilesKt__UtilsKt(Function2 $onError, File f, IOException e) {
    ...
    public static final File normalize(File $this$normalize) {
        ...
        List<File> normalize$FilesKt__UtilsKt = normalize$FilesKt__UtilsKt($this$normalize_u24lambda_u246.getSegments());
        String separator = File.separator;
        Intrinsics.checkNotNullExpressionValue(separator, "separator");

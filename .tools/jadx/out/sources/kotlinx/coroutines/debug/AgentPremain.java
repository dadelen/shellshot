...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m7216constructorimpl = Result.m7216constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m7216constructorimpl = Result.m7216constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m7222isFailureimpl(m7216constructorimpl) ? null : m7216constructorimpl);

...
public abstract class DispatchedTask<T> extends Task {
    ...
    public final void run() {
        ...
        try {
            ...
            context$iv = continuation.get$context();
            ...
            if (oldValue$iv != ThreadContextKt.NO_THREAD_ELEMENTS) {
                try {
                    ...
                    try {
                        ...
                        result = Result.m7216constructorimpl(Unit.INSTANCE);
                    } catch (Throwable th2) {
                        th = th2;
                        Result.Companion companion2 = Result.INSTANCE;
                        result = Result.m7216constructorimpl(ResultKt.createFailure(th));
                        handleFatalException$kotlinx_coroutines_core(fatalException, Result.m7219exceptionOrNullimpl(result));
                    }
                    handleFatalException$kotlinx_coroutines_core(fatalException, Result.m7219exceptionOrNullimpl(result));
                }
            } else {
            ...
            undispatchedCompletion$iv = updateUndispatchedCompletion;
        } catch (Throwable th3) {
            e = th3;
            taskContext = taskContext3;
        }
                ...
                try {
                    if (job == null || job.isActive()) {
                        ...
                        if (exception != null) {
                            ...
                            continuation.resumeWith(Result.m7216constructorimpl(ResultKt.createFailure(exception)));
                        } else {
                            Result.Companion companion4 = Result.INSTANCE;
                            continuation.resumeWith(Result.m7216constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(state)));
                        }
                    } else {
                        ...
                        if (DebugKt.getRECOVER_STACK_TRACES()) {
                            ...
                            try {
                                if (continuation instanceof CoroutineStackFrame) {
                                    ...
                                    continuation.resumeWith(Result.m7216constructorimpl(ResultKt.createFailure(cancellationException)));
                                }
                            } catch (Throwable th5) {
                                th = th5;

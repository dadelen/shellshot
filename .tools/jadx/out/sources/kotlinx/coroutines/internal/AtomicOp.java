...
public abstract class AtomicOp<T> extends OpDescriptor {
    ...
    private final Object decide(Object decision) {
        ...
        return current != AtomicKt.NO_DECISION ? current : _consensus$volatile$FU.compareAndSet(this, AtomicKt.NO_DECISION, decision) ? decision : _consensus$volatile$FU.get(this);
    }

...
public class LockFreeLinkedListNode {
    ...
    public static abstract class CondAddOp extends AtomicOp<LockFreeLinkedListNode> {
        ...
        public void complete(LockFreeLinkedListNode affected, Object failure) {
            ...
            if (update != null && LockFreeLinkedListNode.get_next$volatile$FU().compareAndSet(affected, this, update) && success) {
    ...
    */
    ...
    public final int tryCondAddNext(LockFreeLinkedListNode node, LockFreeLinkedListNode next, CondAddOp condAdd) {
        ...
        if (_next$volatile$FU.compareAndSet(this, next, condAdd)) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (prevNext == this) {
                    ...
                    if (_prev$volatile$FU.compareAndSet(this, oldPrev, prev)) {
                        return prev;
                    }
                } else {
                    if (isRemoved()) {

...
public class SelectImplementation<R> implements CancelHandler, SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    */
    public final java.lang.Object waitUntilSelected(kotlin.coroutines.Continuation<? super kotlin.Unit> r18) {
        ...
        L1d:
            ...
            boolean r11 = r11.compareAndSet(r0, r9, r5)
            if (r11 == 0) goto L6a
            r11 = r0
        ...
        L3a:
            ...
            boolean r11 = r11.compareAndSet(r0, r9, r12)
            if (r11 == 0) goto L6a
            r11 = r9
    ...
    private final int trySelectInternal(Object clauseObject, Object internalResult) {
        ...
        while (true) {
            ...
            if (!(curState instanceof CancellableContinuation)) {
                ...
                if (Intrinsics.areEqual(curState, symbol2) ? true : curState instanceof ClauseData) {
                    return 3;
                }
                ...
                if (Intrinsics.areEqual(curState, symbol4)) {
                    if (state$volatile$FU.compareAndSet(this, curState, CollectionsKt.listOf(clauseObject))) {
                        return 1;
                    }
                } else {
                    ...
                    if (state$volatile$FU.compareAndSet(this, curState, CollectionsKt.plus((Collection<? extends Object>) curState, clauseObject))) {
                        return 1;
                    }
                }
            } else {
                ...
                if (clause == null) {
                    ...
                    if (state$volatile$FU.compareAndSet(this, curState, clause)) {
    ...
    */
    ...
    public void invoke(Throwable cause) {
        ...
        } while (!handler$atomicfu$iv.compareAndSet(this, cur, symbol2));
        Iterable clauses = this.clauses;
        if (clauses == null) {
            return;
        }

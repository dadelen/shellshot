            ...
            if (from.getByte(prefixIndex2) != to.getByte(prefixIndex2)) {
                ...
                while (i3 < toIndex) {
                    ...
                    if (i3 != fromIndex2) {
                        ...
                        if (rangeByte == byteStrings.get(selectChoiceCount3).getByte(prefixIndex2)) {
                            i3++;
                ...
                while (rangeStart < toIndex) {
                    ...
                    while (true) {
                        ...
                        int i4 = prefixIndex5;
                        if (rangeByte2 == byteStrings.get(prefixIndex5).getByte(prefixIndex2)) {
                            prefixIndex5 = i4 + 1;
                        } else {
                            rangeEnd = i4;
                            break;
                    ...
                    childNodesOffset = childNodesOffset2;
                    rangeEnd3 = rangeEnd2;
                    buildTrieRecursive(childNodesOffset, childNodes, i6, byteStrings, rangeStart, rangeEnd3, indexes);
                    rangeStart = rangeEnd3;
                    childNodesOffset2 = childNodesOffset;
                    childNodes2 = childNodes;
                    fromIndex3 = prefixIndex;

...
public final class DataStoreImpl<T> implements DataStore<T> {
    ...
    public DataStoreImpl(Storage<T> storage, List<? extends Function2<? super InitializerApi<T>, ? super Continuation<? super Unit>, ? extends Object>> initTasksList, CorruptionHandler<T> corruptionHandler, CoroutineScope scope) {
        ...
        this.scope = scope;
        this.updateCollection = FlowKt.shareIn(FlowKt.flow(new DataStoreImpl$updateCollection$1(this, null)), this.scope, SharingStartedKt.m8748WhileSubscribed5qebJ5I(SharingStarted.INSTANCE, Duration.INSTANCE.m8646getZEROUwyO8pc(), Duration.INSTANCE.m8646getZEROUwyO8pc()), 0);

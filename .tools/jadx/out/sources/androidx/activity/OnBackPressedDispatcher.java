...
public final class OnBackPressedDispatcher {
    ...
    public OnBackPressedDispatcher(Runnable fallbackOnBackPressed, Consumer<Boolean> consumer) {
        ...
        this.onBackInvokedCallback = Api34Impl.INSTANCE.createOnBackAnimationCallback(new Function1<BackEventCompat, Unit>() { // from class: androidx.activity.OnBackPressedDispatcher.1
            {
                super(1);
            }

...
public class ConstraintLayout extends ViewGroup {
    ...
    class Measurer implements BasicMeasure.Measurer {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:132:0x0107, code lost:
            ...
            if (r31.wrapMeasure[1] == r31.getHeight()) goto L54;
         */
        /* JADX WARN: Code restructure failed: missing block: B:156:0x0078, code lost:
        
            if (r31.wrapMeasure[0] == r31.getWidth()) goto L27;
         */
        ...
        /* JADX WARN: Removed duplicated region for block: B:108:0x0286 A[ADDED_TO_REGION] */
        ...
        /* JADX WARN: Removed duplicated region for block: B:98:0x0292 A[ADDED_TO_REGION] */
    ...
    public void applyConstraintsFromLayoutParams(boolean isInEditMode, View child, ConstraintWidget widget, LayoutParams layoutParams, SparseArray<ConstraintWidget> idToWidget) {
        ...
        if (child instanceof ConstraintHelper) {
            ...
            helper.resolveRtl(constraintWidget, this.mLayoutWidget.isRtl());
        }
        ...
        if (layoutParams.circleConstraint != -1) {
            ...
            if (target4 != null) {
                constraintWidget.connectCircularConstraint(target4, layoutParams.circleAngle, layoutParams.circleRadius);
            }
        } else {
            if (resolvedLeftToLeft != -1) {
                ConstraintWidget target5 = idToWidget.get(resolvedLeftToLeft);
                if (target5 == null) {
                    ...
                    resolveGoneRightMargin = resolveGoneRightMargin2;
                    resolvedHorizontalBias = resolvedHorizontalBias2;
                    constraintWidget.immediateConnect(ConstraintAnchor.Type.LEFT, target5, ConstraintAnchor.Type.LEFT, layoutParams.leftMargin, resolveGoneLeftMargin);
                }
            } else {
                resolvedRightToRight = resolvedRightToRight2;
                resolveGoneRightMargin = resolveGoneRightMargin2;
            ...
            if (layoutParams.topToTop != -1) {
                ConstraintWidget target7 = idToWidget.get(layoutParams.topToTop);
                if (target7 != null) {
            ...
            if (layoutParams.bottomToTop != -1) {
                ConstraintWidget target8 = idToWidget.get(layoutParams.bottomToTop);
                if (target8 != null) {
                ...
                ConstraintWidget target9 = idToWidget.get(layoutParams.bottomToBottom);
                if (target9 == null) {
                    constraintWidget = widget;
                } else {
                    constraintWidget = widget;
                    constraintWidget.immediateConnect(ConstraintAnchor.Type.BOTTOM, target9, ConstraintAnchor.Type.BOTTOM, layoutParams.bottomMargin, layoutParams.goneBottomMargin);
                }
            }

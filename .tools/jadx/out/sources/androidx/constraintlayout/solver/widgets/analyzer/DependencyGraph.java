...
public class DependencyGraph {
    ...
    private boolean basicMeasureWidgets(ConstraintWidgetContainer constraintWidgetContainer) {
        ...
        ConstraintWidget.DimensionBehaviour horiz2;
        int width;
        ConstraintWidget.DimensionBehaviour horiz3;
        Iterator<ConstraintWidget> it = constraintWidgetContainer.mChildren.iterator();
        while (it.hasNext()) {
            ConstraintWidget widget = it.next();
            ConstraintWidget.DimensionBehaviour horiz4 = widget.mListDimensionBehaviors[0];
            ConstraintWidget.DimensionBehaviour vert2 = widget.mListDimensionBehaviors[1];
            if (widget.getVisibility() == 8) {
                widget.measured = true;
            } else {
                if (widget.mMatchConstraintPercentWidth < 1.0f && horiz4 == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                ...
                if (widget.getDimensionRatio() > 0.0f) {
                    if (horiz4 == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && (vert2 == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT || vert2 == ConstraintWidget.DimensionBehaviour.FIXED)) {
                        widget.mMatchConstraintDefaultWidth = 3;
                    } else if (vert2 == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && (horiz4 == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT || horiz4 == ConstraintWidget.DimensionBehaviour.FIXED)) {
                        widget.mMatchConstraintDefaultHeight = 3;
                    } else if (horiz4 == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && vert2 == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                ...
                if (horiz4 == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && widget.mMatchConstraintDefaultWidth == 1 && (widget.mLeft.mTarget == null || widget.mRight.mTarget == null)) {
                    horiz4 = ConstraintWidget.DimensionBehaviour.WRAP_CONTENT;
                }
                ...
                widget.horizontalRun.dimensionBehavior = horiz4;
                ...
                if (horiz4 == ConstraintWidget.DimensionBehaviour.MATCH_PARENT || horiz4 == ConstraintWidget.DimensionBehaviour.FIXED || horiz4 == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) {
                    if (vert == ConstraintWidget.DimensionBehaviour.MATCH_PARENT || vert == ConstraintWidget.DimensionBehaviour.FIXED) {
                        horiz = horiz4;
                    } else if (vert == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) {
                        horiz = horiz4;
                    }
                    ...
                    if (horiz != ConstraintWidget.DimensionBehaviour.MATCH_PARENT) {
                        ...
                        horiz2 = ConstraintWidget.DimensionBehaviour.FIXED;
                        width = width3;
                    }
                    ...
                    measure(widget, horiz2, width, vert, height);
                    widget.horizontalRun.dimension.resolve(widget.getWidth());
                    widget.verticalRun.dimension.resolve(widget.getHeight());
                    widget.measured = true;
                }
                if (horiz4 == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && (vert == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT || vert == ConstraintWidget.DimensionBehaviour.FIXED)) {
                    if (widget.mMatchConstraintDefaultWidth == 3) {
                        ...
                        ConstraintWidget.DimensionBehaviour vert3 = vert;
                        if (widget.mMatchConstraintDefaultWidth == 2) {
                            if (constraintWidgetContainer.mListDimensionBehaviors[0] == ConstraintWidget.DimensionBehaviour.FIXED || constraintWidgetContainer.mListDimensionBehaviors[0] == ConstraintWidget.DimensionBehaviour.MATCH_PARENT) {
                                ...
                                measure(widget, ConstraintWidget.DimensionBehaviour.FIXED, width5, vert3, height3);
                                widget.horizontalRun.dimension.resolve(widget.getWidth());
                                widget.verticalRun.dimension.resolve(widget.getHeight());
                                widget.measured = true;
                            } else {
                            ...
                            measure(widget, ConstraintWidget.DimensionBehaviour.WRAP_CONTENT, 0, vert3, 0);
                            widget.horizontalRun.dimension.resolve(widget.getWidth());
                            widget.verticalRun.dimension.resolve(widget.getHeight());
                            widget.measured = true;
                        } else {
                ...
                if (vert != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                    horiz3 = horiz4;
                } else if (horiz4 != ConstraintWidget.DimensionBehaviour.WRAP_CONTENT && horiz4 != ConstraintWidget.DimensionBehaviour.FIXED) {
                    horiz3 = horiz4;
                } else if (widget.mMatchConstraintDefaultHeight == 3) {
                    if (horiz4 == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) {
                        measure(widget, ConstraintWidget.DimensionBehaviour.WRAP_CONTENT, 0, ConstraintWidget.DimensionBehaviour.WRAP_CONTENT, 0);
                    }
                    ...
                    measure(widget, horiz4, 0, ConstraintWidget.DimensionBehaviour.WRAP_CONTENT, 0);
                    widget.verticalRun.dimension.wrapValue = widget.getHeight();
                } else {
                    ConstraintWidget.DimensionBehaviour horiz5 = horiz4;
                    if (widget.mMatchConstraintDefaultHeight == 2) {
                        if (constraintWidgetContainer.mListDimensionBehaviors[1] == ConstraintWidget.DimensionBehaviour.FIXED || constraintWidgetContainer.mListDimensionBehaviors[1] == ConstraintWidget.DimensionBehaviour.MATCH_PARENT) {
                            ...
                            measure(widget, horiz5, width7, ConstraintWidget.DimensionBehaviour.FIXED, height5);
                            widget.horizontalRun.dimension.resolve(widget.getWidth());
                            widget.verticalRun.dimension.resolve(widget.getHeight());
                            widget.measured = true;
                        } else {
                ...
                if (horiz3 == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && vert == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {

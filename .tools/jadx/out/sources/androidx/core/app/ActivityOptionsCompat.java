...
public class ActivityOptionsCompat {
    ...
    private static class ActivityOptionsCompatImpl extends ActivityOptionsCompat {
        ...
        public ActivityOptionsCompat setPendingIntentBackgroundActivityStartMode(int state) {
            Api34Impl.setPendingIntentBackgroundActivityStartMode(this.mActivityOptions, state);
            return this;
        }
    }
    ...
    static class Api33Impl {
        ...
        static void setPendingIntentBackgroundActivityLaunchAllowed(ActivityOptions activityOptions, boolean allowed) {
    ...
    static class Api34Impl {
        ...
        static ActivityOptions setPendingIntentBackgroundActivityStartMode(ActivityOptions activityOptions, int state) {

...
public final class DisplayCutoutCompat {
    ...
    static class Api33Impl {
        ...
        static DisplayCutout createDisplayCutout(android.graphics.Insets safeInsets, Rect boundLeft, Rect boundTop, Rect boundRight, Rect boundBottom, android.graphics.Insets waterfallInsets, Path cutoutPath) {
            return new DisplayCutout.Builder().setSafeInsets(safeInsets).setBoundingRectLeft(boundLeft).setBoundingRectTop(boundTop).setBoundingRectRight(boundRight).setBoundingRectBottom(boundBottom).setWaterfallInsets(waterfallInsets).setCutoutPath(cutoutPath).build();
        }
    }
}

...
public final class DateInputModalTokens {
    ...
    private static final float ContainerHeight = Dp.m6626constructorimpl((float) 512.0d);
    ...
    private static final float ContainerWidth = Dp.m6626constructorimpl((float) 328.0d);
    private static final float HeaderContainerHeight = Dp.m6626constructorimpl((float) 120.0d);
    private static final float HeaderContainerWidth = Dp.m6626constructorimpl((float) 328.0d);
    ...
    public final float m3138getContainerHeightD9Ej5fM() {

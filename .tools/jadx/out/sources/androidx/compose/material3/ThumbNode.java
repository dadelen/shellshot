...
final class ThumbNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo84measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        float other$iv2 = $this$measure_u2d3p2s80s.mo360toDpu2uoSUM(size);
        float minBound = $this$measure_u2d3p2s80s.mo364toPx0680j_4(Dp.m6626constructorimpl(Dp.m6626constructorimpl(arg0$iv - other$iv2) / 2.0f));
        arg0$iv2 = SwitchKt.SwitchWidth;
        float other$iv3 = SwitchKt.getThumbDiameter();
        float arg0$iv3 = Dp.m6626constructorimpl(arg0$iv2 - other$iv3);
        other$iv = SwitchKt.ThumbPadding;
        float maxBound = $this$measure_u2d3p2s80s.mo364toPx0680j_4(Dp.m6626constructorimpl(arg0$iv3 - other$iv));

                ...
                if (!Dp.m6631equalsimpl0(this.$animatable.getTargetValue().m6640unboximpl(), this.$target)) {
                    ...
                    if (!z) {
                        ...
                        if (Dp.m6631equalsimpl0(m6640unboximpl, f)) {
                            start = new PressInteraction.Press(Offset.INSTANCE.m3938getZeroF1C5BW0(), null);
                        } else {
                            ...
                            if (Dp.m6631equalsimpl0(m6640unboximpl, f2)) {
                                ...
                                if (Dp.m6631equalsimpl0(m6640unboximpl, f3)) {
                                    ...
                                    if (Dp.m6631equalsimpl0(m6640unboximpl, f4)) {
                        ...
                        this.label = 2;
                        if (ElevationKt.m2904animateElevationrAjV9yQ(this.$animatable, this.$target, start, this.$interaction, this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }

...
final class SliderKt$rangeSliderPressDragModifier$1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (CoroutineScopeKt.coroutineScope(new AnonymousClass1($this$pointerInput, this.$state, rangeSliderLogic, null), this) != coroutine_suspended) {
                    break;
                } else {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        static final class C00581 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00581(RangeSliderState rangeSliderState, RangeSliderLogic rangeSliderLogic, CoroutineScope coroutineScope, Continuation<? super C00581> continuation) {
                super(2, continuation);
                this.$state = rangeSliderState;
                this.$rangeSliderLogic = rangeSliderLogic;
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C00581 c00581 = new C00581(this.$state, this.$rangeSliderLogic, this.$$this$coroutineScope, continuation);
                c00581.L$0 = obj;
                return c00581;
            }
            ...
            /* JADX WARN: Removed duplicated region for block: B:13:0x019f A[Catch: CancellationException -> 0x01b0, TryCatch #0 {CancellationException -> 0x01b0, blocks: (B:11:0x0195, B:13:0x019f, B:18:0x01a7), top: B:10:0x0195 }] */
            /* JADX WARN: Removed duplicated region for block: B:18:0x01a7 A[Catch: CancellationException -> 0x01b0, TRY_LEAVE, TryCatch #0 {CancellationException -> 0x01b0, blocks: (B:11:0x0195, B:13:0x019f, B:18:0x01a7), top: B:10:0x0195 }] */
            ...
            */
            public final java.lang.Object invokeSuspend(java.lang.Object r18) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.SliderKt$rangeSliderPressDragModifier$1.AnonymousClass1.C00581.invokeSuspend(java.lang.Object):java.lang.Object");
            }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (ForEachGestureKt.awaitEachGesture(this.$$this$pointerInput, new C00581(this.$state, this.$rangeSliderLogic, $this$coroutineScope, null), this) != coroutine_suspended) {
                        break;
                    } else {
                        return coroutine_suspended;
                    }

...
final class ListItemType implements Comparable<ListItemType> {
    ...
    private static final int OneLine = m2210constructorimpl(1);
    private static final int TwoLine = m2210constructorimpl(2);
    private static final int ThreeLine = m2210constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ListItemType m2208boximpl(int i) {
        return new ListItemType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m2210constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2211equalsimpl(int i, Object obj) {
        return (obj instanceof ListItemType) && i == ((ListItemType) obj).getLines();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2212equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public static String m2214toStringimpl(int i) {
        return "ListItemType(lines=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m2211equalsimpl(this.lines, obj);
    }

    public int hashCode() {
        return m2213hashCodeimpl(this.lines);
    }

    public String toString() {
        return m2214toStringimpl(this.lines);
    }
    ...
    public /* bridge */ /* synthetic */ int compareTo(ListItemType listItemType) {
        return m2215compareToyh95HIg(listItemType.getLines());
    }
    ...
    public static int m2209compareToyh95HIg(int arg0, int other) {
        return Intrinsics.compare(arg0, other);
    }

    /* renamed from: compareTo-yh95HIg, reason: not valid java name */
    public int m2215compareToyh95HIg(int other) {
        return m2209compareToyh95HIg(this.lines, other);
    }

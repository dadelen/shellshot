...
public final class EasingFunctionsKt {
    ...
    static final float EaseInElastic$lambda$0(float fraction) {
        ...
        return (float) ((-((float) Math.pow(2.0d, (fraction * 10.0f) - 10.0f))) * Math.sin(((10.0f * fraction) - 10.75f) * 2.0943951023931953d));
    }
    ...
    static final float EaseOutElastic$lambda$1(float fraction) {
        if (fraction == 0.0f) {
            return 0.0f;
        }
        if (fraction == 1.0f) {
        ...
        return (float) ((((float) Math.pow(2.0d, (-10.0f) * fraction)) * Math.sin(((10.0f * fraction) - 0.75f) * 2.0943951023931953d)) + 1.0d);
    }
    ...
    static final float EaseInOutElastic$lambda$2(float fraction) {
        if (fraction == 0.0f) {
            return 0.0f;
        }
        if (fraction == 1.0f) {
        ...
        return 0.0f <= fraction && fraction <= 0.5f ? (float) ((-(((float) Math.pow(2.0d, (fraction * 20.0f) - 10.0f)) * Math.sin(((20.0f * fraction) - 11.125f) * 1.3962634015954636d))) / 2.0d) : ((float) ((((float) Math.pow(2.0d, ((-20.0f) * fraction) + 10.0f)) * Math.sin(((20.0f * fraction) - 11.125f) * 1.3962634015954636d)) / 2.0d)) + 1.0f;
    }
    ...
    static final float EaseOutBounce$lambda$3(float fraction) {
    ...
    static final float EaseInBounce$lambda$4(float fraction) {
    ...
    static final float EaseInOutBounce$lambda$5(float fraction) {
        if (fraction < 0.5d) {

...
public class MutableSnapshot extends Snapshot {
    ...
    */
    ...
    public void dispose() {
        if (!getDisposed()) {
            super.dispose();
            mo3751nestedDeactivated$runtime_release(this);
        }
    }
    ...
    private final void abandon() {
        ...
        MutableScatterSet modified2 = mutableSnapshot.getModified$runtime_release();
        if (modified2 != null) {
    ...
    public final SnapshotApplyResult innerApplyLocked$runtime_release(int snapshotId, Map<StateRecord, ? extends StateRecord> optimisticMerges, SnapshotIdSet invalidSnapshots) {
        ...
        MutableScatterSet modified = getModified$runtime_release();
        Intrinsics.checkNotNull(modified);
        List list4 = null;
        MutableScatterSet this_$iv = modified;
        int $i$f$forEach = 0;
        Object[] k$iv = this_$iv.elements;
                ...
                if ($this$maskEmptyOrDeleted$iv$iv$iv != -9187201950435737472L) {
                    ...
                    while (j$iv$iv2 < bitCount$iv$iv) {
                        ...
                        if (value$iv$iv$iv < 128) {
                            ...
                            StateObject state = (StateObject) k$iv2[index$iv$iv];
                            List list5 = list3;
                            ...
                            if (current == null) {
                                ...
                                previous = SnapshotKt.readable(first, getId(), start3);
                                if (previous == null) {
                                    start2 = start3;
                                } else {
                                    start2 = start3;
                                        ...
                                        if (Intrinsics.areEqual(current, previous)) {
                                            ...
                                            if (!Intrinsics.areEqual(merged, applied)) {
                                                if (Intrinsics.areEqual(merged, current)) {
                                                    ...
                                                    it2.add(TuplesKt.to(state, current.create()));
                                                    if (list2 == null) {
                                                        it3 = new ArrayList();
                                                        list2 = it3;
                                                    } else {
                                                    ...
                                                    it.add(!Intrinsics.areEqual(merged, previous) ? TuplesKt.to(state, merged) : TuplesKt.to(state, previous.create()));
                                                    list3 = list5;
                                                }
                                            }
                                        }
        ...
        if (list != null) {
            ...
            for (int index$iv = 0; index$iv < size; index$iv++) {
                Object item$iv = it4.get(index$iv);
        ...
        if (list2 != null) {
            ...
            for (int index$iv2 = 0; index$iv2 < size2; index$iv2++) {
                Object item$iv2 = list6.get(index$iv2);
                modified.remove((StateObject) item$iv2);
            }
            List $this$fastForEach$iv = this.merged;
            this.merged = $this$fastForEach$iv == null ? list6 : CollectionsKt.plus((Collection) $this$fastForEach$iv, (Iterable) list6);
        }

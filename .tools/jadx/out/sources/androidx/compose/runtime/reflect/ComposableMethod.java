...
public final class ComposableMethod {
    ...
    public final Object invoke(Composer composer, Object instance, Object... args) {
        ...
        Object[] objArr2 = new Integer[defaultParams];
        int i = 0;
        while (i < defaultParams) {
            ...
            while (it.hasNext()) {
                ...
                int it2 = (item$iv$iv >= objArr.length || args[item$iv$iv] == null) ? 1 : 0;
            ...
            objArr2[i] = Integer.valueOf(accumulator$iv);
            i++;
            objArr = args;
        ...
        while (i3 < totalParams) {
            if (i3 >= 0 && i3 < realParamsCount) {
                ...
                obj = objArr2[i3 - defaultStartIndex];
            }
            arguments[i3] = obj;
            i3++;
        }

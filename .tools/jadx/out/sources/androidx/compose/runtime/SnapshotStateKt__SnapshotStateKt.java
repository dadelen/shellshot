...
final /* synthetic */ class SnapshotStateKt__SnapshotStateKt {
    ...
    public static final <T> State<T> rememberUpdatedState(T t, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1058319986, $changed, -1, "androidx.compose.runtime.rememberUpdatedState (SnapshotState.kt:309)");
        }
        ...
        MutableState $this$rememberUpdatedState_u24lambda_u245 = (MutableState) value$iv;
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        return $this$rememberUpdatedState_u24lambda_u245;
    }
}

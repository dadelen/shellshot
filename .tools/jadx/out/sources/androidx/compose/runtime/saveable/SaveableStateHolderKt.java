...
public final class SaveableStateHolderKt {
    public static final SaveableStateHolder rememberSaveableStateHolder(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(15454635, $changed, -1, "androidx.compose.runtime.saveable.rememberSaveableStateHolder (SaveableStateHolder.kt:60)");
        }
        $composer.startReplaceGroup(-796080049);
        ComposerKt.sourceInformation($composer, "*60@2434L111,65@2619L7");
        Object m3749rememberSaveable = RememberSaveableKt.m3749rememberSaveable(new Object[0], SaveableStateHolderImpl.INSTANCE.getSaver(), (String) null, (Function0<? extends Object>) new Function0<SaveableStateHolderImpl>() { // from class: androidx.compose.runtime.saveable.SaveableStateHolderKt$rememberSaveableStateHolder$1
        ...
        SaveableStateHolderImpl $this$rememberSaveableStateHolder_u24lambda_u240 = (SaveableStateHolderImpl) m3749rememberSaveable;
        ...
        SaveableStateHolderImpl saveableStateHolderImpl = (SaveableStateHolderImpl) m3749rememberSaveable;

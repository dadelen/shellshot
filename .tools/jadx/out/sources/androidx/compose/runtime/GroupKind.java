...
final class GroupKind {
    ...
    private static final int Group = m3625constructorimpl(0);
    private static final int Node = m3625constructorimpl(1);
    private static final int ReusableNode = m3625constructorimpl(2);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ GroupKind m3624boximpl(int i) {
        return new GroupKind(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m3625constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3626equalsimpl(int i, Object obj) {
        return (obj instanceof GroupKind) && i == ((GroupKind) obj).m3632unboximpl();
    }
    ...
    public static String m3631toStringimpl(int i) {
    ...
    public static final boolean m3629isNodeimpl(int arg0) {
        return arg0 != INSTANCE.m3633getGroupULZAiWs();
    }

    /* renamed from: isReusable-impl, reason: not valid java name */
    public static final boolean m3630isReusableimpl(int arg0) {
        return arg0 != INSTANCE.m3634getNodeULZAiWs();
    }
    ...
    public static final class Companion {
        ...
        public final int m3633getGroupULZAiWs() {
            return GroupKind.Group;
        }

        /* renamed from: getNode-ULZAiWs, reason: not valid java name */
        public final int m3634getNodeULZAiWs() {
            return GroupKind.Node;
        }

        /* renamed from: getReusableNode-ULZAiWs, reason: not valid java name */
        public final int m3635getReusableNodeULZAiWs() {

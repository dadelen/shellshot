...
public final class SnackbarHostState {
    ...
    /* JADX WARN: Removed duplicated region for block: B:45:0x00f1 A[Catch: all -> 0x010b, TRY_LEAVE, TryCatch #4 {all -> 0x010b, blocks: (B:43:0x00db, B:45:0x00f1), top: B:42:0x00db }] */
    ...
    private static final class SnackbarDataImpl implements SnackbarData {
        ...
        public void performAction() {
            if (this.continuation.isActive()) {
                ...
                cancellableContinuation.resumeWith(Result.m7216constructorimpl(SnackbarResult.ActionPerformed));
            }
        }
        ...
        public void dismiss() {
            if (this.continuation.isActive()) {
                CancellableContinuation<SnackbarResult> cancellableContinuation = this.continuation;
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m7216constructorimpl(SnackbarResult.Dismissed));
            }
        }
    }
}

...
public final class RippleHostView extends View {
    ...
    public final void m1747addRippleKOepWvA(PressInteraction.Press interaction, boolean bounded, long size, int radius, long color, float alpha, Function0<Unit> onInvalidateRipple) {
        ...
        m1748setRippleProperties07v42R4(size, color, alpha);
        if (bounded) {
            ripple.setHotspot(Offset.m3922getXimpl(interaction.getPressPosition()), Offset.m3923getYimpl(interaction.getPressPosition()));
        } else {
    ...
    public final void m1748setRippleProperties07v42R4(long size, long color, float alpha) {
        UnprojectedRipple ripple = this.ripple;
        if (ripple == null) {
            return;
        }
        ripple.m1759setColorDxMtmZc(color, alpha);
        Rect newBounds = new Rect(0, 0, MathKt.roundToInt(Size.m3991getWidthimpl(size)), MathKt.roundToInt(Size.m3988getHeightimpl(size)));

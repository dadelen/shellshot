...
public interface RippleTheme {
    ...
    long mo1501defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m1755defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
            float contentLuminance = ColorKt.m4215luminance8_81llA(contentColor);
            if (!lightTheme && contentLuminance < 0.5d) {
                return Color.INSTANCE.m4200getWhite0d7_KjU();
            }
            return contentColor;
        }
        ...
        public final RippleAlpha m1754defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            ...
            if (ColorKt.m4215luminance8_81llA(contentColor) > 0.5d) {

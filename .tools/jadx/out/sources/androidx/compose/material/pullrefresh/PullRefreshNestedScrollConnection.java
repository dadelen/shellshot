...
final class PullRefreshNestedScrollConnection implements NestedScrollConnection {
    ...
    public long mo748onPreScrollOzD1aCk(long available, int source) {
        ...
        if (NestedScrollSource.m5245equalsimpl0(source, NestedScrollSource.INSTANCE.m5257getUserInputWNlRxjI()) && Offset.m3923getYimpl(available) < 0.0f) {
            return OffsetKt.Offset(0.0f, this.onPull.invoke(Float.valueOf(Offset.m3923getYimpl(available))).floatValue());
        }
        return Offset.INSTANCE.m3938getZeroF1C5BW0();
    }
    ...
    */
    public java.lang.Object mo747onPreFlingQWom1Mo(long r8, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r10) {
        /*
            r7 = this;
        ...
        L35:
            ...
            float r4 = androidx.compose.ui.unit.Velocity.m6864getYimpl(r8)
            java.lang.Float r4 = kotlin.coroutines.jvm.internal.Boxing.boxFloat(r4)
            r5 = 0
            r0.F$0 = r5
            r6 = 1
            r0.label = r6
            java.lang.Object r8 = r3.invoke(r4, r0)
            if (r8 != r1) goto L50
            return r1
        L50:
            ...
            androidx.compose.ui.unit.Velocity r8 = androidx.compose.ui.unit.Velocity.m6854boximpl(r8)
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.pullrefresh.PullRefreshNestedScrollConnection.mo747onPreFlingQWom1Mo(long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}

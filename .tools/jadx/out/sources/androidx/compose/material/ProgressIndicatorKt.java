...
public final class ProgressIndicatorKt {
    ...
    */
    public static final void m1608LinearProgressIndicator_5eSRE(float r24, androidx.compose.ui.Modifier r25, long r26, long r28, int r30, androidx.compose.runtime.Composer r31, final int r32, final int r33) {
        /*
    ...
    /* JADX WARN: Code restructure failed: missing block: B:59:0x0211, code lost:
        ...
        if (r13.changed(r11) == false) goto L91;
     */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1606LinearProgressIndicator2cYBFYY(androidx.compose.ui.Modifier r37, long r38, long r40, int r42, androidx.compose.runtime.Composer r43, final int r44, final int r45) {
        /*
    ...
    public static final /* synthetic */ void m1609LinearProgressIndicatoreaDK9VM(final float progress, Modifier modifier, long color, long backgroundColor, Composer $composer, final int $changed, final int i) {
        float f;
        Modifier modifier2;
        long j;
        long j2;
        ...
        if (($dirty & 1171) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 8) != 0) {
                    backgroundColor3 = Color.m4161copywmQWz5c(color2, (r12 & 1) != 0 ? Color.m4165getAlphaimpl(color2) : 0.24f, (r12 & 2) != 0 ? Color.m4169getRedimpl(color2) : 0.0f, (r12 & 4) != 0 ? Color.m4168getGreenimpl(color2) : 0.0f, (r12 & 8) != 0 ? Color.m4166getBlueimpl(color2) : 0.0f);
                    $dirty &= -7169;
                    modifier3 = modifier5;
            ...
            m1608LinearProgressIndicator_5eSRE(f, modifier3, color3, backgroundColor2, StrokeCap.INSTANCE.m4515getButtKaPHkGw(), $composer2, ($dirty & 14) | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168), 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$5
                ...
                public final void invoke(Composer composer, int i5) {
                    ProgressIndicatorKt.m1609LinearProgressIndicatoreaDK9VM(progress, modifier4, color4, backgroundColor4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final /* synthetic */ void m1607LinearProgressIndicatorRIQooxk(Modifier modifier, long color, long backgroundColor, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        long j2;
        long color2;
        ...
        if (($dirty & 147) == 146 && $composer2.getSkipping()) {
            ...
            m1606LinearProgressIndicator2cYBFYY(modifier3, color3, backgroundColor2, StrokeCap.INSTANCE.m4515getButtKaPHkGw(), $composer2, ($dirty & 14) | ($dirty & 112) | ($dirty & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            color4 = color3;
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$6
                ...
                public final void invoke(Composer composer, int i5) {
                    ProgressIndicatorKt.m1607LinearProgressIndicatorRIQooxk(Modifier.this, color4, backgroundColor4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }

...
public final class DifferenceKt {
    ...
    public static final ImageVector getDifference(Icons.Outlined $this$Difference) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _difference = ImageVector.Builder.m4846addPathoIyEayM$default($this$_get_Difference__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();

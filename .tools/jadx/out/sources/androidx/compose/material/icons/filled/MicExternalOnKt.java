...
public final class MicExternalOnKt {
    ...
    public static final ImageVector getMicExternalOn(Icons.Filled $this$MicExternalOn) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, -2.21f, 1.79f, -4.0f, 4.0f, -4.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _micExternalOn = ImageVector.Builder.m4846addPathoIyEayM$default($this$_get_MicExternalOn__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();

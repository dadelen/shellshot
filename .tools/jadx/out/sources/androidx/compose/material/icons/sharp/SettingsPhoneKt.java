...
public final class SettingsPhoneKt {
    ...
    public static final ImageVector getSettingsPhone(Icons.Sharp $this$SettingsPhone) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(-2.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _settingsPhone = ImageVector.Builder.m4846addPathoIyEayM$default($this$_get_SettingsPhone__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();

...
public final class ChaletKt {
    ...
    public static final ImageVector getChalet(Icons.Filled $this$Chalet) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineTo(6.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _chalet = ImageVector.Builder.m4846addPathoIyEayM$default($this$_get_Chalet__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();

...
public final class FabPosition {
    ...
    private static final int Start = m1551constructorimpl(0);
    private static final int Center = m1551constructorimpl(1);
    private static final int End = m1551constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FabPosition m1550boximpl(int i) {
        return new FabPosition(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m1551constructorimpl(int i) {
        return i;
    }
    ...
    public static String m1555toStringimpl(int arg0) {
        return m1553equalsimpl0(arg0, Start) ? "FabPosition.Start" : m1553equalsimpl0(arg0, Center) ? "FabPosition.Center" : "FabPosition.End";
    }
}

...
final class DefaultSelectableChipColors implements SelectableChipColors {
    ...
    public State<Color> backgroundColor(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation($composer, "C(backgroundColor)666@29286L28:Chip.kt#jmzs0o");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-403836585, $changed, -1, "androidx.compose.material.DefaultSelectableChipColors.backgroundColor (Chip.kt:660)");
        }
        if (enabled) {
    ...
    public State<Color> contentColor(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation($composer, "C(contentColor)676@29598L28:Chip.kt#jmzs0o");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(2025240134, $changed, -1, "androidx.compose.material.DefaultSelectableChipColors.contentColor (Chip.kt:670)");
        }
        if (enabled) {
    ...
    public State<Color> leadingIconColor(boolean enabled, boolean selected, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation($composer, "C(leadingIconColor)686@29926L28:Chip.kt#jmzs0o");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(189838188, $changed, -1, "androidx.compose.material.DefaultSelectableChipColors.leadingIconColor (Chip.kt:680)");
        }
        if (enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m4164equalsimpl0(this.backgroundColor, ((DefaultSelectableChipColors) other).backgroundColor) && Color.m4164equalsimpl0(this.contentColor, ((DefaultSelectableChipColors) other).contentColor) && Color.m4164equalsimpl0(this.leadingIconColor, ((DefaultSelectableChipColors) other).leadingIconColor) && Color.m4164equalsimpl0(this.disabledBackgroundColor, ((DefaultSelectableChipColors) other).disabledBackgroundColor) && Color.m4164equalsimpl0(this.disabledContentColor, ((DefaultSelectableChipColors) other).disabledContentColor) && Color.m4164equalsimpl0(this.disabledLeadingIconColor, ((DefaultSelectableChipColors) other).disabledLeadingIconColor) && Color.m4164equalsimpl0(this.selectedBackgroundColor, ((DefaultSelectableChipColors) other).selectedBackgroundColor) && Color.m4164equalsimpl0(this.selectedContentColor, ((DefaultSelectableChipColors) other).selectedContentColor) && Color.m4164equalsimpl0(this.selectedLeadingIconColor, ((DefaultSelectableChipColors) other).selectedLeadingIconColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((((((((result * 31) + Color.m4170hashCodeimpl(this.contentColor)) * 31) + Color.m4170hashCodeimpl(this.leadingIconColor)) * 31) + Color.m4170hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m4170hashCodeimpl(this.disabledContentColor)) * 31) + Color.m4170hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m4170hashCodeimpl(this.selectedBackgroundColor)) * 31) + Color.m4170hashCodeimpl(this.selectedContentColor)) * 31) + Color.m4170hashCodeimpl(this.selectedLeadingIconColor);
    }
}

...
public final class RenderNodeApi29 implements DeviceRenderNode {
    ...
    public void mo5836setCompositingStrategyaDBOjCE(int value) {
        ...
        } else if (CompositingStrategy.m4247equalsimpl0(value, CompositingStrategy.INSTANCE.m4252getModulateAlphaNrFUSI())) {
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            ...
            Canvas.m4134clipPathmtrdDE$default($this$record_u24lambda_u241, clipPath, 0, 2, null);
        }

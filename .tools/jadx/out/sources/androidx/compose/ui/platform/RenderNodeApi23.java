...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    private int internalCompositingStrategy = CompositingStrategy.INSTANCE.m4251getAutoNrFUSI();
    private int left;
    ...
    public void mo5836setCompositingStrategyaDBOjCE(int value) {
        if (CompositingStrategy.m4247equalsimpl0(value, CompositingStrategy.INSTANCE.m4253getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else {
            boolean m4247equalsimpl0 = CompositingStrategy.m4247equalsimpl0(value, CompositingStrategy.INSTANCE.m4252getModulateAlphaNrFUSI());
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m4247equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m4253getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            ...
            Canvas.m4134clipPathmtrdDE$default($this$record_u24lambda_u240, clipPath, 0, 2, null);
        }

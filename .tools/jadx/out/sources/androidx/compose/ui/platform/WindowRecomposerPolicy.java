...
public final class WindowRecomposerPolicy {
    ...
    public final Recomposer createAndInstallWindowRecomposer$ui_release(View rootView) {
        ...
        unsetJob = BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, HandlerDispatcherKt.from(rootView.getHandler(), "windowRecomposer cleanup").getImmediate(), null, new WindowRecomposerPolicy$createAndInstallWindowRecomposer$unsetJob$1(newRecomposer, rootView, null), 2, null);

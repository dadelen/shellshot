...
public final class DepthSortedSet {
    ...
    public final boolean contains(LayoutNode node) {
        ...
        if (this.extraAssertions) {
            boolean value$iv = contains == getMapOfOriginalDepth().containsKey(node);
            if (!value$iv) {
    ...
    public final void add(LayoutNode node) {
        ...
        if (value$iv2) {
            ...
            if (usedDepth == null) {
                ...
                boolean value$iv3 = usedDepth.intValue() == node.getDepth();
                if (!value$iv3) {
    ...
    public final boolean remove(LayoutNode node) {
        ...
        if (this.extraAssertions) {
            ...
            boolean value$iv2 = Intrinsics.areEqual(usedDepth, contains ? Integer.valueOf(node.getDepth()) : null);
            if (!value$iv2) {
                InlineClassHelperKt.throwIllegalStateException("invalid node depth");
            }
        }

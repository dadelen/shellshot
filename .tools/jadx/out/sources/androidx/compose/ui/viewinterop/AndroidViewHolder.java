...
public class AndroidViewHolder extends ViewGroup implements NestedScrollingParent3, ComposeNodeLifecycleCallback, OwnerScope {
    ...
    public AndroidViewHolder(Context context, CompositionContext parentContext, int compositeKeyHash, NestedScrollDispatcher dispatcher, View view, Owner owner) {
        ...
        }), $this$layoutNode_u24lambda_u243), new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$coreModifier$2
        ...
        layoutNode.setMeasurePolicy(new MeasurePolicy() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5
            ...
            public MeasureResult mo32measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
                ...
                if (AndroidViewHolder.this.getChildCount() == 0) {
                    return MeasureScope.layout$default($this$measure_u2d3p2s80s, Constraints.m6581getMinWidthimpl(constraints), Constraints.m6580getMinHeightimpl(constraints), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5$measure$1
                        @Override // kotlin.jvm.functions.Function1
                ...
                if (Constraints.m6581getMinWidthimpl(constraints) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumWidth(Constraints.m6581getMinWidthimpl(constraints));
                }
                if (Constraints.m6580getMinHeightimpl(constraints) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumHeight(Constraints.m6580getMinHeightimpl(constraints));
                }
                AndroidViewHolder androidViewHolder = AndroidViewHolder.this;
                AndroidViewHolder androidViewHolder2 = AndroidViewHolder.this;
                int m6581getMinWidthimpl = Constraints.m6581getMinWidthimpl(constraints);
                int m6579getMaxWidthimpl = Constraints.m6579getMaxWidthimpl(constraints);
                ViewGroup.LayoutParams layoutParams = AndroidViewHolder.this.getLayoutParams();
                Intrinsics.checkNotNull(layoutParams);
                obtainMeasureSpec = androidViewHolder2.obtainMeasureSpec(m6581getMinWidthimpl, m6579getMaxWidthimpl, layoutParams.width);
                AndroidViewHolder androidViewHolder3 = AndroidViewHolder.this;
                int m6580getMinHeightimpl = Constraints.m6580getMinHeightimpl(constraints);
                int m6578getMaxHeightimpl = Constraints.m6578getMaxHeightimpl(constraints);
                ViewGroup.LayoutParams layoutParams2 = AndroidViewHolder.this.getLayoutParams();
                Intrinsics.checkNotNull(layoutParams2);
                obtainMeasureSpec2 = androidViewHolder3.obtainMeasureSpec(m6580getMinHeightimpl, m6578getMaxHeightimpl, layoutParams2.height);
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type, int[] consumed) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            long consumedByParent = nestedScrollDispatcher.m5239dispatchPostScrollDzOQY0M(Offset, Offset2, nestedScrollSource);
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3922getXimpl(consumedByParent));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3923getYimpl(consumedByParent));
        }
    }
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            long Offset2 = OffsetKt.Offset(composeOffset3, composeOffset4);
            nestedScrollSource = AndroidViewHolder_androidKt.toNestedScrollSource(type);
            nestedScrollDispatcher.m5239dispatchPostScrollDzOQY0M(Offset, Offset2, nestedScrollSource);
        }
    }
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed, int type) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            long Offset = OffsetKt.Offset(composeOffset, composeOffset2);
            nestedScrollSource = AndroidViewHolder_androidKt.toNestedScrollSource(type);
            long consumedByParent = nestedScrollDispatcher.m5241dispatchPreScrollOzD1aCk(Offset, nestedScrollSource);
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3922getXimpl(consumedByParent));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3923getYimpl(consumedByParent));
        }
    }

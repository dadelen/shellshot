...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m4880getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m4515getButtKaPHkGw();
        }
        return m4879getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m4879getStrokeLineCapCSYIeUk(int id, int defValue) {
        switch (id) {
            case 0:
                return StrokeCap.INSTANCE.m4515getButtKaPHkGw();
            case 1:
                return StrokeCap.INSTANCE.m4516getRoundKaPHkGw();
            case 2:
                return StrokeCap.INSTANCE.m4517getSquareKaPHkGw();
            default:
                return defValue;
        }
    }
    ...
    static /* synthetic */ int m4882getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m4526getMiterLxFBmk8();
        }
        return m4881getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m4881getStrokeLineJoinkLtJ_vA(int id, int defValue) {
        switch (id) {
            case 0:
                return StrokeJoin.INSTANCE.m4526getMiterLxFBmk8();
            case 1:
                return StrokeJoin.INSTANCE.m4527getRoundLxFBmk8();
            case 2:
                return StrokeJoin.INSTANCE.m4525getBevelLxFBmk8();
            default:
                return defValue;
        }
    }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser $this$createVectorImageBuilder, Resources res, Resources.Theme theme, AttributeSet attrs) {
        ...
        if (vectorAttrs.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (value.type != 2) {
                ...
                if (tintColorStateList != null) {
                    ...
                    tintColor = Color.INSTANCE.m4199getUnspecified0d7_KjU();
                }
            } else {
                tintColor = Color.INSTANCE.m4199getUnspecified0d7_KjU();
            }
        ...
        if (blendModeValue != -1) {
            switch (blendModeValue) {
                case 3:
                    tintBlendMode = BlendMode.INSTANCE.m4105getSrcOver0nO6VwU();
                    break;
                case 5:
                    tintBlendMode = BlendMode.INSTANCE.m4103getSrcIn0nO6VwU();
                    break;
                case 9:
                    tintBlendMode = BlendMode.INSTANCE.m4102getSrcAtop0nO6VwU();
                    break;
                case 14:
                    tintBlendMode = BlendMode.INSTANCE.m4094getModulate0nO6VwU();
                    break;
                case 15:
                    tintBlendMode = BlendMode.INSTANCE.m4099getScreen0nO6VwU();
                    break;
                case 16:
                    tintBlendMode = BlendMode.INSTANCE.m4097getPlus0nO6VwU();
                    break;
                default:
                    tintBlendMode = BlendMode.INSTANCE.m4103getSrcIn0nO6VwU();
                    break;
        ...
        float defaultWidthDp = Dp.m6626constructorimpl($this$dp$iv);
        float $this$dp$iv2 = defaultHeight / res.getDisplayMetrics().density;
        float defaultHeightDp = Dp.m6626constructorimpl($this$dp$iv2);
        vectorAttrs.recycle();
    ...
    public static final void parsePath(AndroidVectorParser $this$parsePath, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int strokeLineCap = m4879getStrokeLineCapCSYIeUk(lineCap, StrokeCap.INSTANCE.m4515getButtKaPHkGw());
        ...
        int strokeLineJoin = m4881getStrokeLineJoinkLtJ_vA(lineJoin, StrokeJoin.INSTANCE.m4525getBevelLxFBmk8());
        ...
        int fillPathType = fillRule == 0 ? companion.m4445getNonZeroRgk1Os() : companion.m4444getEvenOddRgk1Os();
        builder.m4847addPathoIyEayM(pathData, fillPathType, name, fillBrush, fillAlpha, strokeBrush, strokeAlpha, strokeLineWidth, strokeLineCap, strokeLineJoin, strokeMiterLimit, trimPathStart, trimPathEnd, trimPathOffset);
    }

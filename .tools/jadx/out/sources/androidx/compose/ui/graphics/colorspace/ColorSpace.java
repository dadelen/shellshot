...
public abstract class ColorSpace {
    ...
    public final int getComponentCount() {
        return ColorModel.m4570getComponentCountimpl(this.model);
    }
    ...
    public final float[] fromXyz(float x, float y, float z) {
        float[] xyz = new float[ColorModel.m4570getComponentCountimpl(this.model)];
        xyz[0] = x;
        xyz[1] = y;
        xyz[2] = z;
        return fromXyz(xyz);
    ...
    public String toString() {
        return this.name + " (id=" + this.id + ", model=" + ((Object) ColorModel.m4572toStringimpl(this.model)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        if (this.id == that.id && Intrinsics.areEqual(this.name, that.name)) {
            return ColorModel.m4569equalsimpl0(this.model, that.model);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((result * 31) + ColorModel.m4571hashCodeimpl(this.model)) * 31) + this.id;
    }
}

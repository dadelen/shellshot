...
public final class PaintingStyle {
    ...
    private static final int Fill = m4423constructorimpl(0);
    private static final int Stroke = m4423constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PaintingStyle m4422boximpl(int i) {
        return new PaintingStyle(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4423constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4424equalsimpl(int i, Object obj) {
        return (obj instanceof PaintingStyle) && i == ((PaintingStyle) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4425equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4426hashCodeimpl(int i) {
    ...
    public int hashCode() {
        return m4426hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m4429getFillTiuSbCo() {
            return PaintingStyle.Fill;
        }

        /* renamed from: getStroke-TiuSbCo, reason: not valid java name */
        public final int m4430getStrokeTiuSbCo() {
            return PaintingStyle.Stroke;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4427toStringimpl(int arg0) {
        return m4425equalsimpl0(arg0, Fill) ? "Fill" : m4425equalsimpl0(arg0, Stroke) ? "Stroke" : "Unknown";
    }

    public String toString() {
        return m4427toStringimpl(this.value);
    }
}

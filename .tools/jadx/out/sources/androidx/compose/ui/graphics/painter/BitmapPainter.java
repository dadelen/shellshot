...
public final class BitmapPainter extends Painter {
    ...
    */
    ...
    private BitmapPainter(ImageBitmap image, long srcOffset, long srcSize) {
        ...
        this.filterQuality = FilterQuality.INSTANCE.m4262getLowfv9h1I();
        this.size = m4830validateSizeN5eqBDc(this.srcOffset, this.srcSize);
        this.alpha = 1.0f;
    }
    ...
    public final void m4833setFilterQualityvDHp3xo$ui_graphics_release(int i) {
    ...
    protected void onDraw(DrawScope $this$onDraw) {
        ...
        float $this$fastRoundToInt$iv = Size.m3991getWidthimpl($this$onDraw.mo4713getSizeNHjbRc());
        int round = Math.round($this$fastRoundToInt$iv);
        float $this$fastRoundToInt$iv2 = Size.m3988getHeightimpl($this$onDraw.mo4713getSizeNHjbRc());
        DrawScope.m4696drawImageAZ2fEMs$default($this$onDraw, imageBitmap, j, j2, 0L, IntSizeKt.IntSize(round, Math.round($this$fastRoundToInt$iv2)), this.alpha, null, this.colorFilter, 0, this.filterQuality, 328, null);
    }

    @Override // androidx.compose.ui.graphics.painter.Painter
    /* renamed from: getIntrinsicSize-NH-jbRc, reason: not valid java name */
    public long mo4832getIntrinsicSizeNHjbRc() {
        return IntSizeKt.m6808toSizeozmzZPI(this.size);
    }
    ...
    private final long m4830validateSizeN5eqBDc(long srcOffset, long srcSize) {
        if (!(IntOffset.m6754getXimpl(srcOffset) >= 0 && IntOffset.m6755getYimpl(srcOffset) >= 0 && IntSize.m6796getWidthimpl(srcSize) >= 0 && IntSize.m6795getHeightimpl(srcSize) >= 0 && IntSize.m6796getWidthimpl(srcSize) <= this.image.getWidth() && IntSize.m6795getHeightimpl(srcSize) <= this.image.getHeight())) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof BitmapPainter) && Intrinsics.areEqual(this.image, ((BitmapPainter) other).image) && IntOffset.m6753equalsimpl0(this.srcOffset, ((BitmapPainter) other).srcOffset) && IntSize.m6794equalsimpl0(this.srcSize, ((BitmapPainter) other).srcSize) && FilterQuality.m4257equalsimpl0(this.filterQuality, ((BitmapPainter) other).filterQuality);
    }

    public int hashCode() {
        int result = this.image.hashCode();
        return (((((result * 31) + IntOffset.m6756hashCodeimpl(this.srcOffset)) * 31) + IntSize.m6797hashCodeimpl(this.srcSize)) * 31) + FilterQuality.m4258hashCodeimpl(this.filterQuality);
    }

    public String toString() {
        return "BitmapPainter(image=" + this.image + ", srcOffset=" + ((Object) IntOffset.m6761toStringimpl(this.srcOffset)) + ", srcSize=" + ((Object) IntSize.m6799toStringimpl(this.srcSize)) + ", filterQuality=" + ((Object) FilterQuality.m4259toStringimpl(this.filterQuality)) + ')';
    }
}

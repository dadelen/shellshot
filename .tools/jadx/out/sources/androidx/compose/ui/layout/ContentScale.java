...
public interface ContentScale {
    ...
    long mo5482computeScaleFactorH7hwNQA(long srcSize, long dstSize);
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo5482computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float it;
                it = ContentScaleKt.m5488computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
        ...
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            public long mo5482computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float it;
                it = ContentScaleKt.m5489computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(it, it);
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            public long mo5482computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float it;
                it = ContentScaleKt.m5487computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(it, it);
            }
        };
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            public long mo5482computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float it;
                it = ContentScaleKt.m5490computeFillWidthiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(it, it);
            }
        };
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            public long mo5482computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float it;
                if (Size.m3991getWidthimpl(srcSize) > Size.m3991getWidthimpl(dstSize) || Size.m3988getHeightimpl(srcSize) > Size.m3988getHeightimpl(dstSize)) {
                    it = ContentScaleKt.m5489computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                    return ScaleFactorKt.ScaleFactor(it, it);
                }
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo5482computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m5490computeFillWidthiLBOSCw;
                float m5487computeFillHeightiLBOSCw;
                m5490computeFillWidthiLBOSCw = ContentScaleKt.m5490computeFillWidthiLBOSCw(srcSize, dstSize);
                m5487computeFillHeightiLBOSCw = ContentScaleKt.m5487computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m5490computeFillWidthiLBOSCw, m5487computeFillHeightiLBOSCw);
            }
        };

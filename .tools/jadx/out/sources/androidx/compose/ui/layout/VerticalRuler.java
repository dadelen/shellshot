...
public final class VerticalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui_release(float coordinate, LayoutCoordinates sourceCoordinates, LayoutCoordinates targetCoordinates) {
        long offset = OffsetKt.Offset(coordinate, IntSize.m6795getHeightimpl(sourceCoordinates.mo5499getSizeYbymL2g()) / 2.0f);
        return Offset.m3922getXimpl(targetCoordinates.mo5500localPositionOfR5De75A(sourceCoordinates, offset));
    }
}

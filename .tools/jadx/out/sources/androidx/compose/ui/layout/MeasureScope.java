...
public interface MeasureScope extends IntrinsicMeasureScope {
    ...
    public static final class DefaultImpls {
        ...
        public static int m5533roundToPxR2X_6o(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo357roundToPxR2X_6o($receiver);
        }

        @Deprecated
        /* renamed from: roundToPx-0680j_4, reason: not valid java name */
        public static int m5534roundToPx0680j_4(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo358roundToPx0680j_4($receiver);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m5535toDpGaN1DYA(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo359toDpGaN1DYA($receiver);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m5536toDpu2uoSUM(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo360toDpu2uoSUM($receiver);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m5537toDpu2uoSUM(MeasureScope $this, int $receiver) {
            return MeasureScope.super.mo361toDpu2uoSUM($receiver);
        }

        @Deprecated
        /* renamed from: toDpSize-k-rfVVM, reason: not valid java name */
        public static long m5538toDpSizekrfVVM(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo362toDpSizekrfVVM($receiver);
        }

        @Deprecated
        /* renamed from: toPx--R2X_6o, reason: not valid java name */
        public static float m5539toPxR2X_6o(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo363toPxR2X_6o($receiver);
        }

        @Deprecated
        /* renamed from: toPx-0680j_4, reason: not valid java name */
        public static float m5540toPx0680j_4(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo364toPx0680j_4($receiver);
        }
        ...
        public static long m5541toSizeXkaWNTQ(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo365toSizeXkaWNTQ($receiver);
        }

        @Deprecated
        /* renamed from: toSp-0xMU5do, reason: not valid java name */
        public static long m5542toSp0xMU5do(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo366toSp0xMU5do($receiver);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m5543toSpkPz2Gy4(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo367toSpkPz2Gy4($receiver);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m5544toSpkPz2Gy4(MeasureScope $this, int $receiver) {
            return MeasureScope.super.mo368toSpkPz2Gy4($receiver);
        }

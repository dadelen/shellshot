...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    private final MutableState size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m3979boximpl(Size.INSTANCE.m3999getUnspecifiedNHjbRc()), null, 2, null);
    private final State<Shader> shaderState = SnapshotStateKt.derivedStateOf(new Function0<Shader>() { // from class: androidx.compose.ui.text.platform.style.ShaderBrushSpan$shaderState$1
        ...
        public final Shader invoke() {
            long $this$isUnspecified$iv = ShaderBrushSpan.this.m6375getSizeNHjbRc();
            if (($this$isUnspecified$iv == InlineClassHelperKt.UnspecifiedPackedFloats) || Size.m3993isEmptyimpl(ShaderBrushSpan.this.m6375getSizeNHjbRc())) {
                return null;
            }
            return ShaderBrushSpan.this.getShaderBrush().mo4132createShaderuvyYCjk(ShaderBrushSpan.this.m6375getSizeNHjbRc());
        }
    });

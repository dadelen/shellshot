...
public final class FontSynthesis {
    ...
    private static final int None = m6210constructorimpl(0);
    private static final int All = m6210constructorimpl(1);
    private static final int Weight = m6210constructorimpl(2);
    private static final int Style = m6210constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FontSynthesis m6209boximpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m6211equalsimpl(this.value, obj);
    }
    ...
    public String toString() {
        return m6216toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m6216toStringimpl(int arg0) {
        return m6212equalsimpl0(arg0, None) ? "None" : m6212equalsimpl0(arg0, All) ? "All" : m6212equalsimpl0(arg0, Weight) ? "Weight" : m6212equalsimpl0(arg0, Style) ? "Style" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final int m6219getNoneGVVA2EU() {
            return FontSynthesis.None;
        }

        /* renamed from: getAll-GVVA2EU, reason: not valid java name */
        public final int m6218getAllGVVA2EU() {
            return FontSynthesis.All;
        }

        /* renamed from: getWeight-GVVA2EU, reason: not valid java name */
        public final int m6221getWeightGVVA2EU() {
            return FontSynthesis.Weight;
        }

        /* renamed from: getStyle-GVVA2EU, reason: not valid java name */
        public final int m6220getStyleGVVA2EU() {
            return FontSynthesis.Style;
        }
    }

    /* renamed from: isWeightOn-impl$ui_text_release, reason: not valid java name */
    public static final boolean m6215isWeightOnimpl$ui_text_release(int arg0) {
        return m6212equalsimpl0(arg0, All) || m6212equalsimpl0(arg0, Weight);
    }

    /* renamed from: isStyleOn-impl$ui_text_release, reason: not valid java name */
    public static final boolean m6214isStyleOnimpl$ui_text_release(int arg0) {
        return m6212equalsimpl0(arg0, All) || m6212equalsimpl0(arg0, Style);
    }
}

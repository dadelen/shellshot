...
public final class AndroidParagraphIntrinsics_androidKt {
    ...
    public static /* synthetic */ int m6348resolveTextDirectionHeuristicsHklW4sA$default(int i, LocaleList localeList, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            localeList = null;
        }
        return m6347resolveTextDirectionHeuristicsHklW4sA(i, localeList);
    }

    /* renamed from: resolveTextDirectionHeuristics-HklW4sA, reason: not valid java name */
    public static final int m6347resolveTextDirectionHeuristicsHklW4sA(int textDirection, LocaleList localeList) {
        Locale currentLocale;
        if (TextDirection.m6503equalsimpl0(textDirection, TextDirection.INSTANCE.m6508getContentOrLtrs_7Xco())) {
            return 2;
        }
        if (TextDirection.m6503equalsimpl0(textDirection, TextDirection.INSTANCE.m6509getContentOrRtls_7Xco())) {
            return 3;
        }
        if (TextDirection.m6503equalsimpl0(textDirection, TextDirection.INSTANCE.m6510getLtrs_7Xco())) {
            return 0;
        }
        if (TextDirection.m6503equalsimpl0(textDirection, TextDirection.INSTANCE.m6511getRtls_7Xco())) {
            return 1;
        }
        if (TextDirection.m6503equalsimpl0(textDirection, TextDirection.INSTANCE.m6507getContents_7Xco()) ? true : TextDirection.m6503equalsimpl0(textDirection, TextDirection.INSTANCE.m6512getUnspecifieds_7Xco())) {
    ...
    public static final boolean getHasEmojiCompat(TextStyle $this$hasEmojiCompat) {
        ...
        return !(((platformStyle == null || (paragraphSyle = platformStyle.getParagraphSyle()) == null) ? null : EmojiSupportMatch.m5944boximpl(paragraphSyle.getEmojiSupportMatch())) == null ? false : EmojiSupportMatch.m5947equalsimpl0(r0.getValue(), EmojiSupportMatch.INSTANCE.m5953getNone_3YsG6Y()));
    }
}

...
public final class TextLayoutInput {
    ...
    public static /* synthetic */ TextLayoutInput m6058copyhu1Yfo$default(TextLayoutInput textLayoutInput, AnnotatedString annotatedString, TextStyle textStyle, List list, int i, boolean z, int i2, Density density, LayoutDirection layoutDirection, Font.ResourceLoader resourceLoader, long j, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        boolean z2 = z;
        return textLayoutInput.m6059copyhu1Yfo(annotatedString, textStyle, list, i, z2, i2, density2, layoutDirection2, resourceLoader2, j2);
    }
    ...
    public final TextLayoutInput m6059copyhu1Yfo(AnnotatedString text, TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int maxLines, boolean softWrap, int overflow, Density density, LayoutDirection layoutDirection, Font.ResourceLoader resourceLoader, long constraints) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TextLayoutInput) && Intrinsics.areEqual(this.text, ((TextLayoutInput) other).text) && Intrinsics.areEqual(this.style, ((TextLayoutInput) other).style) && Intrinsics.areEqual(this.placeholders, ((TextLayoutInput) other).placeholders) && this.maxLines == ((TextLayoutInput) other).maxLines && this.softWrap == ((TextLayoutInput) other).softWrap && TextOverflow.m6535equalsimpl0(this.overflow, ((TextLayoutInput) other).overflow) && Intrinsics.areEqual(this.density, ((TextLayoutInput) other).density) && this.layoutDirection == ((TextLayoutInput) other).layoutDirection && Intrinsics.areEqual(this.fontFamilyResolver, ((TextLayoutInput) other).fontFamilyResolver) && Constraints.m6572equalsimpl0(this.constraints, ((TextLayoutInput) other).constraints);
    }

    public int hashCode() {
        int result = this.text.hashCode();
        return (((((((((((((((((result * 31) + this.style.hashCode()) * 31) + this.placeholders.hashCode()) * 31) + this.maxLines) * 31) + Boolean.hashCode(this.softWrap)) * 31) + TextOverflow.m6536hashCodeimpl(this.overflow)) * 31) + this.density.hashCode()) * 31) + this.layoutDirection.hashCode()) * 31) + this.fontFamilyResolver.hashCode()) * 31) + Constraints.m6582hashCodeimpl(this.constraints);
    }

    public String toString() {
        return "TextLayoutInput(text=" + ((Object) this.text) + ", style=" + this.style + ", placeholders=" + this.placeholders + ", maxLines=" + this.maxLines + ", softWrap=" + this.softWrap + ", overflow=" + ((Object) TextOverflow.m6537toStringimpl(this.overflow)) + ", density=" + this.density + ", layoutDirection=" + this.layoutDirection + ", fontFamilyResolver=" + this.fontFamilyResolver + ", constraints=" + ((Object) Constraints.m6584toStringimpl(this.constraints)) + ')';
    }
}

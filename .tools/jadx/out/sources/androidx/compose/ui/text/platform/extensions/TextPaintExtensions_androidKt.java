...
public final class TextPaintExtensions_androidKt {
    ...
    public static final SpanStyle applySpanStyle(AndroidTextPaint $this$applySpanStyle, SpanStyle style, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4, Density density, boolean requiresLetterSpacing) {
        long m6818getTypeUIouoOA = TextUnit.m6818getTypeUIouoOA(style.getFontSize());
        if (TextUnitType.m6847equalsimpl0(m6818getTypeUIouoOA, TextUnitType.INSTANCE.m6852getSpUIouoOA())) {
            $this$applySpanStyle.setTextSize(density.mo363toPxR2X_6o(style.getFontSize()));
        } else if (TextUnitType.m6847equalsimpl0(m6818getTypeUIouoOA, TextUnitType.INSTANCE.m6851getEmUIouoOA())) {
            $this$applySpanStyle.setTextSize($this$applySpanStyle.getTextSize() * TextUnit.m6819getValueimpl(style.getFontSize()));
        }
        if (hasFontAttributes(style)) {
            ...
            $this$applySpanStyle.setTypeface(function4.invoke(fontFamily, fontWeight, m6198boximpl, FontSynthesis.m6209boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m6218getAllGVVA2EU())));
        }
        ...
        $this$applySpanStyle.m6358setColor8_81llA(style.m6042getColor0d7_KjU());
        $this$applySpanStyle.m6356setBrush12SF9DM(style.getBrush(), Size.INSTANCE.m3999getUnspecifiedNHjbRc(), style.getAlpha());
        ...
        if (TextUnitType.m6847equalsimpl0(TextUnit.m6818getTypeUIouoOA(style.getLetterSpacing()), TextUnitType.INSTANCE.m6852getSpUIouoOA())) {
            if (!(TextUnit.m6819getValueimpl(style.getLetterSpacing()) == 0.0f)) {
                float emWidth = $this$applySpanStyle.getTextSize() * $this$applySpanStyle.getTextScaleX();
                float letterSpacingPx = density.mo363toPxR2X_6o(style.getLetterSpacing());
                if (!(emWidth == 0.0f)) {
                    $this$applySpanStyle.setLetterSpacing(letterSpacingPx / emWidth);
                }
                return m6372generateFallbackSpanStyle62GTOB8(style.getLetterSpacing(), requiresLetterSpacing, style.getBackground(), style.getBaselineShift());
            }
        }
        if (TextUnitType.m6847equalsimpl0(TextUnit.m6818getTypeUIouoOA(style.getLetterSpacing()), TextUnitType.INSTANCE.m6851getEmUIouoOA())) {
            $this$applySpanStyle.setLetterSpacing(TextUnit.m6819getValueimpl(style.getLetterSpacing()));
        }
        return m6372generateFallbackSpanStyle62GTOB8(style.getLetterSpacing(), requiresLetterSpacing, style.getBackground(), style.getBaselineShift());
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:17:0x0053, code lost:
        ...
        if (androidx.compose.ui.text.style.BaselineShift.m6380equalsimpl0(r36.m6383unboximpl(), androidx.compose.ui.text.style.BaselineShift.INSTANCE.m6387getNoney9eOQZs()) == false) goto L24;
     */
    ...
    */
    private static final androidx.compose.ui.text.SpanStyle m6372generateFallbackSpanStyle62GTOB8(long r31, boolean r33, long r34, androidx.compose.ui.text.style.BaselineShift r36) {
        /*
            r0 = r34
            r2 = 1
            r3 = 0
            if (r33 == 0) goto L26
            long r4 = androidx.compose.ui.unit.TextUnit.m6818getTypeUIouoOA(r31)
            androidx.compose.ui.unit.TextUnitType$Companion r6 = androidx.compose.ui.unit.TextUnitType.INSTANCE
            long r6 = r6.m6852getSpUIouoOA()
            boolean r4 = androidx.compose.ui.unit.TextUnitType.m6847equalsimpl0(r4, r6)
            if (r4 == 0) goto L26
            float r4 = androidx.compose.ui.unit.TextUnit.m6819getValueimpl(r31)
            r5 = 0
        ...
        L27:
            ...
            long r5 = r5.m4199getUnspecified0d7_KjU()
            boolean r5 = androidx.compose.ui.graphics.Color.m4164equalsimpl0(r0, r5)
            if (r5 != 0) goto L42
            androidx.compose.ui.graphics.Color$Companion r5 = androidx.compose.ui.graphics.Color.INSTANCE
            long r5 = r5.m4198getTransparent0d7_KjU()
            boolean r5 = androidx.compose.ui.graphics.Color.m4164equalsimpl0(r0, r5)
            if (r5 != 0) goto L42
            r5 = r2
            goto L43
        ...
        L43:
            ...
            float r6 = r6.m6387getNoney9eOQZs()
            float r7 = r36.m6383unboximpl()
            boolean r6 = androidx.compose.ui.text.style.BaselineShift.m6380equalsimpl0(r7, r6)
            if (r6 != 0) goto L56
            goto L57
        L56:
            r2 = r3
        ...
        L64:
            ...
            long r6 = r6.m6830getUnspecifiedXSAIIZE()
            r18 = r6
        L6c:
            if (r5 == 0) goto L71
            r23 = r0
        ...
        L71:
            ...
            long r6 = r6.m4199getUnspecified0d7_KjU()
            r23 = r6
        L79:
            if (r2 == 0) goto L7e
            r20 = r36
        ...
        La6:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.platform.extensions.TextPaintExtensions_androidKt.m6372generateFallbackSpanStyle62GTOB8(long, boolean, long, androidx.compose.ui.text.style.BaselineShift):androidx.compose.ui.text.SpanStyle");
    }
    ...
    public static final void setTextMotion(AndroidTextPaint $this$setTextMotion, TextMotion textMotion) {
        ...
        if (TextMotion.Linearity.m6525equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m6530getLinear4e0Vf04())) {
            $this$setTextMotion.setFlags($this$setTextMotion.getFlags() | 64);
            $this$setTextMotion.setHinting(0);
        } else if (TextMotion.Linearity.m6525equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m6529getFontHinting4e0Vf04())) {
            $this$setTextMotion.getFlags();
            $this$setTextMotion.setHinting(1);
        } else if (TextMotion.Linearity.m6525equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m6531getNone4e0Vf04())) {
            $this$setTextMotion.getFlags();
            $this$setTextMotion.setHinting(0);
        } else {
            $this$setTextMotion.getFlags();

...
public final class AndroidParagraph implements Paragraph {
    ...
    */
    private AndroidParagraph(androidx.compose.ui.text.platform.AndroidParagraphIntrinsics r36, int r37, boolean r38, long r39) {
        /*
    ...
    private AndroidParagraph(String text, TextStyle style, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int maxLines, boolean ellipsis, long constraints, FontFamily.Resolver fontFamilyResolver, Density density) {
        this(new AndroidParagraphIntrinsics(text, style, list, list2, fontFamilyResolver, density), maxLines, ellipsis, constraints, null);
    }
    ...
    public float getWidth() {
        return Constraints.m6579getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo5925getOffsetForPositionk4lQ0M(long position) {
        int line = this.layout.getLineForVertical((int) Offset.m3923getYimpl(position));
        return this.layout.getOffsetForHorizontal(line, Offset.m3922getXimpl(position));
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: getRangeForRect-8-6BmAI, reason: not valid java name */
    public long mo5926getRangeForRect86BmAI(Rect rect, int granularity, final TextInclusionStrategy inclusionStrategy) {
        int m5942toLayoutTextGranularityduNsdkg;
        TextLayout textLayout = this.layout;
        RectF androidRectF = RectHelper_androidKt.toAndroidRectF(rect);
        m5942toLayoutTextGranularityduNsdkg = AndroidParagraph_androidKt.m5942toLayoutTextGranularityduNsdkg(granularity);
        int[] range = textLayout.getRangeForRect(androidRectF, m5942toLayoutTextGranularityduNsdkg, new Function2<RectF, RectF, Boolean>() { // from class: androidx.compose.ui.text.AndroidParagraph$getRangeForRect$range$1
            {
                super(2);
            }
    ...
    public void mo5923fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        this.layout.fillBoundingBoxes(TextRange.m6090getMinimpl(range), TextRange.m6089getMaximpl(range), array, arrayStart);
    }
    ...
    public long mo5927getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo5929paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        AndroidTextPaint $this$paint_RPmYEkk_u24lambda_u2410 = getTextPaint$ui_text_release();
        $this$paint_RPmYEkk_u24lambda_u2410.m6358setColor8_81llA(color);
    ...
    public void mo5928paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        int currBlendMode = getTextPaint$ui_text_release().getBackingBlendMode();
        AndroidTextPaint $this$paint_LG529CI_u24lambda_u2411 = getTextPaint$ui_text_release();
        $this$paint_LG529CI_u24lambda_u2411.m6358setColor8_81llA(color);
        ...
        $this$paint_LG529CI_u24lambda_u2411.m6355setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m6355setBlendModes9anfk8(currBlendMode);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: paint-hn5TExg, reason: not valid java name */
    public void mo5930painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        int currBlendMode = getTextPaint$ui_text_release().getBackingBlendMode();
        AndroidTextPaint $this$paint_hn5TExg_u24lambda_u2412 = getTextPaint$ui_text_release();
        $this$paint_hn5TExg_u24lambda_u2412.m6356setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), alpha);
        ...
        $this$paint_hn5TExg_u24lambda_u2412.m6355setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m6355setBlendModes9anfk8(currBlendMode);
    }

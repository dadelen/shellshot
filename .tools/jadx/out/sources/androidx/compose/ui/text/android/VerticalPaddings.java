...
public final class VerticalPaddings {
    ...
    public static final /* synthetic */ VerticalPaddings m6139boximpl(long j) {
    ...
    public static boolean m6141equalsimpl(long j, Object obj) {
        return (obj instanceof VerticalPaddings) && j == ((VerticalPaddings) obj).getPackedValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m6142equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m6145hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m6146toStringimpl(long j) {
        return "VerticalPaddings(packedValue=" + j + ')';
    }

    public boolean equals(Object obj) {
        return m6141equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m6145hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m6146toStringimpl(this.packedValue);
    }
    ...
    public static final int m6144getTopPaddingimpl(long arg0) {
        return (int) (arg0 >> 32);
    }

    /* renamed from: getBottomPadding-impl, reason: not valid java name */
    public static final int m6143getBottomPaddingimpl(long arg0) {

...
public final class ContentType {
    ...
    public ContentType(String contentHint) {
        this((Set<String>) SetsKt.setOf(contentHint));
    }
    ...
    public final ContentType plus$ui_release(ContentType other) {
        Set combinedValues = SetsKt.plus((Set) this.contentHints, (Iterable) other.contentHints);
        return new ContentType((Set<String>) combinedValues);
    }
}

...
public final class BasicTooltip_androidKt {
    ...
    */
    public static final void BasicTooltipBox(final androidx.compose.ui.window.PopupPositionProvider r35, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r36, androidx.compose.foundation.BasicTooltipState r37, androidx.compose.ui.Modifier r38, boolean r39, boolean r40, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r41, androidx.compose.runtime.Composer r42, final int r43, final int r44) {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void WrappedAnchor(final boolean r28, final androidx.compose.foundation.BasicTooltipState r29, androidx.compose.ui.Modifier r30, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r31, androidx.compose.runtime.Composer r32, final int r33, final int r34) {
        /*
            Method dump skipped, instructions count: 586
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.BasicTooltip_androidKt.WrappedAnchor(boolean, androidx.compose.foundation.BasicTooltipState, androidx.compose.ui.Modifier, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int, int):void");
    }
                ...
                */
                public final void invoke(androidx.compose.runtime.Composer r27, int r28) {
                    /*
                        ...
                        To view this dump add '--comments-level debug' option
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.BasicTooltip_androidKt$TooltipPopup$2.invoke(androidx.compose.runtime.Composer, int):void");
                }
                ...
                public final void invoke2(SemanticsPropertyReceiver $this$semantics) {
                    ...
                    SemanticsPropertiesKt.onLongClick($this$semantics, str, new Function0<Boolean>() { // from class: androidx.compose.foundation.BasicTooltip_androidKt$anchorSemantics$1.1
                        ...
                        public final Boolean invoke() {
                            BuildersKt__Builders_commonKt.launch$default(CoroutineScope.this, null, null, new C00021(basicTooltipState, null), 3, null);
                            return true;
                        }
                    });
                }

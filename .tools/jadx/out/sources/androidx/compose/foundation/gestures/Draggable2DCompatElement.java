...
public final class Draggable2DCompatElement extends ModifierNodeElement<Draggable2DNode> {
    ...
    public boolean equals(Object other) {
        ...
        if (Intrinsics.areEqual(this.state, ((Draggable2DCompatElement) other).state) && this.enabled == ((Draggable2DCompatElement) other).enabled && Intrinsics.areEqual(this.interactionSource, ((Draggable2DCompatElement) other).interactionSource) && this.startDragImmediately == ((Draggable2DCompatElement) other).startDragImmediately && this.onDragStarted == ((Draggable2DCompatElement) other).onDragStarted && this.onDragStopped == ((Draggable2DCompatElement) other).onDragStopped && this.reverseDirection == ((Draggable2DCompatElement) other).reverseDirection) {
            return true;
        }
        return false;
    }

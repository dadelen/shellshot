...
public final class DraggableKt {
    ...
    public static final DraggableState rememberDraggableState(Function1<? super Float, Unit> function1, Composer $composer, int $changed) {
        ...
        if (it$iv == Composer.INSTANCE.getEmpty()) {
            value$iv = DraggableState(new Function1<Float, Unit>() { // from class: androidx.compose.foundation.gestures.DraggableKt$rememberDraggableState$1$1
        ...
        DraggableState draggableState = (DraggableState) value$iv;
    ...
    public static final float m437toFloat3MmeM6k(long $this$toFloat_u2d3MmeM6k, Orientation orientation) {
        return orientation == Orientation.Vertical ? Offset.m3923getYimpl($this$toFloat_u2d3MmeM6k) : Offset.m3922getXimpl($this$toFloat_u2d3MmeM6k);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toFloat-sF-c-tU, reason: not valid java name */
    public static final float m438toFloatsFctU(long $this$toFloat_u2dsF_u2dc_u2dtU, Orientation orientation) {
        return orientation == Orientation.Vertical ? Velocity.m6864getYimpl($this$toFloat_u2dsF_u2dc_u2dtU) : Velocity.m6863getXimpl($this$toFloat_u2dsF_u2dc_u2dtU);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toValidVelocity-TH1AsA0, reason: not valid java name */
    public static final long m439toValidVelocityTH1AsA0(long $this$toValidVelocity_u2dTH1AsA0) {
        return VelocityKt.Velocity(Float.isNaN(Velocity.m6863getXimpl($this$toValidVelocity_u2dTH1AsA0)) ? 0.0f : Velocity.m6863getXimpl($this$toValidVelocity_u2dTH1AsA0), Float.isNaN(Velocity.m6864getYimpl($this$toValidVelocity_u2dTH1AsA0)) ? 0.0f : Velocity.m6864getYimpl($this$toValidVelocity_u2dTH1AsA0));
    }
}

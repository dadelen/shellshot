...
public final class FinalSnappingItem {
    ...
    private static final int ClosestItem = m509constructorimpl(0);
    private static final int NextItem = m509constructorimpl(1);
    private static final int PreviousItem = m509constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FinalSnappingItem m508boximpl(int i) {
    ...
    public static int m512hashCodeimpl(int i) {

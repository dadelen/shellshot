...
final class AndroidConfig implements ScrollConfig {
    ...
    public long mo385calculateMouseWheelScroll8xgXZGE(Density $this$calculateMouseWheelScroll_u2d8xgXZGE, PointerEvent event, long bounds) {
        List $this$fastFold$iv = event.getChanges();
        Offset m3911boximpl = Offset.m3911boximpl(Offset.INSTANCE.m3938getZeroF1C5BW0());
        Offset offset = m3911boximpl;
        int index$iv$iv = 0;
        ...
        while (index$iv$iv < size) {
            ...
            long acc = offset.getPackedValue();
            offset = Offset.m3911boximpl(Offset.m3927plusMKHz9U(acc, c.getScrollDelta()));
            index$iv$iv++;
            $this$fastFold$iv = $this$fastFold$iv;
            m3911boximpl = m3911boximpl;
        }
        return Offset.m3929timestuRUvjQ(offset.getPackedValue(), -$this$calculateMouseWheelScroll_u2d8xgXZGE.mo364toPx0680j_4(Dp.m6626constructorimpl(64)));
    }
}

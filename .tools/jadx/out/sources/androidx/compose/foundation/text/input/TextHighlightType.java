...
public final class TextHighlightType {
    ...
    private static final int HandwritingSelectPreview = m1104constructorimpl(0);
    private static final int HandwritingDeletePreview = m1104constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TextHighlightType m1103boximpl(int i) {
        return new TextHighlightType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m1104constructorimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object obj) {
        return m1105equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m1107hashCodeimpl(this.value);
    }

    public String toString() {
        return m1108toStringimpl(this.value);
    }

...
final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo58measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        long childConstraints;
        int maxIntrinsicWidth = measurable.maxIntrinsicWidth(Constraints.m6578getMaxHeightimpl(constraints));
        if (maxIntrinsicWidth < Constraints.m6579getMaxWidthimpl(constraints)) {
        ...
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, width, placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                ...
                cursorRect = TextFieldScrollKt.getCursorRectInScroller(measureScope, cursorOffset, transformedText, invoke != null ? invoke.getValue() : null, MeasureScope.this.getLayoutDirection() == LayoutDirection.Rtl, placeable.getWidth());
                ...
                int $i$f$fastRoundToInt = Math.round(offset);
                Placeable.PlacementScope.placeRelative$default($this$layout, placeable2, $i$f$fastRoundToInt, 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
}

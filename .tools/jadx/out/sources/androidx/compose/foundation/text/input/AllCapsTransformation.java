...
final /* data */ class AllCapsTransformation implements InputTransformation {
    private final KeyboardOptions keyboardOptions = new KeyboardOptions(KeyboardCapitalization.INSTANCE.m6301getCharactersIUNYP9k(), (Boolean) null, 0, 0, (PlatformImeOptions) null, (Boolean) null, (LocaleList) null, 126, (DefaultConstructorMarker) null);
    ...
    public void transformInput(TextFieldBuffer $this$transformInput) {
        ...
        for (int i$iv = 0; i$iv < $this$forEachChange$iv.getChangeCount(); i$iv++) {
            long range = $this$forEachChange$iv.mo1096getRangejx7JFs(i$iv);
            $this$forEachChange$iv.mo1095getOriginalRangejx7JFs(i$iv);
            if (!TextRange.m6086getCollapsedimpl(range)) {
                $this$transformInput.replace(TextRange.m6090getMinimpl(range), TextRange.m6089getMaximpl(range), StringKt.toUpperCase(TextRangeKt.m6099substringFDrldGo($this$transformInput.asCharSequence(), range), this.locale));
            }
        }
    }

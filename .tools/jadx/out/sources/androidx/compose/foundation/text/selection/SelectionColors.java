...
public final class SelectionColors {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SelectionColors) && Color.m4164equalsimpl0(this.selectionHandleColor, ((SelectionColors) other).selectionHandleColor) && Color.m4164equalsimpl0(this.selectionBackgroundColor, ((SelectionColors) other).selectionBackgroundColor);
    }

    public int hashCode() {
        int result = Color.m4170hashCodeimpl(this.selectionHandleColor);
        return (result * 31) + Color.m4170hashCodeimpl(this.selectionBackgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + ((Object) Color.m4171toStringimpl(this.selectionHandleColor)) + ", selectionBackgroundColor=" + ((Object) Color.m4171toStringimpl(this.selectionBackgroundColor)) + ')';
    }
}

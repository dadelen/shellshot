...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation initialOrientation, float initial) {
        ...
        this.previousSelection = TextRange.INSTANCE.m6097getZerod9O1mEE();
    ...
    public final void m1074setPreviousSelection5zctL8(long j) {
    ...
    */
    ...
    public final int m1072getOffsetToFollow5zctL8(long selection) {
        return TextRange.m6092getStartimpl(selection) != TextRange.m6092getStartimpl(this.previousSelection) ? TextRange.m6092getStartimpl(selection) : TextRange.m6087getEndimpl(selection) != TextRange.m6087getEndimpl(this.previousSelection) ? TextRange.m6087getEndimpl(selection) : TextRange.m6090getMinimpl(selection);
    }

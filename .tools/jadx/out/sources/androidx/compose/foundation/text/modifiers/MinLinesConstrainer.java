...
public final class MinLinesConstrainer {
    ...
    public static final class Companion {
        ...
        public final MinLinesConstrainer from(MinLinesConstrainer minMaxUtil, LayoutDirection layoutDirection, TextStyle paramStyle, Density density, FontFamily.Resolver fontFamilyResolver) {
            ...
            MinLinesConstrainer it2 = new MinLinesConstrainer(layoutDirection, TextStyleKt.resolveDefaults(paramStyle, layoutDirection), DensityKt.Density(density.getDensity(), density.getFontScale()), fontFamilyResolver, null);
    ...
    public final long m1288coerceMinLinesOh53vG4$foundation_release(long inConstraints, int minLines) {
        String str;
        Paragraph m5974ParagraphUdtVg6A;
        String str2;
        Paragraph m5974ParagraphUdtVg6A2;
        int minHeight;
        ...
        if (Float.isNaN(oneLineHeight) || Float.isNaN(lineHeight)) {
            ...
            m5974ParagraphUdtVg6A = ParagraphKt.m5974ParagraphUdtVg6A(str, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (r22 & 32) != 0 ? CollectionsKt.emptyList() : null, (r22 & 64) != 0 ? CollectionsKt.emptyList() : null, (r22 & 128) != 0 ? Integer.MAX_VALUE : 1, (r22 & 256) != 0 ? false : false);
            oneLineHeight = m5974ParagraphUdtVg6A.getHeight();
            str2 = MinLinesConstrainerKt.TwoLineTextReplacement;
            m5974ParagraphUdtVg6A2 = ParagraphKt.m5974ParagraphUdtVg6A(str2, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (r22 & 32) != 0 ? CollectionsKt.emptyList() : null, (r22 & 64) != 0 ? CollectionsKt.emptyList() : null, (r22 & 128) != 0 ? Integer.MAX_VALUE : 2, (r22 & 256) != 0 ? false : false);
            float twoLineHeight = m5974ParagraphUdtVg6A2.getHeight();
        ...
        if (minLines != 1) {
            ...
            minHeight = RangesKt.coerceAtMost(RangesKt.coerceAtLeast(Math.round($this$fastRoundToInt$iv), 0), Constraints.m6578getMaxHeightimpl(inConstraints));
        } else {
            minHeight = Constraints.m6580getMinHeightimpl(inConstraints);
        }
        return ConstraintsKt.Constraints(Constraints.m6581getMinWidthimpl(inConstraints), Constraints.m6579getMaxWidthimpl(inConstraints), minHeight, Constraints.m6578getMaxHeightimpl(inConstraints));
    }
}

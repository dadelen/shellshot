...
public class StaticTextSelectionParams {
    ...
    public boolean getShouldClip() {
        ...
        return (it == null || TextOverflow.m6535equalsimpl0(it.getLayoutInput().getOverflow(), TextOverflow.INSTANCE.m6544getVisiblegIe3tQ8()) || !it.getHasVisualOverflow()) ? false : true;
    }

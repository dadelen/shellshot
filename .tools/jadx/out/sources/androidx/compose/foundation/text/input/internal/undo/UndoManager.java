...
public final class UndoManager<T> {
    ...
    public UndoManager(List<? extends T> list, List<? extends T> list2, int capacity) {
        ...
        if (getSize() <= this.capacity) {
            ...
            throw new IllegalArgumentException(("Initial list of undo and redo operations have a size=(" + getSize() + ") greater than the given capacity=(" + this.capacity + ").").toString());
        }
    }

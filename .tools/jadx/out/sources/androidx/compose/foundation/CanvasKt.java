...
public final class CanvasKt {
    public static final void Canvas(final Modifier modifier, final Function1<? super DrawScope, Unit> function1, Composer $composer, final int $changed) {
        ...
        if (($dirty & 19) == 18 && $composer2.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-932836462, $dirty, -1, "androidx.compose.foundation.Canvas (Canvas.kt:42)");
            }
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.CanvasKt$Canvas$1
                ...
                public final void invoke(Composer composer, int i) {
                    CanvasKt.Canvas(Modifier.this, function1, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
    ...
    public static final void Canvas(final Modifier modifier, final String contentDescription, final Function1<? super DrawScope, Unit> function1, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(Canvas)P(1)63@3176L48,63@3131L94:Canvas.kt#71ulvw");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
            $dirty |= $composer2.changed(modifier) ? 4 : 2;
        }
        ...
        if (($dirty & 147) == 146 && $composer2.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 1782764706, "CC(remember):Canvas.kt#9igjgp");
            boolean invalid$iv = ($dirty & 112) == 32;
            Object it$iv = $composer2.rememberedValue();
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.CanvasKt$Canvas$2$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
            ...
            SpacerKt.Spacer(SemanticsModifierKt.semantics$default(drawBehind, false, (Function1) value$iv, 1, null), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.CanvasKt$Canvas$3
                ...
                public final void invoke(Composer composer, int i) {
                    CanvasKt.Canvas(Modifier.this, contentDescription, function1, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }

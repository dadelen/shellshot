...
final class GridSlotCache implements LazyGridSlotsProvider {
    ...
    public LazyGridSlots mo799invoke0kLqBqw(Density density, long constraints) {
        ...
        LazyGridSlots invoke = this.calculation.invoke(density, Constraints.m6567boximpl(constraints));

...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo32measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        int width = Constraints.m6577getHasFixedWidthimpl(constraints) ? Constraints.m6579getMaxWidthimpl(constraints) : 0;
        int height = Constraints.m6576getHasFixedHeightimpl(constraints) ? Constraints.m6578getMaxHeightimpl(constraints) : 0;
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1

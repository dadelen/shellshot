...
public final class DragInteractionKt {
    public static final State<Boolean> collectIsDraggedAsState(InteractionSource $this$collectIsDraggedAsState, Composer $composer, int $changed) {
        Object value$iv;
        DragInteractionKt$collectIsDraggedAsState$1$1 value$iv2;
        ...
        MutableState isDragged = (MutableState) value$iv;
        ...
        if (invalid$iv || it$iv2 == Composer.INSTANCE.getEmpty()) {
            value$iv2 = new DragInteractionKt$collectIsDraggedAsState$1$1($this$collectIsDraggedAsState, isDragged, null);
            $composer.updateRememberedValue(value$iv2);
        } else {
            value$iv2 = it$iv2;
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        EffectsKt.LaunchedEffect($this$collectIsDraggedAsState, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) value$iv2, $composer, $changed & 14);
        if (ComposerKt.isTraceInProgress()) {

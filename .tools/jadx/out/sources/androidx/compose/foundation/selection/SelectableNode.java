...
final class SelectableNode extends ClickableNode {
    ...
    private SelectableNode(boolean selected, MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean enabled, Role role, Function0<Unit> function0) {
        super(interactionSource, indicationNodeFactory, enabled, null, role, function0, null);
        this.selected = selected;
    }

    /* renamed from: update-QzZPfjk, reason: not valid java name */
    public final void m927updateQzZPfjk(boolean selected, MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean enabled, Role role, Function0<Unit> onClick) {

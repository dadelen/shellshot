...
final class SelectableElement extends ModifierNodeElement<SelectableNode> {
    ...
    private SelectableElement(boolean selected, MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean enabled, Role role, Function0<Unit> function0) {
    ...
    public void update(SelectableNode node) {
        node.m927updateQzZPfjk(this.selected, this.interactionSource, this.indicationNodeFactory, this.enabled, this.role, this.onClick);
    }

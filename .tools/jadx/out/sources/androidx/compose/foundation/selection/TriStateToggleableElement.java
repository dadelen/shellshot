...
final class TriStateToggleableElement extends ModifierNodeElement<TriStateToggleableNode> {
    ...
    private TriStateToggleableElement(ToggleableState state, MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean enabled, Role role, Function0<Unit> function0) {
        this.state = state;
    ...
    public void update(TriStateToggleableNode node) {
        node.m937updateQzZPfjk(this.state, this.interactionSource, this.indicationNodeFactory, this.enabled, this.role, this.onClick);
    }
    ...
    public int hashCode() {
        ...
        int result4 = (((result3 + (indicationNodeFactory != null ? indicationNodeFactory.hashCode() : 0)) * 31) + Boolean.hashCode(this.enabled)) * 31;
        Role role = this.role;
        return ((result4 + (role != null ? Role.m5899hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode();
    }
}

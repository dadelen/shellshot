        ...
        while (true) {
            ...
            while (i16 < min) {
                ...
                while (i18 < min) {
                    ...
                    double distance = pointProviderLab.distance(dArr4[i16], dArr4[i18]);
            ...
            while (i22 < i2) {
                ...
                double distance2 = pointProviderLab.distance(dArr7, dArr8);
                double d = distance2;
                int i24 = i21;
                int i25 = -1;
                int i26 = i22;
                ...
                while (i27 < min) {
                    ...
                    int i29 = i23;
                    double[] dArr9 = dArr8;
                    if (distanceArr[i23][i28].distance < 4.0d * distance2) {
                        double distance3 = pointProviderLab.distance(dArr7, dArr4[i28]);
                        if (distance3 < d) {
                            d = distance3;
                            i25 = i28;
                        }
                ...
                if (i25 == -1 || Math.abs(Math.sqrt(d) - Math.sqrt(distance2)) <= 3.0d) {
                    i21 = i24;
                } else {
                    iArr6[i26] = i25;
                    i21 = i24 + 1;

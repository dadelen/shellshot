        ...
        switch (this.label) {
            case 0:
                ...
                if (!sourceFile.exists() || !sourceFile.delete()) {
                    m7212constructorimpl = Result.m7212constructorimpl(Unit.INSTANCE);
                    ...
                    if (m7215exceptionOrNullimpl != null) {
                        ...
                        shellLogger2.e(OutputRepository.TAG, "文件系统删除原图失败 path=" + screenshotCandidate.getAbsolutePath(), m7215exceptionOrNullimpl);
                    }
                    ...
                    if (uri != null) {
                        ...
                        try {
                            ...
                            m7212constructorimpl2 = Result.m7212constructorimpl(Boxing.boxInt(contentResolver.delete(uri, null, null)));
                        } catch (Throwable th2) {
                            Result.Companion companion4 = Result.INSTANCE;
                            m7212constructorimpl2 = Result.m7212constructorimpl(ResultKt.createFailure(th2));
                        }
                        Throwable m7215exceptionOrNullimpl2 = Result.m7215exceptionOrNullimpl(m7212constructorimpl2);
                        if (m7215exceptionOrNullimpl2 != null) {
                            shellLogger = outputRepository3.logger;
                            shellLogger.e(OutputRepository.TAG, "MediaStore 删除原图失败 uri=" + uri, m7215exceptionOrNullimpl2);
                        }
                        Integer boxInt = Boxing.boxInt(0);
                        if (Result.m7218isFailureimpl(m7212constructorimpl2)) {
                            m7212constructorimpl2 = boxInt;
                        }
                        if (((Number) m7212constructorimpl2).intValue() > 0) {

...
@DebugMetadata(c = "com.example.shellshot.ui.screen.LogScreenKt$ZipLogAppendReveal$1$1", f = "LogScreen.kt", i = {}, l = {163}, m = "invokeSuspend", n = {}, s = {})
...
final class LogScreenKt$ZipLogAppendReveal$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        boolean ZipLogAppendReveal$lambda$20;
        boolean ZipLogAppendReveal$lambda$23;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (this.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                if (this.$shouldAnimate) {
                    ZipLogAppendReveal$lambda$23 = LogScreenKt.ZipLogAppendReveal$lambda$23(this.$animationHandled$delegate);
                    if (!ZipLogAppendReveal$lambda$23) {
                        this.label = 1;
                        ...
                        LogScreenKt.ZipLogAppendReveal$lambda$21(this.$entered$delegate, true);
                        LogScreenKt.ZipLogAppendReveal$lambda$24(this.$animationHandled$delegate, true);
                        this.$onAnimationHandled.invoke();
                        return Unit.INSTANCE;
                    }
                }
                ZipLogAppendReveal$lambda$20 = LogScreenKt.ZipLogAppendReveal$lambda$20(this.$entered$delegate);
                if (!ZipLogAppendReveal$lambda$20) {
                    LogScreenKt.ZipLogAppendReveal$lambda$21(this.$entered$delegate, true);
                }
                return Unit.INSTANCE;
            case 1:

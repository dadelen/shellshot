...
public final class GlassComponentsKt {
    ...
    public static final void SectionLabel(final String text, Modifier modifier, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 19) == 18 && $composer3.getSkipping()) {
            ...
            $composer2 = $composer3;
            int $dirty2 = $dirty;
            long m7071getTextSecondary0d7_KjU = colors.m7071getTextSecondary0d7_KjU();
            ...
            modifier4 = modifier3;
            TextKt.m2697Text4IGK_g(text, modifier4, m7071getTextSecondary0d7_KjU, 0L, (FontStyle) null, semiBold, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, labelLarge, $composer2, i3, 0, 65496);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }

...
public final class HomeScreenKt {
    ...
    public static final void HomeScreen(Modifier modifier, final MainUiState uiState, final boolean darkTheme, final Function0<Unit> onToggleDarkTheme, final Function1<? super Boolean, Unit> onToggleMonitoring, final Function1<? super String, Unit> onSelectTemplate, Composer $composer, final int $changed, final int i) {
        ...
        if (($changed & 48) == 0) {
            $dirty |= ($changed & 64) == 0 ? $composer4.changed(uiState) : $composer4.changedInstance(uiState) ? 32 : 16;
        }
        if (($changed & 384) == 0) {
        ...
        if ((74899 & $dirty) == 74898 && $composer4.getSkipping()) {
            ...
            insetColor = Color.m4161copywmQWz5c(r22, (r12 & 1) != 0 ? Color.m4165getAlphaimpl(r22) : darkTheme ? 0.06f : 0.4f, (r12 & 2) != 0 ? Color.m4169getRedimpl(r22) : 0.0f, (r12 & 4) != 0 ? Color.m4168getGreenimpl(r22) : 0.0f, (r12 & 8) != 0 ? Color.m4166getBlueimpl(Color.INSTANCE.m4200getWhite0d7_KjU()) : 0.0f);
            insetBorder = Color.m4161copywmQWz5c(r24, (r12 & 1) != 0 ? Color.m4165getAlphaimpl(r24) : darkTheme ? 0.06f : 0.6f, (r12 & 2) != 0 ? Color.m4169getRedimpl(r24) : 0.0f, (r12 & 4) != 0 ? Color.m4168getGreenimpl(r24) : 0.0f, (r12 & 8) != 0 ? Color.m4166getBlueimpl(Color.INSTANCE.m4200getWhite0d7_KjU()) : 0.0f);
            ...
            boolean changed = $composer4.changed(titleColor) | (($dirty & 896) == 256) | (($dirty & 7168) == 2048) | $composer4.changed(statusDot) | $composer4.changed(statusTitle) | $composer4.changed(monitoringEnabled) | ((57344 & $dirty) == 16384) | (($dirty & 112) == 32 || (($dirty & 64) != 0 && $composer4.changedInstance(uiState))) | $composer4.changed(secondaryTextColor) | $composer4.changed(insetColor) | $composer4.changed(insetBorder) | $composer4.changed(selectedTemplate) | ((458752 & $dirty) == 131072);

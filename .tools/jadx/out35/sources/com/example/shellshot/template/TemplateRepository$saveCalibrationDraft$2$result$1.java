        ...
        switch (this.label) {
            case 0:
                ...
                try {
                    ...
                    m7212constructorimpl = Result.m7212constructorimpl(new TemplateCalibrationResult(persistDraft.getSuccess(), persistDraft.getTemplateId(), persistDraft.getMessage()));
                } catch (Throwable th) {
                ...
                if (m7215exceptionOrNullimpl != null) {
                    ...
                    shellLogger.e(TemplateRepository.TAG, "保存模板失败", m7215exceptionOrNullimpl);

...
public class ConstraintSet {
    ...
    public void clone(ConstraintSet set) {
        ...
        for (Integer key : set.mConstraints.keySet()) {
            this.mConstraints.put(key, set.mConstraints.get(key).m6887clone());
        }
    }
    ...
    public void center(int centerID, int firstID, int firstSide, int firstMargin, int secondId, int secondSide, int secondMargin, float bias) {
        ...
        if (firstSide == 1) {
            ...
            secondMargin2 = secondMargin;
            firstID3 = centerID;
            secondMargin3 = secondId;
        } else {
            if (firstSide != 2) {
                if (firstSide == 6) {
                    firstID4 = firstID;
                    ...
                    secondMargin4 = secondMargin;
                    firstID5 = centerID;
                    secondMargin5 = secondId;
                } else {
                    if (firstSide != 7) {
        ...
        Constraint constraint3 = this.mConstraints.get(Integer.valueOf(firstID3));

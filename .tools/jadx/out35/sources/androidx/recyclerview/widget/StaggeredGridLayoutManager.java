...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (true) {
            ...
            int span3 = staggeredGridLayoutManager3.mLazySpanLookup.getSpan(viewLayoutPosition);
            boolean z3 = span3 == -1 ? r9 : r8;
            if (z3) {
                ...
                span = staggeredGridLayoutManager3.mSpans[span3];
            }
            ...
            if (layoutState.mLayoutDirection == r9) {
                decoratedMeasurement = layoutParams.mFullSpan ? staggeredGridLayoutManager3.getMaxEnd(i5) : span.getEndLine(i5);
                ...
                minStart = layoutParams.mFullSpan ? staggeredGridLayoutManager3.getMinStart(i5) : span.getStartLine(i5);
                ...
                if (z3 && layoutParams.mFullSpan) {
                    ...
                    createFullSpanItemFromStart.mGapDir = r9;
            ...
            if (staggeredGridLayoutManager3.isLayoutRTL() && staggeredGridLayoutManager3.mOrientation == r9) {
                ...
                decoratedMeasurement2 = z4 ? orientationHelper2.getEndAfterPadding() : orientationHelper2.getEndAfterPadding() - (((staggeredGridLayoutManager3.mSpanCount - r9) - span.mIndex) * staggeredGridLayoutManager3.mSizePerSpan);
                startAfterPadding2 = decoratedMeasurement2 - staggeredGridLayoutManager3.mSecondaryOrientation.getDecoratedMeasurement(next);
            } else {
                startAfterPadding2 = layoutParams.mFullSpan ? staggeredGridLayoutManager3.mSecondaryOrientation.getStartAfterPadding() : (span.mIndex * staggeredGridLayoutManager3.mSizePerSpan) + staggeredGridLayoutManager3.mSecondaryOrientation.getStartAfterPadding();
            ...
            if (z5) {
                ...
                staggeredGridLayoutManager.updateRemainingSpans(span2, layoutState2.mLayoutDirection, i);
            }
        ...
        int i9 = staggeredGridLayoutManager3.mLayoutState.mLayoutDirection;
        OrientationHelper orientationHelper3 = staggeredGridLayoutManager3.mPrimaryOrientation;
        if (i9 == -1) {
            maxEnd = staggeredGridLayoutManager3.mPrimaryOrientation.getStartAfterPadding() - staggeredGridLayoutManager3.getMinStart(orientationHelper3.getStartAfterPadding());
        } else {
            maxEnd = staggeredGridLayoutManager3.getMaxEnd(orientationHelper3.getEndAfterPadding()) - staggeredGridLayoutManager3.mPrimaryOrientation.getEndAfterPadding();
        }
        ...
        if (preferLastSpan(layoutDir)) {
            for (int i3 = this.mSpanCount - 1; i3 >= 0; i3--) {
                if (i3 != prevFocusSpan.mIndex) {
                    Span[] spanArr = this.mSpans;
                    if (shouldSearchFromStart) {
                        findLastPartiallyVisibleItemPosition2 = spanArr[i3].findFirstPartiallyVisibleItemPosition();
                    } else {
                        findLastPartiallyVisibleItemPosition2 = spanArr[i3].findLastPartiallyVisibleItemPosition();
                    }
            ...
            for (int i4 = 0; i4 < this.mSpanCount; i4++) {
                ...
                if (shouldSearchFromStart) {
                    findLastPartiallyVisibleItemPosition = spanArr2[i4].findFirstPartiallyVisibleItemPosition();
                } else {
                    findLastPartiallyVisibleItemPosition = spanArr2[i4].findLastPartiallyVisibleItemPosition();
                }

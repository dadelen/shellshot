    ...
    public static final Modifier progressSemantics(Modifier $this$progressSemantics, final float value, final ClosedFloatingPointRange<Float> closedFloatingPointRange, final int steps) {
        return SemanticsModifierKt.semantics($this$progressSemantics, true, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.ProgressSemanticsKt$progressSemantics$1
            ...
            public final void invoke2(SemanticsPropertyReceiver $this$semantics) {
                SemanticsPropertiesKt.setProgressBarRangeInfo($this$semantics, new ProgressBarRangeInfo(((Number) RangesKt.coerceIn(Float.valueOf(value), closedFloatingPointRange)).floatValue(), closedFloatingPointRange, steps));
            }
        });
    }

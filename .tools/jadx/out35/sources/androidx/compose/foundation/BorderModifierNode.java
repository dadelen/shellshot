...
public final class BorderModifierNode extends DelegatingNode {
    ...
    private BorderModifierNode(float widthParameter, Brush brushParameter, Shape shapeParameter) {
        ...
        this.drawWithCacheModifierNode = (CacheDrawModifierNode) delegate(DrawModifierKt.CacheDrawModifierNode(new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.BorderModifierNode$drawWithCacheModifierNode$1
            ...
            public final DrawResult invoke(CacheDrawScope $this$CacheDrawModifierNode) {
                ...
                boolean hasValidBorderParams = $this$CacheDrawModifierNode.mo364toPx0680j_4(BorderModifierNode.this.getWidth()) >= 0.0f && Size.m3990getMinDimensionimpl($this$CacheDrawModifierNode.m3812getSizeNHjbRc()) > 0.0f;
                if (!hasValidBorderParams) {
                    drawContentWithoutBorder = BorderKt.drawContentWithoutBorder($this$CacheDrawModifierNode);
                    return drawContentWithoutBorder;
                }
                float strokeWidthPx = Math.min(Dp.m6631equalsimpl0(BorderModifierNode.this.getWidth(), Dp.INSTANCE.m6644getHairlineD9Ej5fM()) ? 1.0f : (float) Math.ceil($this$CacheDrawModifierNode.mo364toPx0680j_4(BorderModifierNode.this.getWidth())), (float) Math.ceil(Size.m3990getMinDimensionimpl($this$CacheDrawModifierNode.m3812getSizeNHjbRc()) / 2.0f));
                float halfStroke = strokeWidthPx / 2.0f;
                long topLeft = OffsetKt.Offset(halfStroke, halfStroke);
                long borderSize = SizeKt.Size(Size.m3991getWidthimpl($this$CacheDrawModifierNode.m3812getSizeNHjbRc()) - strokeWidthPx, Size.m3988getHeightimpl($this$CacheDrawModifierNode.m3812getSizeNHjbRc()) - strokeWidthPx);
                boolean fillArea = 2.0f * strokeWidthPx > Size.m3990getMinDimensionimpl($this$CacheDrawModifierNode.m3812getSizeNHjbRc());
                Outline outline = BorderModifierNode.this.getShape().mo275createOutlinePq9zytI($this$CacheDrawModifierNode.m3812getSizeNHjbRc(), $this$CacheDrawModifierNode.getLayoutDirection(), $this$CacheDrawModifierNode);
                ...
                if (outline instanceof Outline.Rounded) {
                    m244drawRoundRectBorderJqoCqck = BorderModifierNode.this.m244drawRoundRectBorderJqoCqck($this$CacheDrawModifierNode, BorderModifierNode.this.getBrush(), (Outline.Rounded) outline, topLeft, borderSize, fillArea, strokeWidthPx);
                    return m244drawRoundRectBorderJqoCqck;
                }
                if (outline instanceof Outline.Rectangle) {
                    m241drawRectBorderNsqcLGU = BorderKt.m241drawRectBorderNsqcLGU($this$CacheDrawModifierNode, BorderModifierNode.this.getBrush(), topLeft, borderSize, fillArea, strokeWidthPx);
    ...
    public final void m246setWidth0680j_4(float value) {
        if (!Dp.m6631equalsimpl0(this.width, value)) {
            this.width = value;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:22:0x00ef, code lost:
        ...
        if (androidx.compose.ui.graphics.ImageBitmapConfig.m4377equalsimpl(r15, r0 != null ? androidx.compose.ui.graphics.ImageBitmapConfig.m4375boximpl(r0.mo4030getConfig_sVssgQ()) : null) != false) goto L25;
     */
    ...
    */
    ...
    public final DrawResult m244drawRoundRectBorderJqoCqck(CacheDrawScope $this$drawRoundRectBorder_u2dJqoCqck, final Brush brush, Outline.Rounded outline, final long topLeft, final long borderSize, final boolean fillArea, final float strokeWidth) {
        ...
        if (!RoundRectKt.isSimple(outline.getRoundRect())) {
            ...
            return $this$drawRoundRectBorder_u2dJqoCqck.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderModifierNode$drawRoundRectBorder$2
                ...
                public final void invoke2(ContentDrawScope $this$onDrawWithContent) {
                    ...
                    DrawScope.m4702drawPathGBMwjPU$default($this$onDrawWithContent, Path.this, brush, 0.0f, null, null, 0, 60, null);
                }
            });
        }
        final long cornerRadius = outline.getRoundRect().m3972getTopLeftCornerRadiuskKHJgLs();
        ...
        return $this$drawRoundRectBorder_u2dJqoCqck.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderModifierNode$drawRoundRectBorder$1
            ...
            public final void invoke2(ContentDrawScope $this$onDrawWithContent) {
                ...
                $this$onDrawWithContent.drawContent();
                if (fillArea) {
                    DrawScope.m4708drawRoundRectZuiqVtQ$default($this$onDrawWithContent, brush, 0L, 0L, cornerRadius, 0.0f, null, null, 0, 246, null);
                    return;
                }
                if (CornerRadius.m3897getXimpl(cornerRadius) < halfStroke) {
                    ContentDrawScope $this$clipRect_u2drOu3jXo$iv = $this$onDrawWithContent;
                    float left$iv = strokeWidth;
                    float top$iv = strokeWidth;
                    float right$iv = Size.m3991getWidthimpl($this$onDrawWithContent.mo4713getSizeNHjbRc()) - strokeWidth;
                    float bottom$iv = Size.m3988getHeightimpl($this$onDrawWithContent.mo4713getSizeNHjbRc()) - strokeWidth;
                    ...
                    long previousSize$iv$iv2 = $this$withTransform_u24lambda_u246$iv$iv.mo4634getSizeNHjbRc();
                    $this$withTransform_u24lambda_u246$iv$iv.getCanvas().save();
                    try {
                        DrawTransform $this$clipRect_rOu3jXo_u24lambda_u244$iv = $this$withTransform_u24lambda_u246$iv$iv.getTransform();
                        $this$clipRect_rOu3jXo_u24lambda_u244$iv.mo4637clipRectN_I0leg(left$iv, top$iv, right$iv, bottom$iv, clipOp$iv);
                    ...
                    try {
                        DrawScope.m4708drawRoundRectZuiqVtQ$default($this$clipRect_u2drOu3jXo$iv, brush2, 0L, 0L, j, 0.0f, null, null, 0, 246, null);
                ...
                long j2 = topLeft;
                long j3 = borderSize;
                m242shrinkKibmq7A = BorderKt.m242shrinkKibmq7A(cornerRadius, halfStroke);
                DrawScope.m4708drawRoundRectZuiqVtQ$default($this$onDrawWithContent, brush3, j2, j3, m242shrinkKibmq7A, 0.0f, borderStroke, null, 0, 208, null);
            }
        });
    }
}

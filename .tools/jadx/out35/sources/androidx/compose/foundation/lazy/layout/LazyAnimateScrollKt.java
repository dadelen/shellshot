...
public final class LazyAnimateScrollKt {
    ...
    private static final float TargetDistance = Dp.m6626constructorimpl(2500);
    private static final float BoundDistance = Dp.m6626constructorimpl(1500);
    private static final float MinimumDistance = Dp.m6626constructorimpl(50);
    ...
    public static final Object animateScrollToItem(LazyLayoutAnimateScrollScope $this$animateScrollToItem, int index, int scrollOffset, int numOfItemsForTeleport, Density density, Continuation<? super Unit> continuation) {
        Object scroll = $this$animateScrollToItem.scroll(new LazyAnimateScrollKt$animateScrollToItem$2(index, density, $this$animateScrollToItem, scrollOffset, numOfItemsForTeleport, null), continuation);

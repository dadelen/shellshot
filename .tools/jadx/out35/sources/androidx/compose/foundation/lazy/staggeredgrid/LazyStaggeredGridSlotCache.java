...
final class LazyStaggeredGridSlotCache implements LazyGridStaggeredGridSlotsProvider {
    ...
    public LazyStaggeredGridSlots mo866invoke0kLqBqw(Density density, long constraints) {
        if (this.cachedSizes != null && Constraints.m6572equalsimpl0(this.cachedConstraints, constraints)) {
        ...
        LazyStaggeredGridSlots invoke = this.calculation.invoke(density, Constraints.m6567boximpl(constraints));

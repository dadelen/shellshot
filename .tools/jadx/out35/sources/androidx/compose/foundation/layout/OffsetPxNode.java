    ...
    public MeasureResult mo84measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetPxNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                long offsetValue = OffsetPxNode.this.getOffset().invoke($this$measure_u2d3p2s80s).getPackedValue();
                boolean rtlAware = OffsetPxNode.this.getRtlAware();
                Placeable placeable2 = placeable;
                if (rtlAware) {
                    Placeable.PlacementScope.placeRelativeWithLayer$default($this$layout, placeable2, IntOffset.m6754getXimpl(offsetValue), IntOffset.m6755getYimpl(offsetValue), 0.0f, (Function1) null, 12, (Object) null);
                } else {
                    Placeable.PlacementScope.placeWithLayer$default($this$layout, placeable2, IntOffset.m6754getXimpl(offsetValue), IntOffset.m6755getYimpl(offsetValue), 0.0f, (Function1) null, 12, (Object) null);
                }
            }
        }, 4, null);
    }

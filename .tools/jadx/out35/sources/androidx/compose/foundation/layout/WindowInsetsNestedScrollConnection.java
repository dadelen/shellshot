...
final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public long mo748onPreScrollOzD1aCk(long available, int source) {
        return m746scroll8S9VItk(available, this.sideCalculator.hideMotion(Offset.m3922getXimpl(available), Offset.m3923getYimpl(available)));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostScroll-DzOQY0M */
    public long mo474onPostScrollDzOQY0M(long consumed, long available, int source) {
        return m746scroll8S9VItk(available, this.sideCalculator.showMotion(Offset.m3922getXimpl(available), Offset.m3923getYimpl(available)));
    }

    /* renamed from: scroll-8S9VItk, reason: not valid java name */
    private final long m746scroll8S9VItk(long available, float scrollAmount) {
        ...
        if (!(scrollAmount == 0.0f)) {
            if (this.windowInsets.isVisible() != (scrollAmount > 0.0f) || animationController != null) {
                if (animationController == null) {
                    ...
                    requestAnimationController();
                    return this.sideCalculator.mo698consumedOffsetsMKHz9U(available);
                }
    ...
    public Object mo747onPreFlingQWom1Mo(long available, Continuation<? super Velocity> continuation) {
        return m745flinghuYlsQE(available, this.sideCalculator.hideMotion(Velocity.m6863getXimpl(available), Velocity.m6864getYimpl(available)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo473onPostFlingRZ2iAVY(long consumed, long available, Continuation<? super Velocity> continuation) {
        return m745flinghuYlsQE(available, this.sideCalculator.showMotion(Velocity.m6863getXimpl(available), Velocity.m6864getYimpl(available)), true, continuation);
    }
    ...
    */
    public final java.lang.Object m745flinghuYlsQE(long r23, float r25, boolean r26, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r27) {
        /*
            Method dump skipped, instructions count: 424
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.layout.WindowInsetsNestedScrollConnection.m745flinghuYlsQE(long, float, boolean, kotlin.coroutines.Continuation):java.lang.Object");
    }

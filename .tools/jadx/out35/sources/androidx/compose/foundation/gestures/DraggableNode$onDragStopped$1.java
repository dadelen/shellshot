...
final class DraggableNode$onDragStopped$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        Function3 function3;
        long m443reverseIfNeededAH228Gc;
        Orientation orientation;
        float m438toFloatsFctU;
        ...
        switch (this.label) {
            case 0:
                ...
                m443reverseIfNeededAH228Gc = this.this$0.m443reverseIfNeededAH228Gc(this.$velocity);
                orientation = this.this$0.orientation;
                m438toFloatsFctU = DraggableKt.m438toFloatsFctU(m443reverseIfNeededAH228Gc, orientation);
                Float boxFloat = Boxing.boxFloat(m438toFloatsFctU);
                this.label = 1;

...
public final class FocusInteractionKt {
    public static final State<Boolean> collectIsFocusedAsState(InteractionSource $this$collectIsFocusedAsState, Composer $composer, int $changed) {
        Object value$iv;
        FocusInteractionKt$collectIsFocusedAsState$1$1 value$iv2;
        ...
        MutableState isFocused = (MutableState) value$iv;
        ...
        if (invalid$iv || it$iv2 == Composer.INSTANCE.getEmpty()) {
            value$iv2 = new FocusInteractionKt$collectIsFocusedAsState$1$1($this$collectIsFocusedAsState, isFocused, null);
            $composer.updateRememberedValue(value$iv2);
        } else {
            value$iv2 = it$iv2;
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        EffectsKt.LaunchedEffect($this$collectIsFocusedAsState, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) value$iv2, $composer, $changed & 14);
        if (ComposerKt.isTraceInProgress()) {

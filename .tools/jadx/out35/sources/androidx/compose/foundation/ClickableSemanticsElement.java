...
final class ClickableSemanticsElement extends ModifierNodeElement<ClickableSemanticsNode> {
    ...
    private ClickableSemanticsElement(boolean enabled, Role role, String onLongClickLabel, Function0<Unit> function0, String onClickLabel, Function0<Unit> function02) {
    ...
    public void update(ClickableSemanticsNode node) {
        node.m271updateUMe6uN4(this.enabled, this.onClickLabel, this.role, this.onClick, this.onLongClickLabel, this.onLongClick);
    }

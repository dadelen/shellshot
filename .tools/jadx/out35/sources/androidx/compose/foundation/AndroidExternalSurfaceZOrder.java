...
public final class AndroidExternalSurfaceZOrder {
    ...
    private static final int Behind = m215constructorimpl(0);
    private static final int MediaOverlay = m215constructorimpl(1);
    private static final int OnTop = m215constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ AndroidExternalSurfaceZOrder m214boximpl(int i) {
    ...
    public static boolean m216equalsimpl(int i, Object obj) {
        return (obj instanceof AndroidExternalSurfaceZOrder) && i == ((AndroidExternalSurfaceZOrder) obj).m220unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m216equalsimpl(this.zOrder, obj);
    }

    public int hashCode() {
        return m218hashCodeimpl(this.zOrder);
    }

    public String toString() {
        return m219toStringimpl(this.zOrder);
    }

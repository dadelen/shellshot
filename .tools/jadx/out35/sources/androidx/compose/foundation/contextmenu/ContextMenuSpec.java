...
public final class ContextMenuSpec {
    ...
    private static final float ContainerWidthMin = Dp.m6626constructorimpl(112);
    private static final float ContainerWidthMax = Dp.m6626constructorimpl(280);
    private static final float ListItemHeight = Dp.m6626constructorimpl(48);
    private static final float MenuContainerElevation = Dp.m6626constructorimpl(3);
    private static final float CornerRadius = Dp.m6626constructorimpl(4);
    private static final Alignment.Vertical LabelVerticalTextAlignment = Alignment.INSTANCE.getCenterVertically();
    private static final int LabelHorizontalTextAlignment = TextAlign.INSTANCE.m6498getStarte0LSkKk();
    private static final float HorizontalPadding = Dp.m6626constructorimpl(12);
    private static final float VerticalPadding = Dp.m6626constructorimpl(8);
    private static final float IconSize = Dp.m6626constructorimpl(24);
    ...
    public final int m343getLabelHorizontalTextAlignmente0LSkKk() {
        return LabelHorizontalTextAlignment;
    }

    /* renamed from: getHorizontalPadding-D9Ej5fM, reason: not valid java name */
    public final float m341getHorizontalPaddingD9Ej5fM() {
        return HorizontalPadding;
    }

    /* renamed from: getVerticalPadding-D9Ej5fM, reason: not valid java name */
    public final float m348getVerticalPaddingD9Ej5fM() {
        return VerticalPadding;
    }

    /* renamed from: getIconSize-D9Ej5fM, reason: not valid java name */
    public final float m342getIconSizeD9Ej5fM() {
        return IconSize;
    }

    /* renamed from: getFontSize-XSAIIZE, reason: not valid java name */
    public final long m340getFontSizeXSAIIZE() {
        return FontSize;
    }
    ...
    public final long m344getLetterSpacingXSAIIZE() {
        return LetterSpacing;
    }

    /* renamed from: textStyle-8_81llA, reason: not valid java name */
    public final TextStyle m349textStyle8_81llA(long color) {

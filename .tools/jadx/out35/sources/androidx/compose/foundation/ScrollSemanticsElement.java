...
final /* data */ class ScrollSemanticsElement extends ModifierNodeElement<ScrollSemanticsModifierNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((this.state.hashCode() * 31) + Boolean.hashCode(this.reverseScrolling)) * 31) + (this.flingBehavior == null ? 0 : this.flingBehavior.hashCode())) * 31) + Boolean.hashCode(this.isScrollable)) * 31) + Boolean.hashCode(this.isVertical);
    }
    ...
    public ScrollSemanticsElement(ScrollState state, boolean reverseScrolling, FlingBehavior flingBehavior, boolean isScrollable, boolean isVertical) {
        this.state = state;

...
public final class TextFieldPreparedSelection extends BaseTextPreparedSelection<TextFieldPreparedSelection> {
    ...
    public final TextFieldValue getValue() {
        return TextFieldValue.m6333copy3r_uNRQ$default(this.currentValue, getAnnotatedString(), getSelection(), (TextRange) null, 4, (Object) null);
    }
    ...
    public final List<EditCommand> deleteIfSelectedOr(Function1<? super TextFieldPreparedSelection, ? extends EditCommand> or) {
        ...
        return CollectionsKt.listOf((Object[]) new EditCommand[]{new CommitTextCommand("", 0), new SetSelectionCommand(TextRange.m6090getMinimpl(getSelection()), TextRange.m6090getMinimpl(getSelection()))});
    }
    ...
    */
    private final int jumpByPagesOffset(androidx.compose.foundation.text.TextLayoutResultProxy r10, int r11) {
        ...
        L1c:
            androidx.compose.ui.text.input.OffsetMapping r0 = r9.getOffsetMapping()
            androidx.compose.ui.text.input.TextFieldValue r1 = r9.currentValue
            long r1 = r1.getSelection()
            int r1 = androidx.compose.ui.text.TextRange.m6087getEndimpl(r1)
            int r0 = r0.originalToTransformed(r1)
            androidx.compose.ui.text.TextLayoutResult r1 = r10.getValue()
            androidx.compose.ui.geometry.Rect r1 = r1.getCursorRect(r0)
            float r2 = r1.getLeft()
            float r4 = r1.getTop()
            long r5 = r3.m3955getSizeNHjbRc()
            float r5 = androidx.compose.ui.geometry.Size.m3988getHeightimpl(r5)
            float r6 = (float) r11
            float r5 = r5 * r6
            float r4 = r4 + r5
            ...
            long r7 = androidx.compose.ui.geometry.OffsetKt.Offset(r2, r4)
            int r6 = r6.m6064getOffsetForPositionk4lQ0M(r7)

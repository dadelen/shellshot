...
public final class ParagraphLayoutCache {
    ...
    private ParagraphLayoutCache(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines) {
        ...
        this.lastDensity = InlineDensity.INSTANCE.m1284getUnspecifiedL26CHvs();
        this.layoutSize = IntSizeKt.IntSize(0, 0);
        this.prevConstraints = Constraints.INSTANCE.m6589fixedJhjzzOo(0, 0);
    ...
    public /* synthetic */ ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m6542getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, null);
    }
    ...
    public final void setDensity$foundation_release(Density value) {
        ...
        long newDensity = value != null ? InlineDensity.m1276constructorimpl(value) : InlineDensity.INSTANCE.m1284getUnspecifiedL26CHvs();
        if (localField == null) {
            this.density = value;
            this.lastDensity = newDensity;
        } else if (value == null || !InlineDensity.m1278equalsimpl0(this.lastDensity, newDensity)) {
            this.density = value;
            this.lastDensity = newDensity;
            markDirty();
        }
    ...
    public final void m1300setLayoutSizeozmzZPI$foundation_release(long j) {
        this.layoutSize = j;
    }

    /* renamed from: layoutWithConstraints-K40F9xA, reason: not valid java name */
    public final boolean m1299layoutWithConstraintsK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (this.minLines > 1) {
            ...
            MinLinesConstrainer localMin = companion.from(minLinesConstrainer, layoutDirection2, textStyle, density, this.fontFamilyResolver);
            this.mMinLinesConstrainer = localMin;
            finalConstraints = localMin.m1288coerceMinLinesOh53vG4$foundation_release(constraints, this.minLines);
        } else {
            layoutDirection2 = layoutDirection;
            finalConstraints = constraints;
        }
        boolean z2 = false;
        if (!m1297newLayoutWillBeDifferentK40F9xA(finalConstraints, layoutDirection2)) {
            if (!Constraints.m6572equalsimpl0(finalConstraints, this.prevConstraints)) {
                ...
                long localSize = ConstraintsKt.m6593constrain4WqzIAM(finalConstraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(layoutWidth), TextDelegateKt.ceilToIntPx(localParagraph.getHeight())));
                this.layoutSize = localSize;
                if (TextOverflow.m6535equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6544getVisiblegIe3tQ8()) || (IntSize.m6796getWidthimpl(localSize) >= localParagraph.getWidth() && IntSize.m6795getHeightimpl(localSize) >= localParagraph.getHeight())) {
                    z = false;
                }
                this.didOverflow = z;
        ...
        Paragraph it = m1296layoutTextK40F9xA(finalConstraints, layoutDirection2);
        this.prevConstraints = finalConstraints;
        long localSize2 = ConstraintsKt.m6593constrain4WqzIAM(finalConstraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(it.getWidth()), TextDelegateKt.ceilToIntPx(it.getHeight())));
        this.layoutSize = localSize2;
        if (!TextOverflow.m6535equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6544getVisiblegIe3tQ8()) && (IntSize.m6796getWidthimpl(localSize2) < it.getWidth() || IntSize.m6795getHeightimpl(localSize2) < it.getHeight())) {
            z2 = true;
        }
        this.didOverflow = z2;
        this.paragraph = it;
    ...
    public final int intrinsicHeight(int width, LayoutDirection layoutDirection) {
        ...
        int result = TextDelegateKt.ceilToIntPx(m1296layoutTextK40F9xA(ConstraintsKt.Constraints(0, width, 0, Integer.MAX_VALUE), layoutDirection).getHeight());
    ...
    public final void m1301updateL6sJoHM(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines) {
        this.text = text;
        this.style = style;
        this.fontFamilyResolver = fontFamilyResolver;
        this.overflow = overflow;
    ...
    private final Paragraph m1296layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ParagraphIntrinsics localParagraphIntrinsics = setLayoutDirection(layoutDirection);
        return ParagraphKt.m5976Paragraph_EkL_Y(localParagraphIntrinsics, LayoutUtilsKt.m1285finalConstraintstfFHcEY(constraints, this.softWrap, this.overflow, localParagraphIntrinsics.getMaxIntrinsicWidth()), LayoutUtilsKt.m1286finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), TextOverflow.m6535equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6543getEllipsisgIe3tQ8()));
    }

    /* renamed from: newLayoutWillBeDifferent-K40F9xA, reason: not valid java name */
    private final boolean m1297newLayoutWillBeDifferentK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (Constraints.m6572equalsimpl0(constraints, this.prevConstraints)) {
            return false;
        }
        return Constraints.m6579getMaxWidthimpl(constraints) != Constraints.m6579getMaxWidthimpl(this.prevConstraints) || ((float) Constraints.m6578getMaxHeightimpl(constraints)) < localParagraph.getHeight() || localParagraph.getDidExceedMaxLines();
    }
    ...
    public final TextLayoutResult slowCreateTextLayoutResultOrNull(TextStyle style) {
        ...
        finalConstraints = Constraints.m6569copyZbe2FdA(r12, (r12 & 1) != 0 ? Constraints.m6581getMinWidthimpl(r12) : 0, (r12 & 2) != 0 ? Constraints.m6579getMaxWidthimpl(r12) : 0, (r12 & 4) != 0 ? Constraints.m6580getMinHeightimpl(r12) : 0, (r12 & 8) != 0 ? Constraints.m6578getMaxHeightimpl(this.prevConstraints) : 0);
        return new TextLayoutResult(new TextLayoutInput(annotatedString, style, CollectionsKt.emptyList(), this.maxLines, this.softWrap, this.overflow, localDensity, localLayoutDirection, this.fontFamilyResolver, finalConstraints, (DefaultConstructorMarker) null), new MultiParagraph(new MultiParagraphIntrinsics(annotatedString, style, (List<AnnotatedString.Range<Placeholder>>) CollectionsKt.emptyList(), localDensity, this.fontFamilyResolver), finalConstraints, this.maxLines, TextOverflow.m6535equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6543getEllipsisgIe3tQ8()), null), this.layoutSize, null);
    }
    ...
    public String toString() {
        return "ParagraphLayoutCache(paragraph=" + (this.paragraph != null ? "<paragraph>" : AbstractJsonLexerKt.NULL) + ", lastDensity=" + ((Object) InlineDensity.m1282toStringimpl(this.lastDensity)) + ')';
    }
}

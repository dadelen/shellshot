    ...
    public final Object invokeSuspend(Object obj) {
        ...
        switch (this.label) {
            case 0:
                ...
                BuildersKt__Builders_commonKt.launch$default($this$coroutineScope, null, CoroutineStart.UNDISPATCHED, new AnonymousClass1(this.this$0, this.$this_selectionHandleGestures, null), 1, null);
                BuildersKt__Builders_commonKt.launch$default($this$coroutineScope, null, CoroutineStart.UNDISPATCHED, new AnonymousClass2(this.$this_selectionHandleGestures, this.this$0, this.$isStartHandle, null), 1, null);
                launch$default = BuildersKt__Builders_commonKt.launch$default($this$coroutineScope, null, CoroutineStart.UNDISPATCHED, new AnonymousClass3(this.this$0, this.$this_selectionHandleGestures, this.$isStartHandle, null), 1, null);
            ...
            switch (this.label) {
                case 0:
                    ...
                    TapOnPosition tapOnPosition = new TapOnPosition() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.selectionHandleGestures.2.2.1
                        ...
                        public final void mo1226onEventk4lQ0M(long it) {
                            Handle handle;
                            long m1246getHandlePositiontuRUvjQ;
                            ...
                            m1246getHandlePositiontuRUvjQ = TextFieldSelectionState.this.m1246getHandlePositiontuRUvjQ(z);
                            textFieldSelectionState2.m1256updateHandleDraggingUv8p0NA(handle, SelectionHandlesKt.m1328getAdjustedCoordinatesk4lQ0M(m1246getHandlePositiontuRUvjQ));
                        }
                    };

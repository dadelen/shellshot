...
public final class TextObfuscationMode {
    ...
    private static final int Visible = m1113constructorimpl(0);
    private static final int RevealLastTyped = m1113constructorimpl(1);
    private static final int Hidden = m1113constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TextObfuscationMode m1112boximpl(int i) {
    ...
    public static boolean m1114equalsimpl(int i, Object obj) {
        return (obj instanceof TextObfuscationMode) && i == ((TextObfuscationMode) obj).m1118unboximpl();
    }
    ...
    public static String m1117toStringimpl(int i) {
    ...
    public String toString() {
        return m1117toStringimpl(this.value);
    }

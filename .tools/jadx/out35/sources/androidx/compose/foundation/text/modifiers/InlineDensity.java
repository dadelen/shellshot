...
public final class InlineDensity {
    ...
    private static final long Unspecified = m1274constructorimpl(Float.NaN, Float.NaN);
    private final long packedValue;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ InlineDensity m1273boximpl(long j) {
        return new InlineDensity(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static long m1275constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1277equalsimpl(long j, Object obj) {
        return (obj instanceof InlineDensity) && j == ((InlineDensity) obj).getPackedValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1278equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1281hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    public boolean equals(Object obj) {
        return m1277equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m1281hashCodeimpl(this.packedValue);
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m1274constructorimpl(float density, float fontScale) {
        long v1$iv = Float.floatToRawIntBits(density);
        long v2$iv = Float.floatToRawIntBits(fontScale);
        return m1275constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m1276constructorimpl(Density density) {
        return m1274constructorimpl(density.getDensity(), density.getFontScale());
    }

    /* renamed from: getDensity-impl, reason: not valid java name */
    public static final float m1279getDensityimpl(long arg0) {
        int bits$iv$iv = (int) (arg0 >> 32);
        return Float.intBitsToFloat(bits$iv$iv);
    }

    /* renamed from: getFontScale-impl, reason: not valid java name */
    public static final float m1280getFontScaleimpl(long arg0) {
        int bits$iv$iv = (int) (4294967295L & arg0);
        return Float.intBitsToFloat(bits$iv$iv);
    }

    public String toString() {
        return m1282toStringimpl(this.packedValue);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1282toStringimpl(long arg0) {
        return "InlineDensity(density=" + m1279getDensityimpl(arg0) + ", fontScale=" + m1280getFontScaleimpl(arg0) + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m1284getUnspecifiedL26CHvs() {

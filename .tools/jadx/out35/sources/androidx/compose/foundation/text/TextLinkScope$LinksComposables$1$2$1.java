...
@DebugMetadata(c = "androidx.compose.foundation.text.TextLinkScope$LinksComposables$1$2$1", f = "TextLinkScope.kt", i = {}, l = {176}, m = "invokeSuspend", n = {}, s = {})
...
final class TextLinkScope$LinksComposables$1$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((TextLinkScope$LinksComposables$1$2$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (this.$linkStateObserver.collectInteractionsForLinks(this.$interactionSource, this) != coroutine_suspended) {
                    break;
                } else {

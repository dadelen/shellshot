...
public final class CutCornerShapeKt {
    ...
    public static final CutCornerShape m948CutCornerShape0680j_4(float size) {
        return CutCornerShape(CornerSizeKt.m947CornerSize0680j_4(size));
    }
    ...
    public static /* synthetic */ CutCornerShape m950CutCornerShapea9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m949CutCornerShapea9UjIt4(f, f2, f3, f4);
    }

    /* renamed from: CutCornerShape-a9UjIt4, reason: not valid java name */
    public static final CutCornerShape m949CutCornerShapea9UjIt4(float topStart, float topEnd, float bottomEnd, float bottomStart) {
        return new CutCornerShape(CornerSizeKt.m947CornerSize0680j_4(topStart), CornerSizeKt.m947CornerSize0680j_4(topEnd), CornerSizeKt.m947CornerSize0680j_4(bottomEnd), CornerSizeKt.m947CornerSize0680j_4(bottomStart));
    }

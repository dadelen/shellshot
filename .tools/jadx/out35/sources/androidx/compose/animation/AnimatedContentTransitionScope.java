...
public interface AnimatedContentTransitionScope<S> extends Transition.Segment<S> {
    ...
    EnterTransition mo35slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, Function1<? super Integer, Integer> initialOffset);

    /* renamed from: slideOutOfContainer-mOhB8PU, reason: not valid java name */
    ExitTransition mo36slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, Function1<? super Integer, Integer> targetOffset);
    ...
    public static final class SlideDirection {
        ...
        private static final int Left = m38constructorimpl(0);
        private static final int Right = m38constructorimpl(1);
        private static final int Up = m38constructorimpl(2);
        private static final int Down = m38constructorimpl(3);
        private static final int Start = m38constructorimpl(4);
        private static final int End = m38constructorimpl(5);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ SlideDirection m37boximpl(int i) {
        ...
        public static boolean m39equalsimpl(int i, Object obj) {
            return (obj instanceof SlideDirection) && i == ((SlideDirection) obj).getValue();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m40equalsimpl0(int i, int i2) {
            return i == i2;
        }
        ...
        public static String m42toStringimpl(int arg0) {
            return m40equalsimpl0(arg0, Left) ? "Left" : m40equalsimpl0(arg0, Right) ? "Right" : m40equalsimpl0(arg0, Up) ? "Up" : m40equalsimpl0(arg0, Down) ? "Down" : m40equalsimpl0(arg0, Start) ? "Start" : m40equalsimpl0(arg0, End) ? "End" : "Invalid";
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: slideIntoContainer-mOhB8PU$default, reason: not valid java name */
    static /* synthetic */ EnterTransition m33slideIntoContainermOhB8PU$default(AnimatedContentTransitionScope animatedContentTransitionScope, int i, FiniteAnimationSpec finiteAnimationSpec, Function1 function1, int i2, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: slideIntoContainer-mOhB8PU");
        }
        if ((i2 & 2) != 0) {
            finiteAnimationSpec = AnimationSpecKt.spring$default(0.0f, 0.0f, IntOffset.m6745boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntOffset.INSTANCE)), 3, null);
        }
        if ((i2 & 4) != 0) {
        ...
        return animatedContentTransitionScope.mo35slideIntoContainermOhB8PU(i, finiteAnimationSpec, function1);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: slideOutOfContainer-mOhB8PU$default, reason: not valid java name */
    static /* synthetic */ ExitTransition m34slideOutOfContainermOhB8PU$default(AnimatedContentTransitionScope animatedContentTransitionScope, int i, FiniteAnimationSpec finiteAnimationSpec, Function1 function1, int i2, Object obj) {
        if (obj != null) {
        ...
        return animatedContentTransitionScope.mo36slideOutOfContainermOhB8PU(i, finiteAnimationSpec, function1);
    }

...
public final class Transition<S> {
    ...
    public final void animateTo$animation_core_release(final S s, Composer $composer, final int $changed) {
        ...
        if (($dirty & 19) != 18 || !$composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1493585151, $dirty, -1, "androidx.compose.animation.core.Transition.animateTo (Transition.kt:1211)");
            }
            if (!isSeeking()) {
                $composer2.startReplaceGroup(1822507602);
                ComposerKt.sourceInformation($composer2, "");
                updateTarget$animation_core_release(s);
                if (!Intrinsics.areEqual(s, getCurrentState()) || isRunning() || getUpdateChildrenNeeded()) {
                    $composer2.startReplaceGroup(1822738893);
                    ComposerKt.sourceInformation($composer2, "1219@49831L24,1220@49911L1012,1220@49872L1051");
                    ...
                    ComposerKt.sourceInformationMarkerEnd($composer2);
                    ComposerKt.sourceInformationMarkerStart($composer2, 335900987, "CC(remember):Transition.kt#9igjgp");
                    boolean invalid$iv = $composer2.changedInstance(coroutineScope) | (($dirty & 112) == 32);
                    Object it$iv = $composer2.rememberedValue();
                    if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                        value$iv = (Function1) new Function1<DisposableEffectScope, DisposableEffectResult>() { // from class: androidx.compose.animation.core.Transition$animateTo$1$1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
                                ...
                                public final Object invokeSuspend(Object $result) {
                                    ...
                                    switch (this.label) {
                                        case 0:
                                            ...
                                            CoroutineScope $this$launch2 = (CoroutineScope) anonymousClass1.L$0;
                                            $this$launch = $this$launch2;
                                            durationScale = SuspendAnimationKt.getDurationScale($this$launch2.getCoroutineContext());
                                            break;
                                        case 1:
                                            anonymousClass1 = this;
                                            durationScale = anonymousClass1.F$0;
                                            $this$launch = (CoroutineScope) anonymousClass1.L$0;
                                            ResultKt.throwOnFailure($result);
                                            break;
                                        default:
                    ...
                    ComposerKt.sourceInformationMarkerEnd($composer2);
                    EffectsKt.DisposableEffect(coroutineScope, this, (Function1) value$iv, $composer2, $dirty & 112);
                    $composer2.endReplaceGroup();
                } else {
                    $composer2.startReplaceGroup(1823982427);
                    $composer2.endReplaceGroup();
                }
                $composer2.endReplaceGroup();
            } else {
                $composer2.startReplaceGroup(1823992347);
                $composer2.endReplaceGroup();
            }
            if (ComposerKt.isTraceInProgress()) {
    ...
    public final class TransitionAnimationState<T, V extends AnimationVector> implements State<T> {
        ...
        public final void updateTargetValue$animation_core_release(T targetValue, FiniteAnimationSpec<T> animationSpec) {
            ...
            updateAnimation((getResetSnapValue$animation_core_release() > (-3.0f) ? 1 : (getResetSnapValue$animation_core_release() == (-3.0f) ? 0 : -1)) == 0 ? targetValue : getValue(), !isFinished$animation_core_release());
            ...
            if (getResetSnapValue$animation_core_release() >= 0.0f) {
                ...
                setValue$animation_core_release(getAnimation().getValueFromNanos((long) (duration * getResetSnapValue$animation_core_release())));
            } else {

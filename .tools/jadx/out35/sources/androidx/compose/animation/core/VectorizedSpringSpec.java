...
public final class VectorizedSpringSpec<V extends AnimationVector> implements VectorizedFiniteAnimationSpec<V> {
    ...
    */
    public VectorizedSpringSpec(float r2, float r3, V r4) {
        /*
            r1 = this;
            androidx.compose.animation.core.Animations r0 = androidx.compose.animation.core.VectorizedAnimationSpecKt.access$createSpringAnimations(r4, r2, r3)
            r1.<init>(r2, r3, r0)
            return
        */

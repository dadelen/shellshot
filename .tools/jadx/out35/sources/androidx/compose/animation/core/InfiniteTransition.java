...
public final class InfiniteTransition {
    ...
    public final void run$animation_core_release(Composer $composer, final int $changed) {
        Object value$iv;
        InfiniteTransition$run$1$1 value$iv2;
        Composer $composer2 = $composer.startRestartGroup(-318043801);
        ComposerKt.sourceInformation($composer2, "C(run)172@7001L67:InfiniteTransition.kt#pdpnli");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if (($dirty & 3) != 2 || !$composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-318043801, $dirty, -1, "androidx.compose.animation.core.InfiniteTransition.run (InfiniteTransition.kt:171)");
            }
            ComposerKt.sourceInformationMarkerStart($composer2, 748212685, "CC(remember):InfiniteTransition.kt#9igjgp");
            ...
            if (isRunning() || getRefreshChildNeeded()) {
                $composer2.startReplaceGroup(1719915818);
                ComposerKt.sourceInformation($composer2, "176@7149L1537,176@7128L1558");
                ComposerKt.sourceInformationMarkerStart($composer2, 748218891, "CC(remember):InfiniteTransition.kt#9igjgp");
                boolean invalid$iv = $composer2.changedInstance(this);
                Object it$iv2 = $composer2.rememberedValue();
                if (invalid$iv || it$iv2 == Composer.INSTANCE.getEmpty()) {
                    value$iv2 = new InfiniteTransition$run$1$1(toolingOverride, this, null);
                    $composer2.updateRememberedValue(value$iv2);
                } else {
                    value$iv2 = it$iv2;
                }
                ComposerKt.sourceInformationMarkerEnd($composer2);
                EffectsKt.LaunchedEffect(this, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) value$iv2, $composer2, $dirty & 14);
                $composer2.endReplaceGroup();
            } else {
                $composer2.startReplaceGroup(1721436120);
                $composer2.endReplaceGroup();
            }
            if (ComposerKt.isTraceInProgress()) {

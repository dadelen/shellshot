...
final class EnterExitTransitionModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    private final void m83setLookaheadConstraintsBRTryo0(long value) {
    ...
    public final long m85sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()]) {
            ...
            case 2:
                ...
                if (changeSize != null && (size = changeSize.getSize()) != null) {
                    return size.invoke(IntSize.m6788boximpl(fullSize)).getPackedValue();
                }
                break;
            case 3:
                ChangeSize changeSize2 = this.exit.getData().getChangeSize();
                if (changeSize2 != null && (size2 = changeSize2.getSize()) != null) {
                    return size2.invoke(IntSize.m6788boximpl(fullSize)).getPackedValue();
                }
                break;
            default:
    ...
    public final long m87targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        if (this.currentAlignment != null && getAlignment() != null && !Intrinsics.areEqual(this.currentAlignment, getAlignment())) {
            switch (WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()]) {
                ...
                case 3:
                    ...
                    long endSize = it.getSize().invoke(IntSize.m6788boximpl(fullSize)).getPackedValue();
                    Alignment alignment = getAlignment();
                    Intrinsics.checkNotNull(alignment);
                    long targetOffset = alignment.mo3768alignKFBX0sM(fullSize, endSize, LayoutDirection.Ltr);
                    Alignment alignment2 = this.currentAlignment;
                    Intrinsics.checkNotNull(alignment2);
                    long currentOffset = alignment2.mo3768alignKFBX0sM(fullSize, endSize, LayoutDirection.Ltr);
                    return IntOffset.m6757minusqkQi6aY(targetOffset, currentOffset);
                default:
                    throw new NoWhenBranchMatchedException();
            }
        }
    ...
    public MeasureResult mo84measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        if ($this$measure_u2d3p2s80s.isLookingAhead()) {
            ...
            m83setLookaheadConstraintsBRTryo0(constraints);
            return MeasureScope.layout$default($this$measure_u2d3p2s80s, IntSize.m6796getWidthimpl(measuredSize), IntSize.m6795getHeightimpl(measuredSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$1
                {
                    super(1);
                }
        ...
        if (!this.isEnabled.invoke().booleanValue()) {
            final Placeable $this$measure_3p2s80s_u24lambda_u242 = measurable.mo5491measureBRTryo0(constraints);
            return MeasureScope.layout$default($this$measure_u2d3p2s80s, $this$measure_3p2s80s_u24lambda_u242.getWidth(), $this$measure_3p2s80s_u24lambda_u242.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$3$1
                {
                    super(1);
                }
        ...
        final Placeable placeable2 = measurable.mo5491measureBRTryo0(constraints);
        long measuredSize2 = IntSizeKt.IntSize(placeable2.getWidth(), placeable2.getHeight());
        final long target = AnimationModifierKt.m62isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : measuredSize2;
        ...
        State animSize = deferredAnimation != null ? deferredAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$animSize$1
            ...
            public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                return IntSize.m6788boximpl(m88invokeYEO4UFw(enterExitState));
            }

            /* renamed from: invoke-YEO4UFw, reason: not valid java name */
            public final long m88invokeYEO4UFw(EnterExitState it) {
                return EnterExitTransitionModifierNode.this.m85sizeByStateUzc_VyU(it, target);
            }
        }) : null;
        long currentSize2 = ConstraintsKt.m6593constrain4WqzIAM(constraints, animSize != null ? animSize.getValue().getPackedValue() : measuredSize2);
        Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation2 = this.offsetAnimation;
        final long offsetDelta = (deferredAnimation2 == null || (animate2 = deferredAnimation2.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$offsetDelta$1
            @Override // kotlin.jvm.functions.Function1
            public final FiniteAnimationSpec<IntOffset> invoke(Transition.Segment<EnterExitState> segment) {
                SpringSpec springSpec;
                springSpec = EnterExitTransitionKt.DefaultOffsetAnimationSpec;
            ...
            public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                return IntOffset.m6745boximpl(m89invokeBjo55l4(enterExitState));
            }

            /* renamed from: invoke-Bjo55l4, reason: not valid java name */
            public final long m89invokeBjo55l4(EnterExitState it) {
                return EnterExitTransitionModifierNode.this.m87targetOffsetByStateoFUgxo0(it, target);
            }
        })) == null) ? IntOffset.INSTANCE.m6764getZeronOccac() : animate2.getValue().getPackedValue();
        Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation3 = this.slideAnimation;
        long slideOffset = (deferredAnimation3 == null || (animate = deferredAnimation3.animate(this.slideSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$slideOffset$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                return IntOffset.m6745boximpl(m90invokeBjo55l4(enterExitState));
            }

            /* renamed from: invoke-Bjo55l4, reason: not valid java name */
            public final long m90invokeBjo55l4(EnterExitState it) {
                return EnterExitTransitionModifierNode.this.m86slideTargetValueByStateoFUgxo0(it, target);
            }
        })) == null) ? IntOffset.INSTANCE.m6764getZeronOccac() : animate.getValue().getPackedValue();
        Alignment alignment2 = this.currentAlignment;
        if (alignment2 != null) {
            currentSize = currentSize2;
            m6764getZeronOccac = alignment2.mo3768alignKFBX0sM(target, currentSize2, LayoutDirection.Ltr);
        } else {
            currentSize = currentSize2;
            m6764getZeronOccac = IntOffset.INSTANCE.m6764getZeronOccac();
        }
        final long offset = IntOffset.m6758plusqkQi6aY(m6764getZeronOccac, slideOffset);
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, IntSize.m6796getWidthimpl(currentSize), IntSize.m6795getHeightimpl(currentSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                $this$layout.placeWithLayer(Placeable.this, IntOffset.m6754getXimpl(offsetDelta) + IntOffset.m6754getXimpl(offset), IntOffset.m6755getYimpl(offsetDelta) + IntOffset.m6755getYimpl(offset), 0.0f, layerBlock);
            }
        }, 4, null);
    }
    ...
    public final long m86slideTargetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        Function1<IntSize, IntOffset> slideOffset;
        Function1<IntSize, IntOffset> slideOffset2;
        Slide slide = this.enter.getData().getSlide();
        long preEnter = (slide == null || (slideOffset2 = slide.getSlideOffset()) == null) ? IntOffset.INSTANCE.m6764getZeronOccac() : slideOffset2.invoke(IntSize.m6788boximpl(fullSize)).getPackedValue();
        Slide slide2 = this.exit.getData().getSlide();
        long postExit = (slide2 == null || (slideOffset = slide2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m6764getZeronOccac() : slideOffset.invoke(IntSize.m6788boximpl(fullSize)).getPackedValue();
        switch (WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()]) {
            case 1:
                return IntOffset.INSTANCE.m6764getZeronOccac();
            case 2:

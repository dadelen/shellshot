...
public final class FabPosition {
    ...
    private static final int Start = m2102constructorimpl(0);
    private static final int Center = m2102constructorimpl(1);
    private static final int End = m2102constructorimpl(2);
    private static final int EndOverlay = m2102constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FabPosition m2101boximpl(int i) {
        return new FabPosition(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2102constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2103equalsimpl(int i, Object obj) {
        return (obj instanceof FabPosition) && i == ((FabPosition) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2104equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2105hashCodeimpl(int i) {
    ...
    public static String m2106toStringimpl(int arg0) {
        return m2104equalsimpl0(arg0, Start) ? "FabPosition.Start" : m2104equalsimpl0(arg0, Center) ? "FabPosition.Center" : m2104equalsimpl0(arg0, End) ? "FabPosition.End" : "FabPosition.EndOverlay";
    }
}

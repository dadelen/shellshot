...
public final class CardColors {
    ...
    public final CardColors m1828copyjRlVdoo(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor) {
    ...
    public final long m1826containerColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m1827contentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof CardColors) && Color.m4164equalsimpl0(this.containerColor, ((CardColors) other).containerColor) && Color.m4164equalsimpl0(this.contentColor, ((CardColors) other).contentColor) && Color.m4164equalsimpl0(this.disabledContainerColor, ((CardColors) other).disabledContainerColor) && Color.m4164equalsimpl0(this.disabledContentColor, ((CardColors) other).disabledContentColor)) {
            return true;
        }
        return false;
    }

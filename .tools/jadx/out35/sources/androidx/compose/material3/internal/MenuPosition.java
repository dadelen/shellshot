...
public final class MenuPosition {
    ...
    public interface Horizontal {
        ...
        int mo2894position95KtPRI(IntRect anchorBounds, long windowSize, int menuWidth, LayoutDirection layoutDirection);
    }
    ...
    public interface Vertical {
        ...
        int mo2895positionJVtK1S4(IntRect anchorBounds, long windowSize, int menuHeight);
    }

...
public final class SnackbarHostState {
    ...
    /* JADX WARN: Removed duplicated region for block: B:42:0x00cc A[Catch: all -> 0x00e4, TRY_LEAVE, TryCatch #2 {all -> 0x00e4, blocks: (B:40:0x00b6, B:42:0x00cc), top: B:39:0x00b6 }] */
    ...
    private static final class SnackbarDataImpl implements SnackbarData {
        ...
        public void performAction() {
            if (this.continuation.isActive()) {
                ...
                cancellableContinuation.resumeWith(Result.m7212constructorimpl(SnackbarResult.ActionPerformed));
            }
        }
        ...
        public void dismiss() {
            if (this.continuation.isActive()) {
                CancellableContinuation<SnackbarResult> cancellableContinuation = this.continuation;
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m7212constructorimpl(SnackbarResult.Dismissed));
            }
        }

...
public final class PathFillType {
    ...
    private static final int NonZero = m4438constructorimpl(0);
    private static final int EvenOdd = m4438constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PathFillType m4437boximpl(int i) {
        return new PathFillType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4438constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4439equalsimpl(int i, Object obj) {
        return (obj instanceof PathFillType) && i == ((PathFillType) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4440equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4441hashCodeimpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m4445getNonZeroRgk1Os() {
            return PathFillType.NonZero;
        }

        /* renamed from: getEvenOdd-Rg-k1Os, reason: not valid java name */
        public final int m4444getEvenOddRgk1Os() {
    ...
    public static String m4442toStringimpl(int arg0) {
        return m4440equalsimpl0(arg0, NonZero) ? "NonZero" : m4440equalsimpl0(arg0, EvenOdd) ? "EvenOdd" : "Unknown";
    }

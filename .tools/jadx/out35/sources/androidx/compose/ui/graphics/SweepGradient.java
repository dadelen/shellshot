    ...
    */
    ...
    public Shader mo4132createShaderuvyYCjk(long size) {
        ...
        if (OffsetKt.m3943isUnspecifiedk4lQ0M(this.center)) {
            Offset = SizeKt.m4001getCenteruvyYCjk(size);
        } else {
            Offset = OffsetKt.Offset((Offset.m3922getXimpl(this.center) > Float.POSITIVE_INFINITY ? 1 : (Offset.m3922getXimpl(this.center) == Float.POSITIVE_INFINITY ? 0 : -1)) == 0 ? Size.m3991getWidthimpl(size) : Offset.m3922getXimpl(this.center), Offset.m3923getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m3988getHeightimpl(size) : Offset.m3923getYimpl(this.center));
        }
        return ShaderKt.m4481SweepGradientShader9KIMszo(Offset, this.colors, this.stops);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SweepGradient) && Offset.m3919equalsimpl0(this.center, ((SweepGradient) other).center) && Intrinsics.areEqual(this.colors, ((SweepGradient) other).colors) && Intrinsics.areEqual(this.stops, ((SweepGradient) other).stops);
    }

    public int hashCode() {
        int result = Offset.m3924hashCodeimpl(this.center);

...
public final class ClipOp {
    ...
    private static final int Difference = m4145constructorimpl(0);
    private static final int Intersect = m4145constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ClipOp m4144boximpl(int i) {
        return new ClipOp(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4145constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4146equalsimpl(int i, Object obj) {
        return (obj instanceof ClipOp) && i == ((ClipOp) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4147equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4148hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m4146equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m4148hashCodeimpl(this.value);
    }
    ...
    public static String m4149toStringimpl(int arg0) {
        return m4147equalsimpl0(arg0, Difference) ? "Difference" : m4147equalsimpl0(arg0, Intersect) ? "Intersect" : "Unknown";
    }

    public String toString() {
        return m4149toStringimpl(this.value);
    }
}

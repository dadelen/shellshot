...
public final class PathOperation {
    ...
    private static final int Difference = m4448constructorimpl(0);
    private static final int Intersect = m4448constructorimpl(1);
    private static final int Union = m4448constructorimpl(2);
    private static final int Xor = m4448constructorimpl(3);
    private static final int ReverseDifference = m4448constructorimpl(4);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PathOperation m4447boximpl(int i) {
        return new PathOperation(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4448constructorimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object obj) {
        return m4449equalsimpl(this.value, obj);
    }
    ...
    public static final class Companion {
        ...
        public final int m4454getDifferenceb3I0S0c() {
            return PathOperation.Difference;
        }

        /* renamed from: getIntersect-b3I0S0c, reason: not valid java name */
        public final int m4455getIntersectb3I0S0c() {
            return PathOperation.Intersect;
        }

        /* renamed from: getUnion-b3I0S0c, reason: not valid java name */
        public final int m4457getUnionb3I0S0c() {
            return PathOperation.Union;
        }

        /* renamed from: getXor-b3I0S0c, reason: not valid java name */
        public final int m4458getXorb3I0S0c() {
            return PathOperation.Xor;
        }

        /* renamed from: getReverseDifference-b3I0S0c, reason: not valid java name */
        public final int m4456getReverseDifferenceb3I0S0c() {
    ...
    public static String m4452toStringimpl(int arg0) {
        return m4450equalsimpl0(arg0, Difference) ? "Difference" : m4450equalsimpl0(arg0, Intersect) ? "Intersect" : m4450equalsimpl0(arg0, Union) ? "Union" : m4450equalsimpl0(arg0, Xor) ? "Xor" : m4450equalsimpl0(arg0, ReverseDifference) ? "ReverseDifference" : "Unknown";
    }

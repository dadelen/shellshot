...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint internalPaint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m4105getSrcOver0nO6VwU();
    }
    ...
    public long mo4036getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo4042setColor8_81llA(long color) {
        AndroidPaint_androidKt.m4048setNativeColor4WTKRHQ(this.internalPaint, color);
    }
    ...
    public void mo4041setBlendModes9anfk8(int value) {
        if (!BlendMode.m4074equalsimpl0(this._blendMode, value)) {
            this._blendMode = value;
            AndroidPaint_androidKt.m4047setNativeBlendModeGB0RdKg(this.internalPaint, value);
        }
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo4040getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStyle-k9PVt8s, reason: not valid java name */
    public void mo4046setStylek9PVt8s(int value) {
        AndroidPaint_androidKt.m4052setNativeStyle5YerkU(this.internalPaint, value);
    }
    ...
    public int mo4038getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeCap-BeK7IIE, reason: not valid java name */
    public void mo4044setStrokeCapBeK7IIE(int value) {
        AndroidPaint_androidKt.m4050setNativeStrokeCapCSYIeUk(this.internalPaint, value);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo4039getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo4045setStrokeJoinWw9F2mQ(int value) {
        AndroidPaint_androidKt.m4051setNativeStrokeJoinkLtJ_vA(this.internalPaint, value);
    }
    ...
    public int mo4037getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setFilterQuality-vDHp3xo, reason: not valid java name */
    public void mo4043setFilterQualityvDHp3xo(int value) {
        AndroidPaint_androidKt.m4049setNativeFilterQuality50PEsBU(this.internalPaint, value);
    }

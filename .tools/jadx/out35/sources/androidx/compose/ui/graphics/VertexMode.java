...
public final class VertexMode {
    ...
    private static final int Triangles = m4555constructorimpl(0);
    private static final int TriangleStrip = m4555constructorimpl(1);
    private static final int TriangleFan = m4555constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ VertexMode m4554boximpl(int i) {
        return new VertexMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4555constructorimpl(int i) {
        return i;
    }
    ...
    public static final class Companion {
        ...
        public final int m4563getTrianglesc2xauaI() {
            return VertexMode.Triangles;
        }

        /* renamed from: getTriangleStrip-c2xauaI, reason: not valid java name */
        public final int m4562getTriangleStripc2xauaI() {
            return VertexMode.TriangleStrip;
        }

        /* renamed from: getTriangleFan-c2xauaI, reason: not valid java name */
        public final int m4561getTriangleFanc2xauaI() {
            return VertexMode.TriangleFan;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4559toStringimpl(int arg0) {
        return m4557equalsimpl0(arg0, Triangles) ? "Triangles" : m4557equalsimpl0(arg0, TriangleStrip) ? "TriangleStrip" : m4557equalsimpl0(arg0, TriangleFan) ? "TriangleFan" : "Unknown";
    }

    public String toString() {
        return m4559toStringimpl(this.value);
    }
}

...
public final class FilterQuality {
    ...
    private static final int None = m4255constructorimpl(0);
    private static final int Low = m4255constructorimpl(1);
    private static final int Medium = m4255constructorimpl(2);
    private static final int High = m4255constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FilterQuality m4254boximpl(int i) {
    ...
    public static boolean m4256equalsimpl(int i, Object obj) {
        return (obj instanceof FilterQuality) && i == ((FilterQuality) obj).m4260unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m4264getNonefv9h1I() {
            return FilterQuality.None;
        }

        /* renamed from: getLow-f-v9h1I, reason: not valid java name */
        public final int m4262getLowfv9h1I() {
            return FilterQuality.Low;
        }

        /* renamed from: getMedium-f-v9h1I, reason: not valid java name */
        public final int m4263getMediumfv9h1I() {
            return FilterQuality.Medium;
        }

        /* renamed from: getHigh-f-v9h1I, reason: not valid java name */
        public final int m4261getHighfv9h1I() {
            return FilterQuality.High;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4259toStringimpl(int arg0) {
        return m4257equalsimpl0(arg0, None) ? "None" : m4257equalsimpl0(arg0, Low) ? "Low" : m4257equalsimpl0(arg0, Medium) ? "Medium" : m4257equalsimpl0(arg0, High) ? "High" : "Unknown";
    }

...
public final class KeyEventType {
    ...
    private static final int Unknown = m5211constructorimpl(0);
    private static final int KeyUp = m5211constructorimpl(1);
    private static final int KeyDown = m5211constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ KeyEventType m5210boximpl(int i) {
        return new KeyEventType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m5211constructorimpl(int i) {
        return i;
    }
    ...
    public static int m5214hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m5212equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m5214hashCodeimpl(this.value);
    }
    ...
    public static String m5215toStringimpl(int arg0) {
        return m5213equalsimpl0(arg0, KeyUp) ? "KeyUp" : m5213equalsimpl0(arg0, KeyDown) ? "KeyDown" : m5213equalsimpl0(arg0, Unknown) ? "Unknown" : "Invalid";
    }

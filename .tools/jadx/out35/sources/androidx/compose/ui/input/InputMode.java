...
public final class InputMode {
    ...
    private static final int Touch = m4896constructorimpl(1);
    private static final int Keyboard = m4896constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ InputMode m4895boximpl(int i) {
    ...
    public static String m4900toStringimpl(int arg0) {
        return m4898equalsimpl0(arg0, Touch) ? "Touch" : m4898equalsimpl0(arg0, Keyboard) ? "Keyboard" : "Error";
    }
    ...
    public static final class Companion {
        ...
        public final int m4903getTouchaOaMEAU() {
            return InputMode.Touch;
        }

        /* renamed from: getKeyboard-aOaMEAU, reason: not valid java name */
        public final int m4902getKeyboardaOaMEAU() {

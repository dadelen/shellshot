...
public final class PointerEventKt {
    ...
    public static final boolean positionChanged(PointerInputChange $this$positionChanged) {
        return !Offset.m3919equalsimpl0(positionChangeInternal($this$positionChanged, false), Offset.INSTANCE.m3938getZeroF1C5BW0());
    }

    public static final boolean positionChangedIgnoreConsumed(PointerInputChange $this$positionChangedIgnoreConsumed) {
        return true ^ Offset.m3919equalsimpl0(positionChangeInternal($this$positionChangedIgnoreConsumed, true), Offset.INSTANCE.m3938getZeroF1C5BW0());
    }
    ...
    private static final long positionChangeInternal(PointerInputChange $this$positionChangeInternal, boolean ignoreConsumed) {
        ...
        long offset = Offset.m3926minusMKHz9U(currentPosition, previousPosition);
        return (ignoreConsumed || !$this$positionChangeInternal.isConsumed()) ? offset : Offset.INSTANCE.m3938getZeroF1C5BW0();
    }
    ...
    public static final void consumePositionChange(PointerInputChange $this$consumePositionChange) {
        if (!Offset.m3919equalsimpl0(positionChange($this$consumePositionChange), Offset.INSTANCE.m3938getZeroF1C5BW0())) {
    ...
    public static final boolean m5306isOutOfBoundsO0kMr_c(PointerInputChange $this$isOutOfBounds_u2dO0kMr_c, long size) {
    ...
    public static final boolean m5307isOutOfBoundsjwHxaWs(PointerInputChange $this$isOutOfBounds_u2djwHxaWs, long size, long extendedTouchPadding) {
        if (!PointerType.m5434equalsimpl0($this$isOutOfBounds_u2djwHxaWs.getType(), PointerType.INSTANCE.m5441getTouchT8wyACA())) {
            return m5306isOutOfBoundsO0kMr_c($this$isOutOfBounds_u2djwHxaWs, size);
        }
        long position = $this$isOutOfBounds_u2djwHxaWs.getPosition();
        float x = Offset.m3922getXimpl(position);
        float y = Offset.m3923getYimpl(position);
        float minX = -Size.m3991getWidthimpl(extendedTouchPadding);
        float maxX = IntSize.m6796getWidthimpl(size) + Size.m3991getWidthimpl(extendedTouchPadding);
        float minY = -Size.m3988getHeightimpl(extendedTouchPadding);
        float maxY = IntSize.m6795getHeightimpl(size) + Size.m3988getHeightimpl(extendedTouchPadding);

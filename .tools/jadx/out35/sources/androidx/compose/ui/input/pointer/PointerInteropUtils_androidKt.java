...
public final class PointerInteropUtils_androidKt {
    ...
    public static final void m5422toMotionEventScoped4ec7I(PointerEvent $this$toMotionEventScope_u2dd_u2d4ec7I, long offset, Function1<? super MotionEvent, Unit> function1) {
        m5423toMotionEventScopeubNVwUQ($this$toMotionEventScope_u2dd_u2d4ec7I, offset, function1, false);
    }

    /* renamed from: toCancelMotionEventScope-d-4ec7I, reason: not valid java name */
    public static final void m5421toCancelMotionEventScoped4ec7I(PointerEvent $this$toCancelMotionEventScope_u2dd_u2d4ec7I, long offset, Function1<? super MotionEvent, Unit> function1) {
        m5423toMotionEventScopeubNVwUQ($this$toCancelMotionEventScope_u2dd_u2d4ec7I, offset, function1, true);
    }
    ...
    private static final void m5423toMotionEventScopeubNVwUQ(PointerEvent $this$toMotionEventScope_u2dubNVwUQ, long offset, Function1<? super MotionEvent, Unit> function1, boolean cancel) {
        ...
        motionEvent.offsetLocation(-Offset.m3922getXimpl(offset), -Offset.m3923getYimpl(offset));
        function1.invoke(motionEvent);
        motionEvent.offsetLocation(Offset.m3922getXimpl(offset), Offset.m3923getYimpl(offset));

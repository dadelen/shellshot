...
public final class AnimatedVisibilityClock implements ComposeAnimationClock<AnimatedVisibilityComposeAnimation, AnimatedVisibilityState> {
    ...
    public AnimatedVisibilityClock(AnimatedVisibilityComposeAnimation animation) {
        String m6565getEnterjXw82LU;
        this.animation = animation;
        if (getAnimation().m6551getAnimationObject().getCurrentState().booleanValue()) {
            m6565getEnterjXw82LU = AnimatedVisibilityState.INSTANCE.m6566getExitjXw82LU();
        } else {
            m6565getEnterjXw82LU = AnimatedVisibilityState.INSTANCE.m6565getEnterjXw82LU();
        }
        this.state = m6565getEnterjXw82LU;
    }
    ...
    public /* bridge */ /* synthetic */ AnimatedVisibilityState getState() {
        return AnimatedVisibilityState.m6558boximpl(getState());
    }

    @Override // androidx.compose.ui.tooling.animation.clock.ComposeAnimationClock
    public /* bridge */ /* synthetic */ void setState(AnimatedVisibilityState animatedVisibilityState) {
        m6557setState7IW2chM(animatedVisibilityState.m6564unboximpl());
    }
    ...
    public void m6557setState7IW2chM(String value) {
        this.state = value;
        setClockTime(0L);
    }
    ...
    public void setStateParameters(Object par1, Object par2) {
        ...
        m6557setState7IW2chM(((AnimatedVisibilityState) par1).m6564unboximpl());
    }
    ...
    public void setClockTime(long animationTimeNanos) {
        Transition it = getAnimation().m6551getAnimationObject();
        Pair<Boolean, Boolean> m6555toCurrentTargetPair7IW2chM = m6555toCurrentTargetPair7IW2chM(getState());
        boolean current = m6555toCurrentTargetPair7IW2chM.component1().booleanValue();
        boolean target = m6555toCurrentTargetPair7IW2chM.component2().booleanValue();
    ...
    private final Pair<Boolean, Boolean> m6555toCurrentTargetPair7IW2chM(String $this$toCurrentTargetPair_u2d7IW2chM) {
        return AnimatedVisibilityState.m6561equalsimpl0($this$toCurrentTargetPair_u2d7IW2chM, AnimatedVisibilityState.INSTANCE.m6565getEnterjXw82LU()) ? TuplesKt.to(false, true) : TuplesKt.to(true, false);
    }
}

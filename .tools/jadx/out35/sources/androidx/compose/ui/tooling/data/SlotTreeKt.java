...
public final class SlotTreeKt {
    ...
    */
    private static final androidx.compose.ui.tooling.data.SourceInformationContext sourceInformationContextOf(java.lang.String r17, androidx.compose.ui.tooling.data.SourceInformationContext r18) {
        /*
    ...
    public static final IntRect boundsOfLayoutNode(LayoutInfo node) {
        ...
        long size = coordinates.mo5499getSizeYbymL2g();
        int left = MathKt.roundToInt(Offset.m3922getXimpl(position));
        int top = MathKt.roundToInt(Offset.m3923getYimpl(position));
        int right = IntSize.m6796getWidthimpl(size) + left;
        int bottom = IntSize.m6795getHeightimpl(size) + top;
    ...
    public static final List<ParameterInformation> extractParameterInfo(List<? extends Object> list, SourceInformationContext context) {
        ...
        if (!list.isEmpty()) {
            ...
            if (element$iv != null) {
                try {
                    Field blockField = accessibleField(element$iv.getClass(), "block");
                    if (blockField != null && (block = blockField.get(element$iv)) != null) {
                        ...
                        while (i4 < size) {
                            ...
                            if (metadata.getSortedIndex() >= fields.size()) {
                                ...
                                Field field = (Field) fields.get(metadata.getSortedIndex());
                                ...
                                boolean compared2 = compared;
                                String substring = field.getName().substring(1);
                                Intrinsics.checkNotNullExpressionValue(substring, "this as java.lang.String).substring(startIndex)");
                                parameters.add(new ParameterInformation(substring, value, fromDefault, z, compared2 && !fromDefault, metadata.getInlineClass(), stable));
                            }
                            i4++;
                            block = block2;
                        }

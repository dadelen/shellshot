...
public final class ViewInfoUtil_androidKt {
    ...
    public static final String toDebugString(List<ViewInfo> list, int indentation, Function1<? super ViewInfo, Boolean> function1) {
        ...
        Iterable $this$forEach$iv = CollectionsKt.sortedWith(filterTree(list, function1), ComparisonsKt.compareBy(new Function1<ViewInfo, Comparable<?>>() { // from class: androidx.compose.ui.tooling.ViewInfoUtil_androidKt$toDebugString$2
            @Override // kotlin.jvm.functions.Function1
        ...
        for (Object element$iv : $this$forEach$iv) {
            ...
            if (it.getLocation() != null) {
                StringBuilder append = builder.append(indentString + '|' + it.getFileName() + AbstractJsonLexerKt.COLON + it.getLineNumber());

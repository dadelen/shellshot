...
public final class CornerRadiusKt {
    public static final long CornerRadius(float x, float y) {
        ...
        return CornerRadius.m3891constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }
    ...
    public static final long m3908lerp3Ry4LBc(long start, long stop, float fraction) {
        return CornerRadius(MathHelpersKt.lerp(CornerRadius.m3897getXimpl(start), CornerRadius.m3897getXimpl(stop), fraction), MathHelpersKt.lerp(CornerRadius.m3898getYimpl(start), CornerRadius.m3898getYimpl(stop), fraction));
    }
}

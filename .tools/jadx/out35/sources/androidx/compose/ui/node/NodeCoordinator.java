...
public abstract class NodeCoordinator extends LookaheadCapablePlaceable implements Measurable, LayoutCoordinates, OwnerScope {
    ...
    private static final float[] tmpMatrix = Matrix.m4393constructorimpl$default(null, 1, null);
    private static final HitTestSource PointerInputSource = new HitTestSource() { // from class: androidx.compose.ui.node.NodeCoordinator$Companion$PointerInputSource$1
        ...
        public int mo5722entityTypeOLwlOKw() {
            return NodeKind.m5726constructorimpl(16);
        }
        ...
        public boolean interceptOutOfBoundsChildEvents(Modifier.Node node) {
            ...
            int kind$iv3 = NodeKind.m5726constructorimpl(16);
        ...
        public void mo5721childHitTestYqVAtuI(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
            layoutNode.m5643hitTestM_7yMNQ$ui_release(pointerPosition, hitTestResult, isTouchEvent, isInLayer);
        }
    };
    private static final HitTestSource SemanticsSource = new HitTestSource() { // from class: androidx.compose.ui.node.NodeCoordinator$Companion$SemanticsSource$1
        ...
        public int mo5722entityTypeOLwlOKw() {
            return NodeKind.m5726constructorimpl(8);
        }
        ...
        public void mo5721childHitTestYqVAtuI(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
            layoutNode.m5644hitTestSemanticsM_7yMNQ$ui_release(pointerPosition, hitTestResult, isTouchEvent, isInLayer);
        }
    };
    private Density layerDensity = getLayoutNode().getDensity();
    private LayoutDirection layerLayoutDirection = getLayoutNode().getLayoutDirection();
    private float lastLayerAlpha = 0.8f;
    private long position = IntOffset.INSTANCE.m6764getZeronOccac();
    private final Function2<Canvas, GraphicsLayer, Unit> drawBlock = new Function2<Canvas, GraphicsLayer, Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$drawBlock$1
        ...
        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final void invoke2(final Canvas canvas, final GraphicsLayer parentLayer) {
            ...
            if (isPlaced) {
                ...
                snapshotObserver.observeReads$ui_release(nodeCoordinator2, function1, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$drawBlock$1.1
                    ...
                    public final void invoke2() {
                        NodeCoordinator.this.drawContainedDrawModifiers(canvas, parentLayer);
                    }
                });
    ...
    public interface HitTestSource {
        /* renamed from: childHitTest-YqVAtuI */
        void mo5721childHitTestYqVAtuI(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer);

        /* renamed from: entityType-OLwlOKw */
        int mo5722entityTypeOLwlOKw();
    ...
    public final /* synthetic */ <T> void m5719visitNodesaLcG6gQ(int type, Function1<? super T, Unit> block) {
        int i;
        ...
        Object obj;
        int i3 = 0;
        boolean includeTail$iv4 = NodeKindKt.m5735getIncludeSelfInTraversalH91voCI(type);
    ...
    private final boolean m5698hasNodeH91voCI(int type) {
        Modifier.Node headNode = headNode(NodeKindKt.m5735getIncludeSelfInTraversalH91voCI(type));
        return headNode != null && DelegatableNodeKt.m5611has64DMado(headNode, type);
    }

    /* renamed from: head-H91voCI, reason: not valid java name */
    public final Modifier.Node m5712headH91voCI(int type) {
        boolean includeTail$iv = NodeKindKt.m5735getIncludeSelfInTraversalH91voCI(type);
    ...
    public final long mo5499getSizeYbymL2g() {
    ...
    public void replace$ui_release() {
        ...
        if (explicitLayer != null) {
            mo5552placeAtf8xVGno(getPosition(), this.zIndex, explicitLayer);
        } else {
            mo5492placeAtf8xVGno(getPosition(), this.zIndex, this.layerBlock);
        }
    }
    ...
    protected void onMeasureResultChanged(int width, int height) {
        ...
        if (layer4 != null) {
            layer4.mo5777resizeozmzZPI(IntSizeKt.IntSize(width, height));
        } else if (getLayoutNode().isPlaced() && (nodeCoordinator = this.wrappedBy) != null) {
            nodeCoordinator.invalidateLayer();
        }
        m5553setMeasuredSizeozmzZPI(IntSizeKt.IntSize(width, height));
        if (this.layerBlock != null) {
            updateLayerParameters(false);
        }
        int type$iv4 = NodeKind.m5726constructorimpl(4);
        boolean includeTail$iv$iv = NodeKindKt.m5735getIncludeSelfInTraversalH91voCI(type$iv4);
        ...
        if (includeTail$iv$iv || (stopNode$iv$iv = stopNode$iv$iv.getParent()) != null) {
            ...
            while (node$iv$iv != null && (node$iv$iv.getAggregateChildKindSet() & type$iv4) != 0) {
                if ((node$iv$iv.getKindSet() & type$iv4) == 0) {
                    ...
                    while (node3 != null) {
                        if (node3 instanceof DrawModifierNode) {
                            DrawModifierNode it = (DrawModifierNode) node3;
                            ...
                            if (((this_$iv$iv$iv.getKindSet() & type$iv4) != 0 ? 1 : 0) == 0 || !(node3 instanceof DelegatingNode)) {
                                layer2 = layer4;
                                type$iv2 = type$iv4;
                                node = node3;
                            } else {
    ...
    protected void m5717setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public Object getParentData() {
        ...
        MutableVector mutableVector;
        int i = 64;
        if (!getLayoutNode().getNodes().m5687hasH91voCI$ui_release(NodeKind.m5726constructorimpl(64))) {
            return null;
        }
        ...
        while (node$iv4 != null) {
            ...
            int kind$iv = (node.getKindSet() & NodeKind.m5726constructorimpl(i)) != 0 ? 1 : 0;
            if (kind$iv != 0) {
                int m5726constructorimpl = NodeKind.m5726constructorimpl(i);
                MutableVector mutableVector2 = null;
                Modifier.Node node2 = node;
                while (node2 != null) {
                    if (node2 instanceof ParentDataModifierNode) {
                        ...
                        Modifier.Node this_$iv$iv = node2;
                        if (((this_$iv$iv.getKindSet() & m5726constructorimpl) != 0) && (node2 instanceof DelegatingNode)) {
                            int count$iv2 = 0;
                            DelegatingNode this_$iv$iv2 = (DelegatingNode) node2;
                            Modifier.Node node$iv$iv = this_$iv$iv2.getDelegate();
                            while (node$iv$iv != null) {
                                Modifier.Node next$iv = node$iv$iv;
                                if ((next$iv.getKindSet() & m5726constructorimpl) != 0) {
                                    count$iv2++;
                                    this_$iv3 = this_$iv4;
                                    if (count$iv2 == 1) {
                                        node2 = next$iv;
    ...
    public final long m5710getLastMeasurementConstraintsmsEJaDk$ui_release() {
        return getMeasurementConstraints();
    }

    /* renamed from: performingMeasure-K40F9xA, reason: not valid java name */
    protected final Placeable m5715performingMeasureK40F9xA(long constraints, Function0<? extends Placeable> block) {
    ...
    public final void onMeasured() {
        ...
        if (nodeCoordinator.m5698hasNodeH91voCI(NodeKind.m5726constructorimpl(128))) {
            ...
            int i4 = 0;
            try {
                int type$iv2 = NodeKind.m5726constructorimpl(128);
                NodeCoordinator this_$iv4 = this;
                int i5 = 0;
                boolean includeTail$iv$iv = NodeKindKt.m5735getIncludeSelfInTraversalH91voCI(type$iv2);
                    ...
                    if ((node$iv$iv.getKindSet() & type$iv2) == 0) {
                        ...
                        while (node2 != null) {
                            ...
                            if (node2 instanceof LayoutAwareModifierNode) {
                                ...
                                this_$iv2 = this_$iv4;
                                i3 = i5;
                                it.mo354onRemeasuredozmzZPI(nodeCoordinator.getMeasuredSize());
                            } else {
                                this_$iv2 = this_$iv4;
                                i3 = i5;
    ...
    protected void mo5492placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        if (this.forcePlaceWithLookaheadOffset) {
            ...
            m5702placeSelfMLgxB_4(lookaheadDelegate.getPosition(), zIndex, layerBlock, null);
            return;
        }
        m5702placeSelfMLgxB_4(position, zIndex, layerBlock, null);
    }
    ...
    protected void mo5552placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
        if (this.forcePlaceWithLookaheadOffset) {
            LookaheadDelegate lookaheadDelegate = getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            m5702placeSelfMLgxB_4(lookaheadDelegate.getPosition(), zIndex, null, layer);
            return;
        }
        m5702placeSelfMLgxB_4(position, zIndex, null, layer);
    }

    /* renamed from: placeSelf-MLgxB_4, reason: not valid java name */
    private final void m5702placeSelfMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer explicitLayer) {
        if (explicitLayer != null) {
            ...
            if (this.layer == null) {
                OwnedLayer $this$placeSelf_MLgxB_4_u24lambda_u2413 = LayoutNodeKt.requireOwner(getLayoutNode()).createLayer(this.drawBlock, this.invalidateParentLayer, explicitLayer);
                $this$placeSelf_MLgxB_4_u24lambda_u2413.mo5777resizeozmzZPI(getMeasuredSize());
                $this$placeSelf_MLgxB_4_u24lambda_u2413.mo5776movegyyYBs(position);
                this.layer = $this$placeSelf_MLgxB_4_u24lambda_u2413;
        ...
        if (!IntOffset.m6753equalsimpl0(getPosition(), position)) {
            m5717setPositiongyyYBs(position);
            ...
            if (layer != null) {
                layer.mo5776movegyyYBs(position);
            } else {
                NodeCoordinator nodeCoordinator = this.wrappedBy;
                if (nodeCoordinator != null) {
                    nodeCoordinator.invalidateLayer();
    ...
    public final void m5716placeSelfApparentToRealOffsetMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
        m5702placeSelfMLgxB_4(IntOffset.m6758plusqkQi6aY(position, getApparentToRealOffset()), zIndex, layerBlock, layer);
    }
    ...
    public final void draw(Canvas canvas, GraphicsLayer graphicsLayer) {
        ...
        float x = IntOffset.m6754getXimpl(getPosition());
        float y = IntOffset.m6755getYimpl(getPosition());
    ...
    public final void drawContainedDrawModifiers(Canvas canvas, GraphicsLayer graphicsLayer) {
        Modifier.Node head = m5712headH91voCI(NodeKind.m5726constructorimpl(4));
        if (head == null) {
            performDraw(canvas, graphicsLayer);
        } else {
            LayoutNodeDrawScope drawScope = getLayoutNode().getMDrawScope$ui_release();
            drawScope.m5653draweZhPAX0$ui_release(canvas, IntSizeKt.m6808toSizeozmzZPI(mo5499getSizeYbymL2g()), this, head, graphicsLayer);
        }
    }
    ...
    public final void onPlaced() {
        ...
        int i3;
        MutableVector mutableVector;
        int type$iv3 = NodeKind.m5726constructorimpl(128);
        NodeCoordinator this_$iv4 = this;
        int i4 = 0;
        boolean includeTail$iv$iv = NodeKindKt.m5735getIncludeSelfInTraversalH91voCI(type$iv3);
    ...
    public final void updateLayerBlock(Function1<? super GraphicsLayerScope, Unit> layerBlock, boolean forceUpdateLayerParameters) {
        ...
        if (layoutNode.isAttached() && layerBlock != null) {
            ...
            if (this.layer == null) {
                OwnedLayer $this$updateLayerBlock_u24lambda_u2416 = Owner.createLayer$default(LayoutNodeKt.requireOwner(layoutNode), this.drawBlock, this.invalidateParentLayer, null, 4, null);
                $this$updateLayerBlock_u24lambda_u2416.mo5777resizeozmzZPI(getMeasuredSize());
                $this$updateLayerBlock_u24lambda_u2416.mo5776movegyyYBs(getPosition());
                this.layer = $this$updateLayerBlock_u24lambda_u2416;
    ...
    private final void updateLayerParameters(boolean invokeOnLayoutChange) {
        ...
        if (layer != null) {
            ...
            if (layerBlock != null) {
                ...
                graphicsLayerScope.m4474setSizeuvyYCjk(IntSizeKt.m6808toSizeozmzZPI(mo5499getSizeYbymL2g()));
    ...
    public final long m5711getMinimumTouchTargetSizeNHjbRc() {
        Density $this$getMinimumTouchTargetSize_NH_jbRc_u24lambda_u2421 = this.layerDensity;
        return $this$getMinimumTouchTargetSize_NH_jbRc_u24lambda_u2421.mo365toSizeXkaWNTQ(getLayoutNode().getViewConfiguration().mo5647getMinimumTouchTargetSizeMYxV2XQ());
    }

    /* renamed from: hitTest-YqVAtuI, reason: not valid java name */
    public final void m5713hitTestYqVAtuI(HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        Modifier.Node head = m5712headH91voCI(hitTestSource.mo5722entityTypeOLwlOKw());
        if (!m5720withinLayerBoundsk4lQ0M(pointerPosition)) {
            if (isTouchEvent) {
                float distanceFromEdge = m5708distanceInMinimumTouchTargettz77jQw(pointerPosition, m5711getMinimumTouchTargetSizeNHjbRc());
                if (((Float.isInfinite(distanceFromEdge) || Float.isNaN(distanceFromEdge)) ? false : true) && hitTestResult.isHitInMinimumTouchTargetBetter(distanceFromEdge, false)) {
                    m5700hitNearJHbHoSQ(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, false, distanceFromEdge);
                    return;
                }
                return;
            }
        ...
        if (head == null) {
            mo5635hitTestChildYqVAtuI(hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
            return;
        }
        if (m5714isPointerInBoundsk4lQ0M(pointerPosition)) {
            m5699hit1hIXUjU(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
            return;
        }
        float distanceFromEdge2 = !isTouchEvent ? Float.POSITIVE_INFINITY : m5708distanceInMinimumTouchTargettz77jQw(pointerPosition, m5711getMinimumTouchTargetSizeNHjbRc());
        if (((Float.isInfinite(distanceFromEdge2) || Float.isNaN(distanceFromEdge2)) ? false : true) && hitTestResult.isHitInMinimumTouchTargetBetter(distanceFromEdge2, isInLayer)) {
            m5700hitNearJHbHoSQ(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge2);
        } else {
            m5703speculativeHitJHbHoSQ(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge2);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: hit-1hIXUjU, reason: not valid java name */
    public final void m5699hit1hIXUjU(final Modifier.Node $this$hit_u2d1hIXUjU, final HitTestSource hitTestSource, final long pointerPosition, final HitTestResult hitTestResult, final boolean isTouchEvent, final boolean isInLayer) {
        if ($this$hit_u2d1hIXUjU == null) {
            ...
            hitTestResult.hit($this$hit_u2d1hIXUjU, isInLayer, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$hit$1
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    Modifier.Node m5724nextUntilhw7D004;
                    NodeCoordinator nodeCoordinator = NodeCoordinator.this;
                    m5724nextUntilhw7D004 = NodeCoordinatorKt.m5724nextUntilhw7D004($this$hit_u2d1hIXUjU, hitTestSource.mo5722entityTypeOLwlOKw(), NodeKind.m5726constructorimpl(2));
                    nodeCoordinator.m5699hit1hIXUjU(m5724nextUntilhw7D004, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
                }
            });
        }
    }
    ...
    public final void m5700hitNearJHbHoSQ(final Modifier.Node $this$hitNear_u2dJHbHoSQ, final HitTestSource hitTestSource, final long pointerPosition, final HitTestResult hitTestResult, final boolean isTouchEvent, final boolean isInLayer, final float distanceFromEdge) {
        if ($this$hitNear_u2dJHbHoSQ == null) {
            ...
            hitTestResult.hitInMinimumTouchTarget($this$hitNear_u2dJHbHoSQ, distanceFromEdge, isInLayer, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$hitNear$1
                ...
                public final void invoke2() {
                    Modifier.Node m5724nextUntilhw7D004;
                    NodeCoordinator nodeCoordinator = NodeCoordinator.this;
                    m5724nextUntilhw7D004 = NodeCoordinatorKt.m5724nextUntilhw7D004($this$hitNear_u2dJHbHoSQ, hitTestSource.mo5722entityTypeOLwlOKw(), NodeKind.m5726constructorimpl(2));
                    nodeCoordinator.m5700hitNearJHbHoSQ(m5724nextUntilhw7D004, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
                }
            });
        }
    }
    ...
    public final void m5703speculativeHitJHbHoSQ(final Modifier.Node $this$speculativeHit_u2dJHbHoSQ, final HitTestSource hitTestSource, final long pointerPosition, final HitTestResult hitTestResult, final boolean isTouchEvent, final boolean isInLayer, final float distanceFromEdge) {
        Modifier.Node m5724nextUntilhw7D004;
        if ($this$speculativeHit_u2dJHbHoSQ == null) {
            mo5635hitTestChildYqVAtuI(hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
        } else if (!hitTestSource.interceptOutOfBoundsChildEvents($this$speculativeHit_u2dJHbHoSQ)) {
            m5724nextUntilhw7D004 = NodeCoordinatorKt.m5724nextUntilhw7D004($this$speculativeHit_u2dJHbHoSQ, hitTestSource.mo5722entityTypeOLwlOKw(), NodeKind.m5726constructorimpl(2));
            m5703speculativeHitJHbHoSQ(m5724nextUntilhw7D004, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
        } else {
            hitTestResult.speculativeHit($this$speculativeHit_u2dJHbHoSQ, distanceFromEdge, isInLayer, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$speculativeHit$1
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    Modifier.Node m5724nextUntilhw7D0042;
                    NodeCoordinator nodeCoordinator = NodeCoordinator.this;
                    m5724nextUntilhw7D0042 = NodeCoordinatorKt.m5724nextUntilhw7D004($this$speculativeHit_u2dJHbHoSQ, hitTestSource.mo5722entityTypeOLwlOKw(), NodeKind.m5726constructorimpl(2));
                    nodeCoordinator.m5703speculativeHitJHbHoSQ(m5724nextUntilhw7D0042, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
                }
            });
        }
    }
    ...
    public void mo5635hitTestChildYqVAtuI(HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        NodeCoordinator wrapped = this.wrapped;
        if (wrapped != null) {
            long positionInWrapped = m5697fromParentPosition8S9VItk$default(wrapped, pointerPosition, false, 2, null);
            wrapped.m5713hitTestYqVAtuI(hitTestSource, positionInWrapped, hitTestResult, isTouchEvent, isInLayer);
        }
    }
    ...
    public final Rect touchBoundsInRoot() {
        ...
        long padding = m5707calculateMinimumTouchTargetPaddingE7KxVPU(m5711getMinimumTouchTargetSizeNHjbRc());
        bounds.setLeft(-Size.m3991getWidthimpl(padding));
        bounds.setTop(-Size.m3988getHeightimpl(padding));
        bounds.setRight(getMeasuredWidth() + Size.m3991getWidthimpl(padding));
        bounds.setBottom(getMeasuredHeight() + Size.m3988getHeightimpl(padding));
    ...
    public long mo5505screenToLocalMKHz9U(long relativeToScreen) {
        ...
        long positionInRoot = owner.mo5445screenToLocalMKHz9U(relativeToScreen);
        LayoutCoordinates root = LayoutCoordinatesKt.findRootCoordinates(this);
        return mo5500localPositionOfR5De75A(root, positionInRoot);
    }
    ...
    public long mo5503localToScreenMKHz9U(long relativeToLocal) {
        ...
        long positionInRoot = mo5502localToRootMKHz9U(relativeToLocal);
        Owner owner = LayoutNodeKt.requireOwner(getLayoutNode());
        return owner.mo5444localToScreenMKHz9U(positionInRoot);
    }
    ...
    public long mo5508windowToLocalMKHz9U(long relativeToWindow) {
        ...
        LayoutCoordinates root = LayoutCoordinatesKt.findRootCoordinates(this);
        long positionInRoot = Offset.m3926minusMKHz9U(LayoutNodeKt.requireOwner(getLayoutNode()).mo5779calculateLocalPositionMKHz9U(relativeToWindow), LayoutCoordinatesKt.positionInRoot(root));
        return mo5500localPositionOfR5De75A(root, positionInRoot);
    }
    ...
    public long mo5504localToWindowMKHz9U(long relativeToLocal) {
        long positionInRoot = mo5502localToRootMKHz9U(relativeToLocal);
        Owner owner = LayoutNodeKt.requireOwner(getLayoutNode());
        return owner.mo5780calculatePositionInWindowMKHz9U(positionInRoot);
    }
    ...
    public long mo5501localPositionOfS_NoaFU(LayoutCoordinates sourceCoordinates, long relativeToSource, boolean includeMotionFrameOfReference) {
        if (sourceCoordinates instanceof LookaheadLayoutCoordinates) {
            ...
            return Offset.m3931unaryMinusF1C5BW0(sourceCoordinates.mo5501localPositionOfS_NoaFU(this, Offset.m3931unaryMinusF1C5BW0(relativeToSource), includeMotionFrameOfReference));
        }
        ...
        while (coordinator != commonAncestor) {
            position = coordinator.m5718toParentPosition8S9VItk(position, includeMotionFrameOfReference);
            NodeCoordinator nodeCoordinator2 = coordinator.wrappedBy;
            Intrinsics.checkNotNull(nodeCoordinator2);
            coordinator = nodeCoordinator2;
        }
        return m5696ancestorToLocalS_NoaFU(commonAncestor, position, includeMotionFrameOfReference);
    }
    ...
    public void mo5506transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        ...
        Matrix.m4402resetimpl(matrix);
        coordinator.m5706transformToAncestorEL8BTi8(commonAncestor, matrix);
        m5705transformFromAncestorEL8BTi8(commonAncestor, matrix);
    }
    ...
    public void mo5507transformToScreen58bKbWc(float[] matrix) {
        ...
        m5706transformToAncestorEL8BTi8(rootCoordinator, matrix);
        owner.mo5443localToScreen58bKbWc(matrix);
    }

    /* renamed from: transformToAncestor-EL8BTi8, reason: not valid java name */
    private final void m5706transformToAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        NodeCoordinator wrapper = this;
        while (!Intrinsics.areEqual(wrapper, ancestor)) {
            OwnedLayer ownedLayer = wrapper.layer;
            if (ownedLayer != null) {
                ownedLayer.mo5778transform58bKbWc(matrix);
            }
            long position = wrapper.getPosition();
            if (!IntOffset.m6753equalsimpl0(position, IntOffset.INSTANCE.m6764getZeronOccac())) {
                Matrix.m4402resetimpl(tmpMatrix);
                Matrix.m4413translateimpl$default(tmpMatrix, IntOffset.m6754getXimpl(position), IntOffset.m6755getYimpl(position), 0.0f, 4, null);
                Matrix.m4410timesAssign58bKbWc(matrix, tmpMatrix);
            }
    ...
    private final void m5705transformFromAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        if (!Intrinsics.areEqual(ancestor, this)) {
            NodeCoordinator nodeCoordinator = this.wrappedBy;
            Intrinsics.checkNotNull(nodeCoordinator);
            nodeCoordinator.m5705transformFromAncestorEL8BTi8(ancestor, matrix);
            if (!IntOffset.m6753equalsimpl0(getPosition(), IntOffset.INSTANCE.m6764getZeronOccac())) {
                Matrix.m4402resetimpl(tmpMatrix);
                Matrix.m4413translateimpl$default(tmpMatrix, -IntOffset.m6754getXimpl(getPosition()), -IntOffset.m6755getYimpl(getPosition()), 0.0f, 4, null);
                Matrix.m4410timesAssign58bKbWc(matrix, tmpMatrix);
            }
            OwnedLayer ownedLayer = this.layer;
            if (ownedLayer != null) {
                ownedLayer.mo5773inverseTransform58bKbWc(matrix);
            }
        }
    }
    ...
    public Rect localBoundingBoxOf(LayoutCoordinates sourceCoordinates, boolean clipBounds) {
        ...
        bounds.setLeft(0.0f);
        bounds.setTop(0.0f);
        bounds.setRight(IntSize.m6796getWidthimpl(sourceCoordinates.mo5499getSizeYbymL2g()));
        bounds.setBottom(IntSize.m6795getHeightimpl(sourceCoordinates.mo5499getSizeYbymL2g()));
    ...
    private final long m5696ancestorToLocalS_NoaFU(NodeCoordinator ancestor, long offset, boolean includeMotionFrameOfReference) {
        if (ancestor == this) {
            return offset;
        }
        NodeCoordinator wrappedBy = this.wrappedBy;
        if (wrappedBy == null || Intrinsics.areEqual(ancestor, wrappedBy)) {
            return m5709fromParentPosition8S9VItk(offset, includeMotionFrameOfReference);
        }
        return m5709fromParentPosition8S9VItk(wrappedBy.m5696ancestorToLocalS_NoaFU(ancestor, offset, includeMotionFrameOfReference), includeMotionFrameOfReference);
    }
    ...
    public long mo5502localToRootMKHz9U(long relativeToLocal) {
        ...
        for (NodeCoordinator coordinator = this; coordinator != null; coordinator = coordinator.wrappedBy) {
            position = m5704toParentPosition8S9VItk$default(coordinator, position, false, 2, null);
        }
        return position;
    }
    ...
    public static /* synthetic */ long m5704toParentPosition8S9VItk$default(NodeCoordinator nodeCoordinator, long j, boolean z, int i, Object obj) {
        if (obj != null) {
        ...
        return nodeCoordinator.m5718toParentPosition8S9VItk(j, z);
    }

    /* renamed from: toParentPosition-8S9VItk, reason: not valid java name */
    public long m5718toParentPosition8S9VItk(long position, boolean includeMotionFrameOfReference) {
        OwnedLayer layer = this.layer;
        long targetPosition = layer != null ? layer.mo5775mapOffset8S9VItk(position, false) : position;
        if (!includeMotionFrameOfReference && getIsPlacedUnderMotionFrameOfReference()) {
            return targetPosition;
        }
        return IntOffsetKt.m6768plusNvtHpc(targetPosition, getPosition());
    }

    /* renamed from: fromParentPosition-8S9VItk$default, reason: not valid java name */
    public static /* synthetic */ long m5697fromParentPosition8S9VItk$default(NodeCoordinator nodeCoordinator, long j, boolean z, int i, Object obj) {
        if (obj != null) {
        ...
        return nodeCoordinator.m5709fromParentPosition8S9VItk(j, z);
    }

    /* renamed from: fromParentPosition-8S9VItk, reason: not valid java name */
    public long m5709fromParentPosition8S9VItk(long position, boolean includeMotionFrameOfReference) {
        long relativeToPosition;
        if (!includeMotionFrameOfReference && getIsPlacedUnderMotionFrameOfReference()) {
            relativeToPosition = position;
        } else {
            relativeToPosition = IntOffsetKt.m6766minusNvtHpc(position, getPosition());
        }
        OwnedLayer layer = this.layer;
        return layer != null ? layer.mo5775mapOffset8S9VItk(relativeToPosition, true) : relativeToPosition;
    }

    protected final void drawBorder(Canvas canvas, Paint paint) {
        Rect rect = new Rect(0.5f, 0.5f, IntSize.m6796getWidthimpl(getMeasuredSize()) - 0.5f, IntSize.m6795getHeightimpl(getMeasuredSize()) - 0.5f);
    ...
    public final void rectInParent$ui_release(MutableRect bounds, boolean clipBounds, boolean clipToMinimumTouchTargetSize) {
        ...
        if (layer != null) {
            if (this.isClipping) {
                if (clipToMinimumTouchTargetSize) {
                    long minTouch = m5711getMinimumTouchTargetSizeNHjbRc();
                    float horz = Size.m3991getWidthimpl(minTouch) / 2.0f;
                    float vert = Size.m3988getHeightimpl(minTouch) / 2.0f;
                    bounds.intersect(-horz, -vert, IntSize.m6796getWidthimpl(mo5499getSizeYbymL2g()) + horz, IntSize.m6795getHeightimpl(mo5499getSizeYbymL2g()) + vert);
                } else if (clipBounds) {
                    bounds.intersect(0.0f, 0.0f, IntSize.m6796getWidthimpl(mo5499getSizeYbymL2g()), IntSize.m6795getHeightimpl(mo5499getSizeYbymL2g()));
                }
                if (bounds.isEmpty()) {
                    return;
                }
        ...
        int x = IntOffset.m6754getXimpl(getPosition());
        bounds.setLeft(bounds.getLeft() + x);
        bounds.setRight(bounds.getRight() + x);
        int y = IntOffset.m6755getYimpl(getPosition());
    ...
    protected final boolean m5720withinLayerBoundsk4lQ0M(long pointerPosition) {
        if (!OffsetKt.m3939isFinitek4lQ0M(pointerPosition)) {
            return false;
        }
        OwnedLayer layer = this.layer;
        return layer == null || !this.isClipping || layer.mo5774isInLayerk4lQ0M(pointerPosition);
    }

    /* renamed from: isPointerInBounds-k-4lQ0M, reason: not valid java name */
    protected final boolean m5714isPointerInBoundsk4lQ0M(long pointerPosition) {
        float x = Offset.m3922getXimpl(pointerPosition);
        float y = Offset.m3923getYimpl(pointerPosition);
    ...
    public final NodeCoordinator findCommonAncestor$ui_release(NodeCoordinator other) {
        ...
        if (ancestor1 == ancestor2) {
            ...
            int m5726constructorimpl = NodeKind.m5726constructorimpl(2);
    ...
    public final boolean shouldSharePointerInputWithSiblings() {
        ...
        int count$iv$iv;
        MutableVector mutableVector;
        Modifier.Node start = headNode(NodeKindKt.m5735getIncludeSelfInTraversalH91voCI(NodeKind.m5726constructorimpl(16)));
        if (start != null && start.getIsAttached()) {
            Modifier.Node $this$visitSelfAndLocalDescendants_u2d6rFNWt0$iv = start;
            int type$iv3 = NodeKind.m5726constructorimpl(16);
    ...
    private final long m5701offsetFromEdgeMKHz9U(long pointerPosition) {
        float x = Offset.m3922getXimpl(pointerPosition);
    ...
    protected final long m5707calculateMinimumTouchTargetPaddingE7KxVPU(long minimumTouchTargetSize) {
        float widthDiff = Size.m3991getWidthimpl(minimumTouchTargetSize) - getMeasuredWidth();
        float heightDiff = Size.m3988getHeightimpl(minimumTouchTargetSize) - getMeasuredHeight();
        return SizeKt.Size(Math.max(0.0f, widthDiff / 2.0f), Math.max(0.0f, heightDiff / 2.0f));
    }

    /* renamed from: distanceInMinimumTouchTarget-tz77jQw, reason: not valid java name */
    protected final float m5708distanceInMinimumTouchTargettz77jQw(long pointerPosition, long minimumTouchTargetSize) {
        if (getMeasuredWidth() >= Size.m3991getWidthimpl(minimumTouchTargetSize) && getMeasuredHeight() >= Size.m3988getHeightimpl(minimumTouchTargetSize)) {
            return Float.POSITIVE_INFINITY;
        }
        long m5707calculateMinimumTouchTargetPaddingE7KxVPU = m5707calculateMinimumTouchTargetPaddingE7KxVPU(minimumTouchTargetSize);
        float width = Size.m3991getWidthimpl(m5707calculateMinimumTouchTargetPaddingE7KxVPU);
        float height = Size.m3988getHeightimpl(m5707calculateMinimumTouchTargetPaddingE7KxVPU);
        long offsetFromEdge = m5701offsetFromEdgeMKHz9U(pointerPosition);
        if ((width > 0.0f || height > 0.0f) && Offset.m3922getXimpl(offsetFromEdge) <= width && Offset.m3923getYimpl(offsetFromEdge) <= height) {
            return Offset.m3921getDistanceSquaredimpl(offsetFromEdge);
        }
        return Float.POSITIVE_INFINITY;
    }

...
public final class NodeKind<T> {
    ...
    public static final /* synthetic */ NodeKind m5725boximpl(int i) {
        return new NodeKind(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> int m5726constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m5727equalsimpl(int i, Object obj) {
        return (obj instanceof NodeKind) && i == ((NodeKind) obj).m5733unboximpl();
    }
    ...
    public static String m5732toStringimpl(int i) {
        return "NodeKind(mask=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m5727equalsimpl(this.mask, obj);
    }

    public int hashCode() {
        return m5729hashCodeimpl(this.mask);
    }

    public String toString() {
        return m5732toStringimpl(this.mask);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ int m5733unboximpl() {
        return this.mask;
    }
    ...
    public static final int m5730orH91voCI(int arg0, int other) {
        return arg0 | other;
    }

    /* renamed from: or-impl, reason: not valid java name */
    public static final int m5731orimpl(int arg0, int other) {
        return arg0 | other;
    }
}

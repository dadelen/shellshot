...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node $this$touchBoundsInRoot, boolean useMinimumTouchTarget) {
        ...
        if (!useMinimumTouchTarget) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m5613requireCoordinator64DMado($this$touchBoundsInRoot, NodeKind.m5726constructorimpl(8)));
        }
        return DelegatableNodeKt.m5613requireCoordinator64DMado($this$touchBoundsInRoot, NodeKind.m5726constructorimpl(8)).touchBoundsInRoot();
    }
}

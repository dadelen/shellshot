...
public interface ApproachLayoutModifierNode extends LayoutModifierNode {
    ...
    MeasureResult mo96approachMeasure3p2s80s(ApproachMeasureScope approachMeasureScope, Measurable measurable, long j);

    /* renamed from: isMeasurementApproachInProgress-ozmzZPI */
    boolean mo97isMeasurementApproachInProgressozmzZPI(long lookaheadSize);
    ...
    default MeasureResult mo84measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        final Placeable $this$measure_3p2s80s_u24lambda_u240 = measurable.mo5491measureBRTryo0(constraints);
    ...
    default int minApproachIntrinsicWidth(ApproachIntrinsicMeasureScope $this$minApproachIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
        return NodeMeasuringIntrinsics.INSTANCE.minWidth$ui_release(new NodeMeasuringIntrinsics.ApproachMeasureBlock() { // from class: androidx.compose.ui.layout.ApproachLayoutModifierNode$minApproachIntrinsicWidth$1
            ...
            /* renamed from: measure-3p2s80s */
            public final MeasureResult mo5467measure3p2s80s(ApproachMeasureScope $this$ApproachMeasureBlock, Measurable intrinsicMeasurable, long constraints) {
                return ApproachLayoutModifierNode.this.mo96approachMeasure3p2s80s($this$ApproachMeasureBlock, intrinsicMeasurable, constraints);
            }

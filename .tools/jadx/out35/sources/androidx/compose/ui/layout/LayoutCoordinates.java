...
public interface LayoutCoordinates {
    ...
    long mo5500localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long relativeToSource);

    /* renamed from: localToRoot-MK-Hz9U, reason: not valid java name */
    long mo5502localToRootMKHz9U(long relativeToLocal);

    /* renamed from: localToWindow-MK-Hz9U, reason: not valid java name */
    long mo5504localToWindowMKHz9U(long relativeToLocal);

    /* renamed from: windowToLocal-MK-Hz9U, reason: not valid java name */
    long mo5508windowToLocalMKHz9U(long relativeToWindow);
    ...
    public static final class DefaultImpls {
        ...
        public static long m5512screenToLocalMKHz9U(LayoutCoordinates $this, long relativeToScreen) {
            return LayoutCoordinates.super.mo5505screenToLocalMKHz9U(relativeToScreen);
        }

        @Deprecated
        /* renamed from: localToScreen-MK-Hz9U, reason: not valid java name */
        public static long m5511localToScreenMKHz9U(LayoutCoordinates $this, long relativeToLocal) {
            return LayoutCoordinates.super.mo5503localToScreenMKHz9U(relativeToLocal);
        }

        @Deprecated
        /* renamed from: localPositionOf-S_NoaFU, reason: not valid java name */
        public static long m5509localPositionOfS_NoaFU(LayoutCoordinates $this, LayoutCoordinates sourceCoordinates, long relativeToSource, boolean includeMotionFrameOfReference) {
            return LayoutCoordinates.super.mo5501localPositionOfS_NoaFU(sourceCoordinates, relativeToSource, includeMotionFrameOfReference);
        }

        @Deprecated
        /* renamed from: transformFrom-EL8BTi8, reason: not valid java name */
        public static void m5513transformFromEL8BTi8(LayoutCoordinates $this, LayoutCoordinates sourceCoordinates, float[] matrix) {
            LayoutCoordinates.super.mo5506transformFromEL8BTi8(sourceCoordinates, matrix);
        }

        @Deprecated
        /* renamed from: transformToScreen-58bKbWc, reason: not valid java name */
        public static void m5514transformToScreen58bKbWc(LayoutCoordinates $this, float[] matrix) {
            LayoutCoordinates.super.mo5507transformToScreen58bKbWc(matrix);
        }
    }
    ...
    /* renamed from: screenToLocal-MK-Hz9U, reason: not valid java name */
    default long mo5505screenToLocalMKHz9U(long relativeToScreen) {
        return Offset.INSTANCE.m3937getUnspecifiedF1C5BW0();
    }

    /* renamed from: localToScreen-MK-Hz9U, reason: not valid java name */
    default long mo5503localToScreenMKHz9U(long relativeToLocal) {
        return Offset.INSTANCE.m3937getUnspecifiedF1C5BW0();
    }

    /* renamed from: localPositionOf-S_NoaFU$default, reason: not valid java name */
    static /* synthetic */ long m5498localPositionOfS_NoaFU$default(LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2, long j, boolean z, int i, Object obj) {
        if (obj != null) {
        ...
        return layoutCoordinates.mo5501localPositionOfS_NoaFU(layoutCoordinates2, j, z);
    }

    /* renamed from: localPositionOf-S_NoaFU, reason: not valid java name */
    default long mo5501localPositionOfS_NoaFU(LayoutCoordinates sourceCoordinates, long relativeToSource, boolean includeMotionFrameOfReference) {
    ...
    /* renamed from: transformFrom-EL8BTi8, reason: not valid java name */
    default void mo5506transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        throw new UnsupportedOperationException("transformFrom is not implemented on this LayoutCoordinates");
    }

    /* renamed from: transformToScreen-58bKbWc, reason: not valid java name */
    default void mo5507transformToScreen58bKbWc(float[] matrix) {

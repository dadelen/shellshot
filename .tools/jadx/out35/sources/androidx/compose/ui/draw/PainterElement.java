...
final /* data */ class PainterElement extends ModifierNodeElement<PainterModifier> {
    ...
    public void update(PainterModifier node) {
        boolean intrinsicsChanged = node.getSizeToIntrinsics() != this.sizeToIntrinsics || (this.sizeToIntrinsics && !Size.m3987equalsimpl0(node.getPainter().mo4832getIntrinsicSizeNHjbRc(), this.painter.mo4832getIntrinsicSizeNHjbRc()));

    ...
    public void Content(Composer $composer, final int $changed) {
        ...
        if (($dirty & 3) != 2 || !$composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(420213850, $dirty, -1, "androidx.compose.ui.platform.ComposeView.Content (ComposeView.android.kt:439)");
            }
            Function2<Composer, Integer, Unit> value = this.content.getValue();
            if (value == null) {
                $composer2.startReplaceGroup(358373017);
            } else {
                $composer2.startReplaceGroup(150107752);
                ComposerKt.sourceInformation($composer2, "440@18080L8");

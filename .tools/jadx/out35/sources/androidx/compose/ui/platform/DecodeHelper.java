...
public final class DecodeHelper {
    ...
    public final SpanStyle decodeSpanStyle() {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (decodeByte == 1) {
                ...
                mutableSpanStyle.m5863setColor8_81llA(m5831decodeColor0d7_KjU());
            } else if (decodeByte == 2) {
                if (dataAvailable() < 5) {
                    break;
                }
                mutableSpanStyle.m5864setFontSizeR2X_6o(m5834decodeTextUnitXSAIIZE());
                ...
                mutableSpanStyle.m5865setFontStylemLjRB2g(FontStyle.m6198boximpl(m5832decodeFontStyle_LCdwA()));
            } else if (decodeByte == 5) {
                if (dataAvailable() < 1) {
                    break;
                }
                mutableSpanStyle.m5866setFontSynthesistDdu0R4(FontSynthesis.m6209boximpl(m5833decodeFontSynthesisGVVA2EU()));
                ...
                mutableSpanStyle.m5867setLetterSpacingR2X_6o(m5834decodeTextUnitXSAIIZE());
            } else if (decodeByte == 8) {
                if (dataAvailable() < 4) {
                    break;
                }
                mutableSpanStyle.m5862setBaselineShift_isdbwI(BaselineShift.m6377boximpl(m5829decodeBaselineShifty9eOQZs()));
                ...
                mutableSpanStyle.m5861setBackground8_81llA(m5831decodeColor0d7_KjU());
    ...
    public final long m5831decodeColor0d7_KjU() {
        return Color.m4159constructorimpl(m5830decodeULongsVKNKU());
    }

    /* renamed from: decodeTextUnit-XSAIIZE, reason: not valid java name */
    public final long m5834decodeTextUnitXSAIIZE() {
        long type;
        byte decodeByte = decodeByte();
        if (decodeByte == 1) {
            type = TextUnitType.INSTANCE.m6852getSpUIouoOA();
        } else {
            type = decodeByte == 2 ? TextUnitType.INSTANCE.m6851getEmUIouoOA() : TextUnitType.INSTANCE.m6853getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m6847equalsimpl0(type, TextUnitType.INSTANCE.m6853getUnspecifiedUIouoOA())) {
            return TextUnit.INSTANCE.m6830getUnspecifiedXSAIIZE();
        }
        float value = decodeFloat();
        return TextUnitKt.m6831TextUnitanM5pPY(value, type);
    }
    ...
    public final int m5832decodeFontStyle_LCdwA() {
        byte decodeByte = decodeByte();
        return decodeByte == 0 ? FontStyle.INSTANCE.m6208getNormal_LCdwA() : decodeByte == 1 ? FontStyle.INSTANCE.m6207getItalic_LCdwA() : FontStyle.INSTANCE.m6208getNormal_LCdwA();
    }

    /* renamed from: decodeFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m5833decodeFontSynthesisGVVA2EU() {
        byte decodeByte = decodeByte();
        return decodeByte == 0 ? FontSynthesis.INSTANCE.m6219getNoneGVVA2EU() : decodeByte == 1 ? FontSynthesis.INSTANCE.m6218getAllGVVA2EU() : decodeByte == 3 ? FontSynthesis.INSTANCE.m6220getStyleGVVA2EU() : decodeByte == 2 ? FontSynthesis.INSTANCE.m6221getWeightGVVA2EU() : FontSynthesis.INSTANCE.m6219getNoneGVVA2EU();
    }

    /* renamed from: decodeBaselineShift-y9eOQZs, reason: not valid java name */
    private final float m5829decodeBaselineShifty9eOQZs() {
        return BaselineShift.m6378constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        return new Shadow(m5831decodeColor0d7_KjU(), OffsetKt.Offset(decodeFloat(), decodeFloat()), decodeFloat(), null);
    }
    ...
    private final long m5830decodeULongsVKNKU() {
        return ULong.m7386constructorimpl(this.parcel.readLong());
    }

...
public final class FocusRequester {
    ...
    public final boolean findFocusTargetNode$ui_release(Function1<? super FocusTargetNode, Boolean> onFound) {
        ...
        boolean m3883findChildCorrespondingToFocusEnterOMvw8;
        int i;
        ...
        if (size$iv$iv > 0) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if ((branch$iv$iv$iv.getAggregateChildKindSet() & m5726constructorimpl) != 0) {
                                ...
                                while (node != null) {
                                    ...
                                    if (node instanceof FocusTargetNode) {
                                        ...
                                        if (it$iv.fetchFocusProperties$ui_release().getCanFocus()) {
                                            m3883findChildCorrespondingToFocusEnterOMvw8 = function1.invoke(it$iv).booleanValue();
                                            child$iv$iv$iv = child$iv$iv$iv2;
                                        } else {
                                            child$iv$iv$iv = child$iv$iv$iv2;
                                            m3883findChildCorrespondingToFocusEnterOMvw8 = TwoDimensionalFocusSearchKt.m3883findChildCorrespondingToFocusEnterOMvw8(it$iv, FocusDirection.INSTANCE.m3841getEnterdhqQ8s(), function1);
                                        }
                                        if (m3883findChildCorrespondingToFocusEnterOMvw8) {
                                            success$iv = true;
                                            break;
                                        }
                                        i = i3;
                                        ...
                                        if (((this_$iv$iv$iv$iv3.getKindSet() & m5726constructorimpl) != 0 ? i3 : 0) == 0 || !(node instanceof DelegatingNode)) {
                                            i = i3;
                                        } else {
                                            ...
                                            while (node$iv$iv$iv$iv != null) {
                                                ...
                                                if (((next$iv$iv$iv.getKindSet() & m5726constructorimpl) != 0 ? i3 : 0) != 0) {
                                                    count$iv$iv$iv2++;
    ...
    */
    public final boolean saveFocusedChild() {
        ...
        L17:
            ...
            androidx.compose.ui.focus.FocusRequesterModifierNode r5 = (androidx.compose.ui.focus.FocusRequesterModifierNode) r5
            r6 = 0
            boolean r7 = androidx.compose.ui.focus.FocusRequesterModifierNodeKt.saveFocusedChild(r5)
            if (r7 == 0) goto L24
            r7 = 1
            return r7
        L24:
        ...
        L2d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.focus.FocusRequester.saveFocusedChild():boolean");
    }
    ...
    private final boolean findFocusTarget(Function1<? super FocusTargetNode, Boolean> onFound) {
        ...
        if (size$iv > 0) {
            ...
            while (true) {
                ...
                DelegatableNode $this$visitChildren_u2d6rFNWt0$iv = node4;
                int m5726constructorimpl = NodeKind.m5726constructorimpl(1024);
                            ...
                            if ((node$iv$iv.getKindSet() & m5726constructorimpl) != 0) {
                                ...
                                while (node5 != null) {
                                    ...
                                    if (node5 instanceof FocusTargetNode) {
                                        ...
                                        child$iv$iv = child$iv$iv2;
                                        Modifier.Node this_$iv$iv$iv2 = node5;
                                        if (((this_$iv$iv$iv2.getKindSet() & m5726constructorimpl) != 0 ? i3 : 0) == 0 || !(node5 instanceof DelegatingNode)) {
                                            success = success3;
                                            node = node5;
                                            i = i3;
                                        } else {
                                            int count$iv$iv2 = 0;
                                            DelegatingNode this_$iv$iv$iv3 = (DelegatingNode) node5;
                                            Modifier.Node node$iv$iv$iv = this_$iv$iv$iv3.getDelegate();
                                            while (node$iv$iv$iv != null) {
                                                Modifier.Node next$iv$iv = node$iv$iv$iv;
                                                if (((next$iv$iv.getKindSet() & m5726constructorimpl) != 0 ? i3 : 0) != 0) {
                                                    count$iv$iv2++;
                                                    if (count$iv$iv2 == i3) {
                                                        success2 = success3;
                                                        node2 = next$iv$iv;

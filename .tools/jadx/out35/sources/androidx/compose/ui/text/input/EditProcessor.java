...
public final class EditProcessor {
    ...
    private TextFieldValue mBufferState = new TextFieldValue(AnnotatedStringKt.emptyAnnotatedString(), TextRange.INSTANCE.m6097getZerod9O1mEE(), (TextRange) null, (DefaultConstructorMarker) null);
    ...
    public final void reset(TextFieldValue value, TextInputSession textInputSession) {
        ...
        boolean compositionChanged = !Intrinsics.areEqual(value.getComposition(), this.mBuffer.m6250getCompositionMzsxiRA$ui_text_release());
        if (!Intrinsics.areEqual(this.mBufferState.getText(), value.getText())) {
            ...
            textChanged = true;
        } else if (!TextRange.m6085equalsimpl0(this.mBufferState.getSelection(), value.getSelection())) {
            this.mBuffer.setSelection$ui_text_release(TextRange.m6090getMinimpl(value.getSelection()), TextRange.m6089getMaximpl(value.getSelection()));
            selectionChanged = true;
        }
        if (value.getComposition() == null) {
            this.mBuffer.commitComposition$ui_text_release();
        } else if (!TextRange.m6086getCollapsedimpl(value.getComposition().getPackedValue())) {
            this.mBuffer.setComposition$ui_text_release(TextRange.m6090getMinimpl(value.getComposition().getPackedValue()), TextRange.m6089getMaximpl(value.getComposition().getPackedValue()));
        }
        if (textChanged || (!selectionChanged && compositionChanged)) {
            this.mBuffer.commitComposition$ui_text_release();
            value = TextFieldValue.m6333copy3r_uNRQ$default(value, (AnnotatedString) null, 0L, (TextRange) null, 3, (Object) null);
        }
    ...
    public final TextFieldValue apply(List<? extends EditCommand> editCommands) {
        ...
        try {
            ...
            long $this$apply_u24lambda_u242 = this.mBuffer.m6251getSelectiond9O1mEE$ui_text_release();
            TextRange m6080boximpl = TextRange.m6080boximpl($this$apply_u24lambda_u242);
            m6080boximpl.getPackedValue();
            if (TextRange.m6091getReversedimpl(this.mBufferState.getSelection())) {
                m6080boximpl = null;
            }
            TextFieldValue newState = new TextFieldValue(annotatedString$ui_text_release, m6080boximpl != null ? m6080boximpl.getPackedValue() : TextRangeKt.TextRange(TextRange.m6089getMaximpl($this$apply_u24lambda_u242), TextRange.m6090getMinimpl($this$apply_u24lambda_u242)), this.mBuffer.m6250getCompositionMzsxiRA$ui_text_release(), (DefaultConstructorMarker) null);
    ...
    private final String generateBatchErrorMessage(List<? extends EditCommand> editCommands, final EditCommand failedCommand) {
        ...
        StringBuilder append = $this$generateBatchErrorMessage_u24lambda_u243.append("Error while applying EditCommand batch to buffer (length=" + this.mBuffer.getLength$ui_text_release() + ", composition=" + this.mBuffer.m6250getCompositionMzsxiRA$ui_text_release() + ", selection=" + ((Object) TextRange.m6095toStringimpl(this.mBuffer.m6251getSelectiond9O1mEE$ui_text_release())) + "):");
        Intrinsics.checkNotNullExpressionValue(append, "append(value)");
        Intrinsics.checkNotNullExpressionValue(append.append('\n'), "append('\\n')");
        CollectionsKt.joinTo(editCommands, $this$generateBatchErrorMessage_u24lambda_u243, (r14 & 2) != 0 ? ", " : "\n", (r14 & 4) != 0 ? "" : null, (r14 & 8) != 0 ? "" : null, (r14 & 16) != 0 ? -1 : 0, (r14 & 32) != 0 ? "..." : null, (r14 & 64) != 0 ? null : new Function1<EditCommand, CharSequence>() { // from class: androidx.compose.ui.text.input.EditProcessor$generateBatchErrorMessage$1$1

...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        if (fontFamily == null ? true : fontFamily instanceof DefaultFontFamily) {
            result = this.platformTypefaceResolver.mo6228createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m6246getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            result = this.platformTypefaceResolver.mo6229createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m6246getFontStyle_LCdwA());
        } else {
            ...
            result = ((AndroidTypeface) typeface).mo6341getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m6246getFontStyle_LCdwA(), typefaceRequest.m6247getFontSynthesisGVVA2EU());
        }

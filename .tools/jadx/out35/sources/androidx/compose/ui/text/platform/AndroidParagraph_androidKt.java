...
public final class AndroidParagraph_androidKt {
    ...
    public static final Paragraph ActualParagraph(String text, TextStyle style, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int maxLines, boolean ellipsis, float width, Density density, Font.ResourceLoader resourceLoader) {
        return new AndroidParagraph(new AndroidParagraphIntrinsics(text, style, list, list2, DelegatingFontLoaderForDeprecatedUsage_androidKt.createFontFamilyResolver(resourceLoader), density), maxLines, ellipsis, ConstraintsKt.Constraints$default(0, ParagraphKt.ceilToInt(width), 0, 0, 13, null), null);
    }

    /* renamed from: ActualParagraph-O3s9Psw, reason: not valid java name */
    public static final Paragraph m6350ActualParagraphO3s9Psw(String text, TextStyle style, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int maxLines, boolean ellipsis, long constraints, Density density, FontFamily.Resolver fontFamilyResolver) {
        return new AndroidParagraph(new AndroidParagraphIntrinsics(text, style, list, list2, fontFamilyResolver, density), maxLines, ellipsis, constraints, null);
    }

    /* renamed from: ActualParagraph--hBUhpc, reason: not valid java name */
    public static final Paragraph m6349ActualParagraphhBUhpc(ParagraphIntrinsics paragraphIntrinsics, int maxLines, boolean ellipsis, long constraints) {

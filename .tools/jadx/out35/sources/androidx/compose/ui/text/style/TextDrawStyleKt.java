...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle start, TextForegroundStyle stop, float fraction) {
        if (!(start instanceof BrushStyle) && !(stop instanceof BrushStyle)) {
            return TextForegroundStyle.INSTANCE.m6514from8_81llA(ColorKt.m4214lerpjxsXWHM(start.mo6391getColor0d7_KjU(), stop.mo6391getColor0d7_KjU(), fraction));
        }
        if ((start instanceof BrushStyle) && (stop instanceof BrushStyle)) {
    ...
    public static final long m6513modulateDxMtmZc(long $this$modulate_u2dDxMtmZc, float alpha) {
        ...
        if (Float.isNaN(alpha)) {
            ...
            if (alpha < 1.0f) {
                $this$modulate_u2dDxMtmZc3 = Color.m4161copywmQWz5c($this$modulate_u2dDxMtmZc, (r12 & 1) != 0 ? Color.m4165getAlphaimpl($this$modulate_u2dDxMtmZc) : Color.m4165getAlphaimpl($this$modulate_u2dDxMtmZc) * alpha, (r12 & 2) != 0 ? Color.m4169getRedimpl($this$modulate_u2dDxMtmZc) : 0.0f, (r12 & 4) != 0 ? Color.m4168getGreenimpl($this$modulate_u2dDxMtmZc) : 0.0f, (r12 & 8) != 0 ? Color.m4166getBlueimpl($this$modulate_u2dDxMtmZc) : 0.0f);

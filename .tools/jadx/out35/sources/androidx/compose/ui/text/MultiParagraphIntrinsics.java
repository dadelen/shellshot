...
public final class MultiParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public MultiParagraphIntrinsics(AnnotatedString annotatedString, TextStyle style, List<AnnotatedString.Range<Placeholder>> list, Density density, FontFamily.Resolver fontFamilyResolver) {
        ...
        while (index$iv$iv$iv < size) {
            ...
            List<AnnotatedString.Range<SpanStyle>> spanStyles = annotatedString$iv.getSpanStyles();
            ...
            target$iv$iv.add(new ParagraphIntrinsicInfo(ParagraphIntrinsicsKt.ParagraphIntrinsics(text, merge, spanStyles, (List<AnnotatedString.Range<Placeholder>>) localPlaceholders, density, fontFamilyResolver), paragraphStyleRange$iv.getStart(), paragraphStyleRange$iv.getEnd()));
            index$iv$iv$iv++;
            $i$f$mapEachParagraphStyle = $i$f$mapEachParagraphStyle2;
            paragraphStyle = paragraphStyle;
            $this$mapEachParagraphStyle$iv = $this$mapEachParagraphStyle$iv;
        }
    ...
    public final ParagraphStyle resolveTextDirection(ParagraphStyle style, ParagraphStyle defaultStyle) {
        return !TextDirection.m6503equalsimpl0(style.getTextDirection(), TextDirection.INSTANCE.m6512getUnspecifieds_7Xco()) ? style : ParagraphStyle.m5982copyykzQM6k$default(style, 0, defaultStyle.getTextDirection(), 0L, null, null, null, 0, 0, null, 509, null);
    }
}

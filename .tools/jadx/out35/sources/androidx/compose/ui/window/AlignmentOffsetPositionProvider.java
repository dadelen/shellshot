...
public final class AlignmentOffsetPositionProvider implements PopupPositionProvider {
    ...
    public long mo336calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        long anchorAlignmentPoint = this.alignment.mo3768alignKFBX0sM(IntSize.INSTANCE.m6801getZeroYbymL2g(), anchorBounds.m6780getSizeYbymL2g(), layoutDirection);
        long popupAlignmentPoint = IntOffset.m6762unaryMinusnOccac(this.alignment.mo3768alignKFBX0sM(IntSize.INSTANCE.m6801getZeroYbymL2g(), popupContentSize, layoutDirection));
        long resolvedUserOffset = IntOffsetKt.IntOffset(IntOffset.m6754getXimpl(this.offset) * (layoutDirection == LayoutDirection.Ltr ? 1 : -1), IntOffset.m6755getYimpl(this.offset));
        return IntOffset.m6758plusqkQi6aY(IntOffset.m6758plusqkQi6aY(IntOffset.m6758plusqkQi6aY(anchorBounds.m6782getTopLeftnOccac(), anchorAlignmentPoint), popupAlignmentPoint), resolvedUserOffset);
    }
}

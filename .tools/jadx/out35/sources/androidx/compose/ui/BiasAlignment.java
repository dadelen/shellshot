...
public final /* data */ class BiasAlignment implements Alignment {
    ...
    public long mo3768alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        float centerX = (IntSize.m6796getWidthimpl(space) - IntSize.m6796getWidthimpl(size)) / 2.0f;
        float centerY = (IntSize.m6795getHeightimpl(space) - IntSize.m6795getHeightimpl(size)) / 2.0f;

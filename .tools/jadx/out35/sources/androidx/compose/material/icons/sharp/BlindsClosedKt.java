...
public final class BlindsClosedKt {
    ...
    public static final ImageVector getBlindsClosed(Icons.Sharp $this$BlindsClosed) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _blindsClosed = ImageVector.Builder.m4846addPathoIyEayM$default($this$_get_BlindsClosed__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();

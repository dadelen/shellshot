...
public final class _3pKt {
    ...
    public static final ImageVector get_3p(Icons.Sharp $this$_3p) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        __3p = ImageVector.Builder.m4846addPathoIyEayM$default($this$_get__3p__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();

...
public final class CameraAltKt {
    ...
    public static final ImageVector getCameraAlt(Icons.Sharp $this$CameraAlt) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.arcToRelative(3.0f, 3.0f, 0.0f, true, true, -6.0f, 0.0f);
        ImageVector.Builder.m4846addPathoIyEayM$default($this$_get_CameraAlt__u24lambda_u242, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);

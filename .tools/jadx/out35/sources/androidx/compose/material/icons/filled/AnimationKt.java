...
public final class AnimationKt {
    ...
    public static final ImageVector getAnimation(Icons.Filled $this$Animation) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 1.12f, -0.37f, 2.16f, -1.0f, 3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _animation = ImageVector.Builder.m4846addPathoIyEayM$default($this$_get_Animation__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();

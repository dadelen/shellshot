...
public final class _6kPlusKt {
    ...
    public static final ImageVector get_6kPlus(Icons.Sharp $this$_6kPlus) {
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineTo(12.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        __6kPlus = ImageVector.Builder.m4846addPathoIyEayM$default($this$_get__6kPlus__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();

...
public final class SnackbarDefaults {
    ...
    public final long getBackgroundColor(Composer $composer, int $changed) {
        ...
        m4161copywmQWz5c = Color.m4161copywmQWz5c(r2, (r12 & 1) != 0 ? Color.m4165getAlphaimpl(r2) : 0.8f, (r12 & 2) != 0 ? Color.m4169getRedimpl(r2) : 0.0f, (r12 & 4) != 0 ? Color.m4168getGreenimpl(r2) : 0.0f, (r12 & 8) != 0 ? Color.m4166getBlueimpl(MaterialTheme.INSTANCE.getColors($composer, 6).m1477getOnSurface0d7_KjU()) : 0.0f);
        long m4208compositeOverOWjLjI = ColorKt.m4208compositeOverOWjLjI(m4161copywmQWz5c, MaterialTheme.INSTANCE.getColors($composer, 6).m1482getSurface0d7_KjU());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        return m4208compositeOverOWjLjI;
    }
    ...
    public final long getPrimaryActionColor(Composer $composer, int $changed) {
        ...
        if (colors.isLight()) {
            long primary2 = colors.m1478getPrimary0d7_KjU();
            overlayColor = Color.m4161copywmQWz5c(r3, (r12 & 1) != 0 ? Color.m4165getAlphaimpl(r3) : 0.6f, (r12 & 2) != 0 ? Color.m4169getRedimpl(r3) : 0.0f, (r12 & 4) != 0 ? Color.m4168getGreenimpl(r3) : 0.0f, (r12 & 8) != 0 ? Color.m4166getBlueimpl(colors.m1482getSurface0d7_KjU()) : 0.0f);
            primary = ColorKt.m4208compositeOverOWjLjI(overlayColor, primary2);
        } else {
            primary = colors.m1479getPrimaryVariant0d7_KjU();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }

...
final class DefaultChipColors implements ChipColors {
    ...
    public State<Color> backgroundColor(boolean enabled, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation($composer, "C(backgroundColor)599@26739L79:Chip.kt#jmzs0o");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1593588247, $changed, -1, "androidx.compose.material.DefaultChipColors.backgroundColor (Chip.kt:598)");
        }
    ...
    public State<Color> contentColor(boolean enabled, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation($composer, "C(contentColor)604@26921L73:Chip.kt#jmzs0o");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(483145880, $changed, -1, "androidx.compose.material.DefaultChipColors.contentColor (Chip.kt:603)");
        }
    ...
    public State<Color> leadingIconContentColor(boolean enabled, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation($composer, "C(leadingIconContentColor)609@27108L117:Chip.kt#jmzs0o");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1955749013, $changed, -1, "androidx.compose.material.DefaultChipColors.leadingIconContentColor (Chip.kt:608)");
        }
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4153boximpl(enabled ? this.leadingIconContentColor : this.disabledLeadingIconContentColor), $composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m4164equalsimpl0(this.backgroundColor, ((DefaultChipColors) other).backgroundColor) && Color.m4164equalsimpl0(this.contentColor, ((DefaultChipColors) other).contentColor) && Color.m4164equalsimpl0(this.leadingIconContentColor, ((DefaultChipColors) other).leadingIconContentColor) && Color.m4164equalsimpl0(this.disabledBackgroundColor, ((DefaultChipColors) other).disabledBackgroundColor) && Color.m4164equalsimpl0(this.disabledContentColor, ((DefaultChipColors) other).disabledContentColor) && Color.m4164equalsimpl0(this.disabledLeadingIconContentColor, ((DefaultChipColors) other).disabledLeadingIconContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((result * 31) + Color.m4170hashCodeimpl(this.contentColor)) * 31) + Color.m4170hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m4170hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m4170hashCodeimpl(this.disabledContentColor)) * 31) + Color.m4170hashCodeimpl(this.disabledLeadingIconContentColor);
    }
}

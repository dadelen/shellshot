...
public final class ComposableMethodKt {
    ...
    private static final ComposableInfo getComposableInfo(Method method) {
        ...
        int changedParamCount = changedParamCount(i, !Modifier.isStatic(method.getModifiers()) ? 1 : 0);
        int i3 = i + 1 + changedParamCount;
        int length2 = method.getParameterTypes().length;
        if ((length2 != i3) != false) {
            i2 = defaultParamCount(i);
        } else {
            i2 = 0;
        }
        return new ComposableInfo(i3 + i2 == length2, i, changedParamCount, i2);
    }

...
public final class Updater<T> {
    ...
    public static final /* synthetic */ Updater m3655boximpl(Composer composer) {
        return new Updater(composer);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m3656constructorimpl(Composer composer) {
        return composer;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3657equalsimpl(Composer composer, Object obj) {
        return (obj instanceof Updater) && Intrinsics.areEqual(composer, ((Updater) obj).getComposer());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3658equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m3659hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3664toStringimpl(Composer composer) {
        return "Updater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m3657equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m3659hashCodeimpl(this.composer);
    }

    public String toString() {
        return m3664toStringimpl(this.composer);
    }
    ...
    public static final void m3662setimpl(Composer arg0, int value, Function2<? super T, ? super Integer, Unit> function2) {
    ...
    /* renamed from: set-impl, reason: not valid java name */
    public static final <V> void m3663setimpl(Composer arg0, V v, Function2<? super T, ? super V, Unit> function2) {
    ...
    public static final void m3665updateimpl(Composer arg0, int value, Function2<? super T, ? super Integer, Unit> function2) {
    ...
    /* renamed from: update-impl, reason: not valid java name */
    public static final <V> void m3666updateimpl(Composer arg0, V v, Function2<? super T, ? super V, Unit> function2) {
        boolean inserting = arg0.getInserting();
    ...
    public static final void m3660initimpl(Composer arg0, final Function1<? super T, Unit> function1) {
    ...
    public static final void m3661reconcileimpl(Composer arg0, final Function1<? super T, Unit> function1) {

...
public final class NestedMutableSnapshot extends MutableSnapshot {
    ...
    public NestedMutableSnapshot(int id, SnapshotIdSet invalid, Function1<Object, Unit> function1, Function1<Object, Unit> function12, MutableSnapshot parent) {
        ...
        this.parent = parent;
        this.parent.mo3750nestedActivated$runtime_release(this);
    }
    ...
    */
    public androidx.compose.runtime.snapshots.SnapshotApplyResult apply() {
        /*
            ...
            goto Lda
        L12:
            androidx.collection.MutableScatterSet r0 = r13.getModified$runtime_release()
            int r1 = r13.getId()
            r2 = 0
            if (r0 == 0) goto L2d
        ...
        L2e:
            ...
            if (r0 == 0) goto L7f
            int r8 = r0.get_size()     // Catch: java.lang.Throwable -> Ld7
            if (r8 != 0) goto L46
            goto L7f
        L46:
        ...
        L60:
            androidx.compose.runtime.snapshots.MutableSnapshot r9 = r13.parent     // Catch: java.lang.Throwable -> Ld7
            androidx.collection.MutableScatterSet r9 = r9.getModified$runtime_release()     // Catch: java.lang.Throwable -> Ld7
            if (r9 == 0) goto L72
            r10 = r9
            r11 = 0
            r12 = r0
            androidx.collection.ScatterSet r12 = (androidx.collection.ScatterSet) r12     // Catch: java.lang.Throwable -> Ld7
    ...
    private final void deactivate() {
        if (!this.deactivated) {
            ...
            this.parent.mo3751nestedDeactivated$runtime_release(this);
        }
    }
}

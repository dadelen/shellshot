        ...
        while (true) {
            ...
            synchronized (lock$iv$iv$iv$iv$iv$iv) {
                try {
                    ...
                    SnapshotStateMap.StateMapStateRecord $this$mutate_u24lambda_u2415$iv$iv = (SnapshotStateMap.StateMapStateRecord) SnapshotKt.writableRecord($this$writable$iv$iv$iv$iv, this_$iv, current);
                    lock$iv$iv$iv2 = SnapshotStateMapKt.sync;
                    synchronized (lock$iv$iv$iv2) {
                        try {
                            if ($this$mutate_u24lambda_u2415$iv$iv.getModification() == currentModification$iv$iv) {
                                set = set2;
                                try {
                                    $this$mutate_u24lambda_u2415$iv$iv.setMap$runtime_release(newMap$iv$iv);
                                    z = true;
                                    $this$mutate_u24lambda_u2415$iv$iv.setModification$runtime_release($this$mutate_u24lambda_u2415$iv$iv.getModification() + 1);
                                } catch (Throwable th2) {
                                    th = th2;
                                    throw th;
                                }

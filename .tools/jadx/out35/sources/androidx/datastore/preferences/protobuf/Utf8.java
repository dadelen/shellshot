                ...
                if (c2 < 128) {
                    ...
                    if (inIx + 1 != inLength) {
                        ...
                        if (Character.isSurrogatePair(c2, low)) {
                            ...
                            int outIx5 = outIx2 + 1;
                            try {
                                out.put(outIx2, (byte) ((codePoint >>> 18) | AppPrefs.MAX_RECENT_PROCESSED_KEYS));
                                int outIx6 = outIx5 + 1;
                            ...
                            if (outIx <= outLimit - 4) {
                                if (inIx + 1 != inLimit) {
                                    ...
                                    if (Character.isSurrogatePair(c4, low)) {
                                        ...
                                        UnsafeUtil.putByte(out, outIx, (byte) ((codePoint >>> 18) | AppPrefs.MAX_RECENT_PROCESSED_KEYS));
                            ...
                            if (outIx <= outLimit - 4) {
                                if (inIx + 1 != inLimit) {
                                    ...
                                    if (Character.isSurrogatePair(c2, low)) {
                                        ...
                                        long outIx2 = outIx + j2;
                                        UnsafeUtil.putByte(outIx, (byte) ((codePoint2 >>> 18) | AppPrefs.MAX_RECENT_PROCESSED_KEYS));

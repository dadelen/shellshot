...
public final class SimpleActor<T> {
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
                ...
                public final void invoke2(Throwable th) {
                    ...
                    do {
                        Object m8718getOrNullimpl = ChannelResult.m8718getOrNullimpl(((SimpleActor) this).messageQueue.mo8707tryReceivePtdJZtk());
                        if (m8718getOrNullimpl != null) {
                            onUndeliveredElement.invoke(m8718getOrNullimpl, th);
                            obj = Unit.INSTANCE;
                        } else {
                            obj = null;
                        }
    ...
    public final void offer(T msg) {
        Object $this$onClosed_u2dWpGqRn0$iv = this.messageQueue.mo8702trySendJP2dKIU(msg);
        if (!($this$onClosed_u2dWpGqRn0$iv instanceof ChannelResult.Closed)) {
            if (!ChannelResult.m8723isSuccessimpl($this$onClosed_u2dWpGqRn0$iv)) {
        ...
        Throwable it = ChannelResult.m8717exceptionOrNullimpl($this$onClosed_u2dWpGqRn0$iv);
        if (it != null) {
            throw it;
        }
    }

...
public final class ActivityResultRegistryKt {
    public static final <I, O> ManagedActivityResultLauncher<I, O> rememberLauncherForActivityResult(ActivityResultContract<I, O> activityResultContract, Function1<? super O, Unit> function1, Composer $composer, int $changed) {
        ...
        String key;
        ActivityResultRegistryKt$rememberLauncherForActivityResult$1$1 value$iv3;
        ...
        String key2 = (String) RememberSaveableKt.m3749rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<String>() { // from class: androidx.activity.compose.ActivityResultRegistryKt$rememberLauncherForActivityResult$key$1
        ...
        ComposerKt.sourceInformation($composer, "CC(remember):ActivityResultRegistry.kt#9igjgp");
        boolean invalid$iv = $composer.changed(realLauncher) | $composer.changed(activityResultRegistry2) | $composer.changed(key2) | $composer.changed(activityResultContract) | $composer.changed(currentOnResult);
        Object it$iv3 = $composer.rememberedValue();
        if (invalid$iv || it$iv3 == Composer.INSTANCE.getEmpty()) {
            ActivityResultRegistryKt$rememberLauncherForActivityResult$1$1 activityResultRegistryKt$rememberLauncherForActivityResult$1$1 = new ActivityResultRegistryKt$rememberLauncherForActivityResult$1$1(realLauncher, activityResultRegistry2, key2, activityResultContract, currentOnResult);
            activityResultRegistry = activityResultRegistry2;
            key = key2;
            value$iv3 = activityResultRegistryKt$rememberLauncherForActivityResult$1$1;

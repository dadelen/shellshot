...
public final class LocalLifecycleOwnerKt {
    ...
    static {
        ...
        try {
            ...
            compositionLocalFromComposeUi = Result.m7212constructorimpl(providableCompositionLocal);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            compositionLocalFromComposeUi = Result.m7212constructorimpl(ResultKt.createFailure(th));
        }
        ProvidableCompositionLocal<LifecycleOwner> providableCompositionLocal2 = (ProvidableCompositionLocal) (Result.m7218isFailureimpl(compositionLocalFromComposeUi) ? null : compositionLocalFromComposeUi);

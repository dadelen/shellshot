...
public final class UStringsKt {
    ...
    public static final String m8538toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m8540toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m8539toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
        return UnsignedKt.ulongToString($this$toString_u2dV7xB4Y4 & 4294967295L, CharsKt.checkRadix(radix));
    }

    /* renamed from: toString-JSWoG40, reason: not valid java name */
    public static final String m8537toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (Integer.compareUnsigned(data, UInt.m7307constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m7224boximpl(UByte.m7230constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m7307constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m7487boximpl(UShort.m7493constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m7307constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m7307constructorimpl(result * uradix);
            result = UInt.m7307constructorimpl(UInt.m7307constructorimpl(digit) + result2);
            if (Integer.compareUnsigned(result, result2) < 0) {
                return null;
            }
        }
        return UInt.m7301boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m7386constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m7386constructorimpl(result * uradix);
            result = ULong.m7386constructorimpl(ULong.m7386constructorimpl(UInt.m7307constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m7380boximpl(result);
    }
}

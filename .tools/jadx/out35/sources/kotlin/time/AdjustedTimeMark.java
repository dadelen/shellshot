...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo8542minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m8661minusLRDsOJo(this, duration);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo8541elapsedNowUwyO8pc() {
        return Duration.m8579minusLRDsOJo(this.mark.mo8541elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo8544plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m8580plusLRDsOJo(this.adjustment, duration), null);
    }
}

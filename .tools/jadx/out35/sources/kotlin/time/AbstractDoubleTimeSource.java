...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo8541elapsedNowUwyO8pc() {
            return Duration.m8579minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public ComparableTimeMark mo8544plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m8580plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo8543minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (Duration.m8556equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m8576isInfiniteimpl(this.offset)) {
                return Duration.INSTANCE.m8642getZEROUwyO8pc();
            }
            long offsetDiff = Duration.m8579minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
            long startedAtDiff = DurationKt.toDuration(this.startedAt - ((DoubleTimeMark) other).startedAt, this.timeSource.getUnit());
            return Duration.m8556equalsimpl0(startedAtDiff, Duration.m8595unaryMinusUwyO8pc(offsetDiff)) ? Duration.INSTANCE.m8642getZEROUwyO8pc() : Duration.m8580plusLRDsOJo(startedAtDiff, offsetDiff);
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m8556equalsimpl0(mo8543minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m8642getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m8572hashCodeimpl(Duration.m8580plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m8591toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m8642getZEROUwyO8pc(), null);
    }
}

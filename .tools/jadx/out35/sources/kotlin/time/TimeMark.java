...
public interface TimeMark {
    ...
    TimeMark mo8542minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo8544plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {2, 2, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m8662plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m8661minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo8544plusLRDsOJo(Duration.m8595unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m8577isNegativeimpl($this.mo8541elapsedNowUwyO8pc());
        }

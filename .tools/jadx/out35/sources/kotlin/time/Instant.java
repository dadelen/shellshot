...
public final class Instant implements Comparable<Instant>, Serializable {
    ...
    public final Instant m8651plusLRDsOJo(long duration) {
        long secondsToAdd = Duration.m8565getInWholeSecondsimpl(duration);
        int nanosecondsToAdd = Duration.m8567getNanosecondsComponentimpl(duration);
        ...
        if ((a$iv ^ sum$iv) < 0 && (a$iv ^ secondsToAdd) >= 0) {
            return Duration.m8578isPositiveimpl(duration) ? MAX : MIN;
        }
    ...
    public final Instant m8649minusLRDsOJo(long duration) {
        return m8651plusLRDsOJo(Duration.m8595unaryMinusUwyO8pc(duration));
    }

    /* renamed from: minus-UwyO8pc, reason: not valid java name */
    public final long m8650minusUwyO8pc(Instant other) {
        Intrinsics.checkNotNullParameter(other, "other");
        Duration.Companion companion = Duration.INSTANCE;
        long duration = DurationKt.toDuration(this.epochSeconds - other.epochSeconds, DurationUnit.SECONDS);
        Duration.Companion companion2 = Duration.INSTANCE;
        return Duration.m8580plusLRDsOJo(duration, DurationKt.toDuration(this.nanosecondsOfSecond - other.nanosecondsOfSecond, DurationUnit.NANOSECONDS));
    }

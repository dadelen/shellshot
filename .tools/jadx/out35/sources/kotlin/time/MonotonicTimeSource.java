...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m8664boximpl(m8658markNowz9LOYto());
    }
    ...
    public long m8658markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m8667constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m8657elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m8656differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m8655adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m8667constructorimpl(LongSaturatedMathKt.m8653saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}

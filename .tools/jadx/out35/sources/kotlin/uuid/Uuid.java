...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m7380boximpl(ULong.m7386constructorimpl(getMostSignificantBits())), ULong.m7380boximpl(ULong.m7386constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m8687toUByteArrayTcUX1vc() {
        return UByteArray.m7283constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (this.mostSignificantBits != other.mostSignificantBits) {
            return Long.compareUnsigned(ULong.m7386constructorimpl(this.mostSignificantBits), ULong.m7386constructorimpl(other.mostSignificantBits));
        }
        return Long.compareUnsigned(ULong.m7386constructorimpl(this.leastSignificantBits), ULong.m7386constructorimpl(other.leastSignificantBits));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m8689fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m8688fromUByteArrayGBYM_sE(byte[] ubyteArray) {

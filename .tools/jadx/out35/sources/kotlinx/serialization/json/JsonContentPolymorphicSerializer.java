...
public abstract class JsonContentPolymorphicSerializer<T> implements KSerializer<T> {
    ...
    public final void serialize(Encoder encoder, T value) {
        ...
        KSerializer actualSerializer = encoder.getSerializersModule().getPolymorphic((KClass<? super KClass<T>>) this.baseClass, (KClass<T>) value);
        if (actualSerializer == null) {
            ...
            actualSerializer = serializerOrNull;
        }

...
public final class JsonElementKt {
    ...
    public static final JsonPrimitive m8808JsonPrimitive7apg3OU(byte value) {
        return m8809JsonPrimitiveVKZWuLQ(ULong.m7386constructorimpl(value & 255));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-xj2QHRw, reason: not valid java name */
    public static final JsonPrimitive m8811JsonPrimitivexj2QHRw(short value) {
        return m8809JsonPrimitiveVKZWuLQ(ULong.m7386constructorimpl(value & 65535));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-WZ4Q5Ns, reason: not valid java name */
    public static final JsonPrimitive m8810JsonPrimitiveWZ4Q5Ns(int value) {
        return m8809JsonPrimitiveVKZWuLQ(ULong.m7386constructorimpl(value & 4294967295L));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-VKZWuLQ, reason: not valid java name */
    public static final JsonPrimitive m8809JsonPrimitiveVKZWuLQ(long value) {

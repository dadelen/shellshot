...
final class ParametrizedCacheEntry<T> {
    ...
    public final Object m8773computeIfAbsentgIAlus(List<? extends KType> types, Function0<? extends KSerializer<T>> producer) {
        ...
        if (obj == null) {
            try {
                ...
                m7212constructorimpl = Result.m7212constructorimpl(producer.invoke());
            } catch (Throwable th) {
            ...
            Object putIfAbsent = $this$getOrPut$iv.putIfAbsent(arrayList, m7211boximpl);

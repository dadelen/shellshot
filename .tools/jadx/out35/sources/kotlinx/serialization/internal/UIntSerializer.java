...
public final class UIntSerializer implements KSerializer<UInt> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return UInt.m7301boximpl(m8789deserializeOGnWXxg(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object value) {
        m8790serializeQn1smSk(encoder, ((UInt) value).getData());
    }
    ...
    public void m8790serializeQn1smSk(Encoder encoder, int value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        encoder.encodeInline(getDescriptor()).encodeInt(value);
    }

    /* renamed from: deserialize-OGnWXxg, reason: not valid java name */
    public int m8789deserializeOGnWXxg(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return UInt.m7307constructorimpl(decoder.decodeInline(getDescriptor()).decodeInt());
    }
}

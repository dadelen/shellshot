...
public final class LimitedDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void mo8758scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo8758scheduleResumeAfterDelay(timeMillis, continuation);
    }
    ...
    public void mo8757dispatch(CoroutineContext context, Runnable block) {
        Runnable task$iv;
        ...
        if (runningWorkers$volatile$FU.get(this) < this.parallelism && tryAllocateWorker() && (task$iv = obtainTaskOrDeallocateWorker()) != null) {
            ...
            this.dispatcher.mo8757dispatch(this, worker);
        }
    }
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (fairnessCounter >= 16 && LimitedDispatcher.this.dispatcher.isDispatchNeeded(LimitedDispatcher.this)) {
                    LimitedDispatcher.this.dispatcher.mo8757dispatch(LimitedDispatcher.this, this);
                    return;
                }
            }
        }

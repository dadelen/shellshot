...
public interface SendChannel<E> {
    ...
    Object mo8702trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo8702trySendJP2dKIU(e);
            if (ChannelResult.m8723isSuccessimpl(result)) {
                return true;
            }
            Throwable m8717exceptionOrNullimpl = ChannelResult.m8717exceptionOrNullimpl(result);

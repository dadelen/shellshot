...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        try {
            ...
            symbol = BroadcastChannelKt.NO_ELEMENT;
            if (obj2 != symbol) {
                s.mo8702trySendJP2dKIU(getValue());
            }
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:24:0x008b -> B:12:0x0090). Please report as a decompilation issue!!! */
    ...
    */
    ...
    public Object mo8702trySendJP2dKIU(E element) {
        ...
        try {
            if (isClosedForSend()) {
                return super.mo8702trySendJP2dKIU(element);
            }
            ...
            for (Object element$iv2 : $this$forEach$iv) {
                ...
                it3.mo8702trySendJP2dKIU(element);
            }

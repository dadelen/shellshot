...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    public void mo8758scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
    ...
    public final void mo8757dispatch(CoroutineContext context, Runnable block) {
        enqueue(block);
    }
    ...
    private final boolean enqueueImpl(Runnable task) {
        ...
        while (true) {
            ...
            if (queue == null) {
                if (_queue$volatile$FU.compareAndSet(this, null, task)) {
                    return true;
                }
                ...
                if (_queue$volatile$FU.compareAndSet(this, queue, newQueue)) {
                    return true;
                }
            } else {
                ...
                switch (((LockFreeTaskQueueCore) queue).addLast(task)) {
                    case 0:
                        return true;
                    case 1:
                        _queue$volatile$FU.compareAndSet(this, queue, ((LockFreeTaskQueueCore) queue).next());
                        break;
                    case 2:
                        return false;
                }
    ...
    private final Runnable dequeue() {
        ...
        while (true) {
            ...
            if (!(queue instanceof LockFreeTaskQueueCore)) {
                ...
                if (_queue$volatile$FU.compareAndSet(this, queue, null)) {
                    Intrinsics.checkNotNull(queue, "null cannot be cast to non-null type java.lang.Runnable{ kotlinx.coroutines.RunnableKt.Runnable }");
    ...
    private final int scheduleImpl(long now, DelayedTask delayedTask) {
        ...
        if (delayedQueue == null) {
            ...
            _delayed$volatile$FU.compareAndSet($this$scheduleImpl_u24lambda_u248, null, new DelayedTaskQueue(now));

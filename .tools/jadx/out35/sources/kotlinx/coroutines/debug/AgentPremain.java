...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m7212constructorimpl = Result.m7212constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m7212constructorimpl = Result.m7212constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m7218isFailureimpl(m7212constructorimpl) ? null : m7212constructorimpl);

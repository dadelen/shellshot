    ...
    */
    ...
    static final class Companion {
        ...
        public final Pair<FileSystem, Path> toJarRoot(URL $this$toJarRoot) {
            ...
            ZipFileSystem zip = ZipFilesKt.openZip(path, FileSystem.SYSTEM, new Function1<ZipEntry, Boolean>() { // from class: okio.internal.ResourceFileSystem$Companion$toJarRoot$zip$1
